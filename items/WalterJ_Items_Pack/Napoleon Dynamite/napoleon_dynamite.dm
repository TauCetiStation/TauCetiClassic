/obj/item/clothing/under/fluff/napoleon_dynamite_shirt
	name = "white shirt"
	desc = "VOTE FOR PEDRO."
	icon = 'tauceti/items/WalterJ_Items_Pack/Napoleon Dynamite/Napoleon Dynamite.dmi'
	tc_custom = 'tauceti/items/WalterJ_Items_Pack/Napoleon Dynamite/Napoleon Dynamite.dmi'
