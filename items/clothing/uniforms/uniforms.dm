...
/obj/item/clothing/under/fluff/terezi_suit
	...
	icon = 'tauceti/items/clothing/uniforms/terezi.dmi'
	tc_custom = 'tauceti/items/clothing/uniforms/terezi.dmi'
	icon_state = "terezi"
	item_state = "terezi_suit"
	item_color = "terezi"
	flags = FPRINT | TABLEPASS
...
/obj/item/clothing/under/rank/cargo_fem
	...
	icon = 'tauceti/items/clothing/uniforms/uboa_dress.dmi'
	tc_custom = 'tauceti/items/clothing/uniforms/uboa_dress.dmi'
	icon_state = "qm_mob"
	item_state = "lb_suit"
	item_color = "qm"
