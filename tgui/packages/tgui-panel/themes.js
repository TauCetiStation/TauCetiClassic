...
export const setClientTheme = name => {
  ...
  if (name === 'light') {
    return Byond.winset({
      ...
      'tcoutputwindow.background-color': 'none',
      'tcoutputwindow.text-color': '#000000',
      'tcmainwindow.background-color': 'none',
  ...
  if (name === 'dark') {
    Byond.winset({
      ...
      'tcoutputwindow.background-color': COLOR_DARK_BG,
      'tcoutputwindow.text-color': COLOR_DARK_TEXT,
      'tcmainwindow.background-color': COLOR_DARK_BG,
