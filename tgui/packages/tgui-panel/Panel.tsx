...
import { emojiPanelVisibleAtom } from './emotes/atom';
import { EmotesPanel } from './emotes/EmotesPanel';
...
export function Panel(props) {
  ...
  const [emojiPanelVisible, setEmojiPanelVisible] = useAtom(
    emojiPanelVisibleAtom,
  );
  useChatPersistence();
  useKeepAlive();
