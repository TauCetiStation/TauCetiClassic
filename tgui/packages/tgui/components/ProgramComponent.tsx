...
export class ProcessProgrammComponent extends Component {
  ...
  render() {
    ...
    return (
      <TypeComponent
        act={this.props.act}
        selected_component={this.props.selected_component}
        component={this.props.component}
        thisEditProgram={this.props.thisEditProgram}
      />
    );
  }
}
          ...
          if (element !== null) {
            ...
            return (
              <TypeComponent
                ...
                component={element}
                selected_component={this.props.selected_component}
                getObj={this.setChildComponentRef}
                thisEditProgram={this.props.thisEditProgram}
              />
            );
          }
  ...
  getNextComponent() {
    if (this.next_component !== null) {
      ...
      return (
        <TypeComponent
          act={this.props.act}
          getObj={this.setNextComponentRef}
          connect={{
  ...
  getNumberBoxComponent(element : ProgramComponent, text, action) {
    ...
    return (
      <NumberInput
        ...
        value={this.data}
        onChange={(e, value) => this.props.act(action, {
          link_component: element?.link_component,
          data_change: value,
        })}
      >
...
export class ProcInjectAfterNextComponentProgramComponent extends ProcProgramComponent {
  ...
  updateProgramData() {
    ...
    let component : ProcInjectAfterNextComponentProgramComponent
    = this.props.component as ProcInjectAfterNextComponentProgramComponent;
