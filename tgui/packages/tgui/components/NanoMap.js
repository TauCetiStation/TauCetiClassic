...
export class NanoMap extends Component {
  constructor(props) {
    ...
    let _offsetX = -128 * this.props.zoom;
    let _offsetY = -128 * this.props.zoom;
  ...
  render() {
    const { dragging, offsetX, offsetY, zoom } = this.state;
    const { children } = this.props;

    const mapUrl = "nanomap_" + this.props.map + "_1.png";
    const mapSize = (513 * zoom) + 'px';
    const newStyle = {
      width: mapSize,
      height: mapSize,
