    ...
    for (let col = 1; col < 4; col++) {
      buttons.push(
        <Button
          ...
          content={
            <Box className="cardpay_button-inside cardpay_button-inside--normal">
              {row * 3 + col}
            </Box>
          }
      ...
      <Window.Content className="cardpay_window-contents">
        ...
        <Box
          ...
          <Button
            ...
            content={
              <Box className="cardpay_button-inside cardpay_button-inside--red">
                {'X'}
              </Box>
            }
          ...
          <Button
            ...
            content={
              <Box className="cardpay_button-inside cardpay_button-inside--green">
                {'O'}
              </Box>
            }
