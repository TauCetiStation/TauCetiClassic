...
/obj/item/omnitool/atom_init()
	. = ..()
	gg = global.radial_menus

/obj/item/omnitool/examine()
	. = ..()
	. += " The mode is: [tool_behaviour]"

/obj/item/omnitool/proc/check_menu(mob/user)
	if(!istype(user))
		return FALSE
...
/obj/item/omnitool/attack_self(mob/user)
	...
	var/list/tool_list = list(
		"Nullrod" = image(icon = 'icons/obj/weapons.dmi', icon_state = "nullrod"),
