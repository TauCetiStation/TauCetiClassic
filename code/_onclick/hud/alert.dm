...
/atom/movable/screen/alert/tox_in_air
	name = "Токсичный газ"
	desc = "В воздухе витает легковоспламеняющаяся, токсичная плазма, и вы вдыхаете её. Выйдите на свежий воздух."
...
/atom/movable/screen/alert/lowpressure
	...
	desc = "Вокруг вас опасный уровень давления атмосферы. Скафандр защитит вас."
...
/atom/movable/screen/alert/blind
	...
	desc = "По какой-то причине вы не можете видеть. Это может быть вызвано генетическим дефектом, травмой глаз, потерей сознания, \
			ну или что-то надето на ваши глаза."
	icon_state = "blind"
...
/atom/movable/screen/alert/embeddedobject
	...
	desc = "Что-то застряло в вашей плоти и вызывает сильную боль. Стоит попросить оказать медицинскую помощь. \
			Если это вам сильно мешает, то нажмите по себе правой кнопкой мыши и выберите 'Вытащить предмет'."
...
/atom/movable/screen/alert/nocell
	name = "Нет батареи"
	desc = "У юнита отсуствует батарея. Модули недоступны до тех пор, пока батарея не будет установлена. Робототехника может оказать помощь."
	icon_state = "nocell"

/atom/movable/screen/alert/emptycell
	name = "Севшая батарея"
	desc = "В батарее юнита не осталось заряда. Модули недоступны до тех пор, пока элемент питания не будет заряжен. \
			Станции подзарядки имеются в роботехнике, в ванных комнатах общежитий. и в спутнике с искусственным интеллектом."
	icon_state = "emptycell"

/atom/movable/screen/alert/lowcell
	name = "Низкий заряд"
	desc = "Батарея скоро сядет. Станции подзарядки имеются в роботехнике, в ванных комнатах общежитий. и в спутнике с искусственным интеллектом."
	icon_state = "lowcell"

//Need to cover all use cases - emag, illegal upgrade module, malf AI hack, traitor cyborg
/atom/movable/screen/alert/hacked
	name = "Взломан"
	desc = "Обнаружено новое опасное оборудование. Пожалуйста, убедитесь, что любое использование этого оборудования разрешается вашим набором законов."
	icon_state = "hacked"

/atom/movable/screen/alert/not_locked
	name = "Разблокированный интерфейс"
	desc = "Интерфейс устройства разблокирован. Кто-то случайно или намеренно оставил его открытым. Робототехника может оказать помощь."
...
/atom/movable/screen/alert/locked
	...
	desc = "Юнит удаленно заблокирован. Этот вопрос может быть решен с помощью компьютера для управления робототехникой, \
			...
			Стоит разобраться по какой причине это произошло."
	icon_state = "locked"
...
/atom/movable/screen/alert/buckled
	name = "Пристегнут"
	desc = "Вы пристегнуты к чему-то и не можете двинуться. \
...
/atom/movable/screen/alert/handcuffed
	...
	desc = "На вас надеты наручники, и вы не можете пользоваться своими руками. Если кто-то потащит вас, вы не сможете двинуться. \
			Нажмите на кнопку Сопротивления, чтобы попытаться выбраться из них."
	icon_state = "handcuff"

/atom/movable/screen/alert/legcuffed
	name = "Скованные ноги"
	desc = "Ваши ноги скованы. Что-то мешает вам свободно ходить. \
			Нажмите на кнопку Сопротивления, чтобы попытаться убрать ловушку из ног."
	icon_state = "legcuff"
