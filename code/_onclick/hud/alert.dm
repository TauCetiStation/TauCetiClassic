...
/atom/movable/screen/alert/emptycell
	...
	desc = "В батарее юнита не осталось заряда. Модули недоступны до тех пор, пока элемент питания не будет заряжен. \
			Станции подзарядки имеются в роботехнике, в туалетах дормитория, на станции подзарядки киборгов и в спутнике с искусственным интеллектом."
	icon_state = "emptycell"

/atom/movable/screen/alert/lowcell
	name = "Низкий заряд"
	desc = "Батарея скоро сядет. Станции подзарядки имеются в роботехнике, в туалетах дормитория, на станции подзарядки киборгов и в спутнике с искусственным интеллектом."
	icon_state = "lowcell"
