...
/atom/movable/screen/blob/shield
	...
	desc = "Создаёт укрепленного блоба. <br>Используйте снова на укреплённом блобе для улучшения в рефлективного блоба."
	screen_loc = ui_id
...
/atom/movable/screen/blob/blobbernaut
	...
	desc = "Создаёт крепкого и умного блоббернаута.<br>Производящая ячейка, создавшая блоббернаута становится неактивной и хрупкой на некоторое время."
	screen_loc = ui_lhand
