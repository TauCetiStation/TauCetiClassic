...
/atom/movable/screen/plane_master/rendering_plate/game_world/proc/apply_singularity_effects()
	add_filter("singularity_0", 1, displacement_map_filter(render_source = SINGA_RENDER_TARGET_0, size = -40))
	add_filter("singularity_1", 2, displacement_map_filter(render_source = SINGA_RENDER_TARGET_1, size = 75))
	add_filter("singularity_2", 3, displacement_map_filter(render_source = SINGA_RENDER_TARGET_2, size = 400))
	add_filter("singularity_3", 4, displacement_map_filter(render_source = SINGA_RENDER_TARGET_3, size = 700))
