...
/atom/movable/screen/essence_voice/Click(location, control, params)
...
/atom/movable/screen/essence_phantom/Click(location, control, params)
	var/mob/living/parasite/essence/E = usr
	if(!E.host)
		return
...
/atom/movable/screen/return_to_body/Click(location, control, params)
	var/mob/living/parasite/essence/E = usr
	if(!E.host)
		return
	E.host.delegate_body_to_essence()

/atom/movable/screen/ling_abilities/Click(location, control, params)
	var/mob/living/parasite/essence/E = usr
