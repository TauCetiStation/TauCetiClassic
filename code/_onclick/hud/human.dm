...
//end intent small hud objects
	...
	mymob.client.screen += list( mymob.throw_icon, mymob.zone_sel, mymob.internals, mymob.healths, mymob.healthdoll, mymob.nutrition_icon, mymob.pullin, mymob.gun_setting_icon, lingchemdisplay, lingstingdisplay, ipcpowerdisplay) //, mymob.hands, mymob.rest, mymob.sleep) //, mymob.mach )
