...
/proc/admin_spawn_room_at_pos()
	...
	switch(tgui_alert(usr,"Wall type",null, list("Reinforced wall","Regular wall","Resin wall")))
		if("Reinforced wall")
	...
	switch(tgui_alert(usr,"Floor type",null, list("Regular floor","Reinforced floor")))
		if("Regular floor")
