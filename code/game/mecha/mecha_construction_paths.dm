...
/datum/construction/mecha/clarke_chassis
	steps = list(list("key"=/obj/item/mecha_parts/part/clarke_torso),//1
					 ...
					 list("key"=/obj/item/clothing/suit/space/globose/mining)//7
					)
...
/datum/construction/reversible/mecha/clarke
	result_type = /obj/mecha/working/clarke
	steps = list(
					//1
					list("key"=QUALITY_WELDING,
							"backkey"=QUALITY_WRENCHING,
					...
					//2
					 ...
					 list("key"=QUALITY_SCREWING,
					 		...
					 		"desc"="Peripherals control module is installed."),
					 //8
					 list("key"=/obj/item/weapon/circuitboard/mecha/clarke/peripherals,
					 		"backkey"=QUALITY_SCREWING,
					 		"desc"="Central control module is secured."),
					 //9
					 list("key"=QUALITY_SCREWING,
					 		...
					 		"desc"="Central control module is installed."),
					 //10
					 list("key"=/obj/item/weapon/circuitboard/mecha/clarke/main,
					 		"backkey"=QUALITY_SCREWING,
					 		"desc"="The wiring is adjusted."),
					 //11
					 list("key"=QUALITY_CUTTING,
	...
	switch(index)
		...
		if(9)
			if(diff==FORWARD)
				...
				new /obj/item/weapon/circuitboard/mecha/clarke/main(get_turf(holder))
				holder.icon_state = "clarke4"
		if(8)
			if(diff==FORWARD)
		...
		if(7)
			if(diff==FORWARD)
				...
				new /obj/item/weapon/circuitboard/mecha/clarke/peripherals(get_turf(holder))
				holder.icon_state = "clarke6"
		if(6)
			if(diff==FORWARD)
