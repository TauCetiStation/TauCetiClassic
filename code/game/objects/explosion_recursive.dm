...
/proc/explosion_rec(turf/epicenter, power)
	...
	playsound(epicenter, 'sound/effects/explosionfar.ogg', VOL_EFFECTS, null, null, round(power*2,1) )
	playsound(epicenter, "explosion", VOL_EFFECTS, null, null, round(power,1) )
