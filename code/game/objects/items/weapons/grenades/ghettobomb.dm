...
/obj/item/weapon/grenade/cancasing/rag/attackby(obj/item/I, mob/user, params)
	...
	user.visible_message("<span class='warning'>[bicon(src)] [user] Поджигает [src] при помощи [I]!</span>", "<span class='warning'>[bicon(src)] Вы поджигаете [name] при помощи [I]!</span>")
	activate(user)
