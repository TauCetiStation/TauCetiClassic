...
/obj/item/weapon/grenade/chem_grenade/hear_talk(mob/living/M, text, verb, datum/language/speaking, list/heard_memes)
	if (detonator)
		detonator.hear_talk(M, text, verb, speaking, heard_memes)
