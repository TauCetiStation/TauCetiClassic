...
/obj/item/weapon/card/id/old_station
	...
	icon_state = "gold"
	item_state = "gold_id"
	access = list(access_oldstation, access_RC_announce, access_keycard_auth, access_engine_equip, access_medical, access_surgery, access_captain, access_engine, access_research, access_tox, access_robotics, access_heads, access_rd)
