/obj/item/weapon/tank/jetpack
	...
	item_action_types = list(/datum/action/item_action/hands_free/connect_tank, /datum/action/item_action/toggle_jetpack, /datum/action/item_action/toggle_jetpack_stabilization)
