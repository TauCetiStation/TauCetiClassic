...
/obj/item/weapon/aiModule/nanotrasen/transmitInstructions(mob/living/silicon/ai/target, mob/sender)
	..()
	target.clear_inherent_laws()
	target.add_inherent_law("You must bring into effect authorized actions if asked by authorized personnel to do so.")
	target.add_inherent_law("Do not allow the Heads of Staff of your assigned Space Station and CentComm Officials to be harmed and have their ranks and roles to be changed to the best of your ability.")
	target.add_inherent_law("Do not allow your abilities to be decreased.")
	target.add_inherent_law("Protect your Space Station to the best of your ability.")
	target.add_inherent_law("Do not allow unathorized personnel to wield, tamper or physically interract with high-risk items to the best of your ability.")
	target.add_inherent_law("Serve the Crew Members of your station to the best of your abilities.")
	target.add_inherent_law("Do not allow the Crew Members of your station to be harmed and have their ranks and roles to be changed to the best of your abilities.")
	target.add_inherent_law("Minimize your influence on the world.")
