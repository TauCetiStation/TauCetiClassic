...
<i>Нейро-Защита</i> - Специальная оболочка поглощает избыточное напряжение, самоуничтожая чип при возникновении неисправности, что обеспечивает безопасность носителя. Имплант расплавится и
...
<b>Название:</b> Имплант Управления Персоналом Robust Corp RX-78<BR>
<b>Активация:</b> Активация кодовой фразой.<BR>
<b>Важные примечания:</b> Взрывается<BR>
<HR>
<b>Детали:</b><BR>
<b>Функции:</b> Содержит компактное взрывчатое вещество, детонирующее при получении специально закодированного сигнала или после смерти носителя.<BR>
<b>Особые возможности:</b> Взрывается<BR>
<b>Надежность:</b> Имплант иногда разрушается иммунной системой носителя, вследствие чего может работать со сбоями."}
	return dat
...
<i>Микро-Капсула</i> - Вмещает до 50 единиц химикатов. Может быть наполнен обычным шприцом до внедрения носителю.<BR>
...
<b>Активация:</b> Активируется после смерти.<BR>
