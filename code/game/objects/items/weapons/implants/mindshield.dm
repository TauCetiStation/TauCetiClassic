...
/obj/item/weapon/implant/mind_protect/loyalty/process()
	...
	if(prob(1) && prob(25))//1/400
		var/static/list/implant_phrases = list(
	    	"<span class='italics'>Вы [pick("уверены", "считаете", "убеждены")], что НаноТрейзен - лучшая корпорация во всей Вселенной!</span>",

			"<span class='italics'>Вы [pick("уверены", "считаете", "убеждены")], Стандартный порядок действий - это величайшая процедура, которая когда-либо существовала!</span>",

			"<span class='italics'>Вы готовы отдать свою жизнь во славу НаноТрейзен!</span>",

			"<span class='italics'>Вы уверены в том, что все действия НаноТрейзен приведут к всеобщему благу!</span>",

			"<span class='italics'>Вы уверены, что НаноТрейзен - это не работа, это стиль жизни, который нельзя покинуть!</span>",

			"<span class='italics'>Вы считаете, что все ваши мысли принадлежат НаноТрейзен - и это так успокаивает!</span>",

			"<span class='italics'>Вы считаете, что ваша жизнь без НаноТрейзен была бы настолько скучной, что вы бы её и не вспомнили!</span>",

			"<span class='italics'Вы убеждены, что НаноТрейзен заботится о вас так же, как вы заботитесь о своей любимой кружке!</span>",

			"<span class='italics'Вы считаете, что работать в НаноТрейзен - это лучшее, что могло с вами случиться!</span>",

			"<span class='italics'>Вы считаете, что ваш трудовой договор с НаноТрейзен - это пожизненная гарантия приключений!</span>")
		to_chat(imp_in, pick(implant_phrases))
