...
/obj/item/weapon/storage/box/syndicate/atom_init()
	...
	switch (tagname)
		...
		if("implant")
			...
			var/obj/item/weapon/implanter/L = new /obj/item/weapon/implanter(src)
			O.imp = new /obj/item/weapon/implant/syndi_loyalty(L)
...
/obj/item/weapon/storage/box/syndie_kit/imp_loyalty
	name = "box (L)"
