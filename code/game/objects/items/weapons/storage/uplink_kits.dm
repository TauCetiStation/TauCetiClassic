/obj/item/weapon/storage/box/syndicate/
	New()
		..()
		var/tagname = pickweight(list("bloodyspai" = 1, "stealth" = 1, "ninja" = 1, "guns" = 1, "implant" = 1, "hacker" = 1,"smoothoperator" = 1, "poisons" = 1, "gadgets" = 1))
		switch (tagname)
			if("bloodyspai")
			...
			if("implant")
				...
				C.imp = new /obj/item/weapon/implanter/compressed(src)
				var/obj/item/weapon/implanter/E = new /obj/item/weapon/implanter(src)
				E.imp = new /obj/item/weapon/implanter/explosive(src)
				var/obj/item/weapon/implanter/A = new /obj/item/weapon/implanter(src)
				A.imp = new /obj/item/weapon/implant/adrenalin(src)
