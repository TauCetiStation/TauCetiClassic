...
/obj/item/weapon/storage/box/syndicate/atom_init()
	. = ..()
	var/tagname = pick("bloodyspai", "silent assassin", "stealth", "screwed", "ninja", "guns", "implant", "hacker", "smoothoperator", "poisons", "gadgets", "liar")
	switch (tagname)
		if("bloodyspai")
		...
		if("silent assassin")
			...
			new /obj/item/clothing/gloves/black/silence(src)
			new /obj/item/weapon/melee/energy/sword/traitor(src)
			new /obj/item/clothing/under/chameleon(src)
		...
		if("guns")
			...
			new /obj/item/weapon/storage/pouch/ammo/revolverammo(src)
			new /obj/item/weapon/kitchenknife/combat(src)
			new /obj/item/weapon/storage/box/syndie_kit/light_armor(src)
		...
		if("smoothoperator")
			...
			new /obj/item/ammo_box/magazine/m9mm/ex(src)
		...
		if("poisons")
			...
			new /obj/item/weapon/reagent_containers/glass/bottle/acid(src)
		...
		if("liar")
			new /obj/item/clothing/mask/gas/voice(src)
			new /obj/item/weapon/card/id/syndicate(src)
			new /obj/item/weapon/storage/box/syndie_kit/fake(src)
