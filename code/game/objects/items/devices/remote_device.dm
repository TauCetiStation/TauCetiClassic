...
/obj/item/device/remote_device/head_of_personal
	...
	cases = list("пульт удалённого управления \"Гражданские отделы\"", "пульта удалённого управления \"Гражданские отделы\"", "пульту удалённого управления \"Гражданские отделы\"", "пульт удалённого управления \"Гражданские отделы\"", "пультом удалённого управления \"Гражданские отделы\"", "пульте удалённого управления \"Гражданские отделы\"")
	icon_state = "rdc_hop"
