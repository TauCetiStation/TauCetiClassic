...
/obj/item/device/remote_device/ERT
	...
	cases = list("пульт удалённого управления \"Станция\"", "пульта удалённого управления \"Станция\"", "пульту удалённого управления \"Станция\"", "пульт удалённого управления \"Станция\"", "пультом удалённого управления \"Станция\"", "пульте удалённого управления \"Станция\"")
...
/obj/item/device/remote_device/captain
	...
	cases = list("пульт удалённого управления \"Главы\"", "пульта удалённого управления \"Главы\"", "пульту удалённого управления \"Главы\"", "пульт удалённого управления \"Главы\"", "пультом удалённого управления \"Главы\"", "пульте удалённого управления \"Главы\"")
	icon_state = "rdc_cap"
...
/obj/item/device/remote_device/head_of_security
	...
	cases = list("пульт удалённого управления \"Бриг\"", "пульта удалённого управления \"Бриг\"", "пульту удалённого управления \"Бриг\"", "пульт удалённого управления \"Бриг\"", "пультом удалённого управления \"Бриг\"", "пульте удалённого управления \"Бриг\"")
	icon_state = "rdc_hos"
