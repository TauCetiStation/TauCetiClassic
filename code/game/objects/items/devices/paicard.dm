/obj/item/device/paicard
	...
	cases = list("устройство с персональным ИИ","устройства с персональным ИИ","устройству с персональным ИИ","устройство с персональным ИИ","устройством с персональным ИИ","устройстве с персональным ИИ")
