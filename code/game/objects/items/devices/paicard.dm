...
/obj/item/device/paicard/proc/alertUpdate()
	...
	for (var/mob/M in viewers(T))
		M.show_message("<span class='notice'>[src] flashes a message across its screen, \</span>"Additional personalities available for download.\"", 3, "<span class='notice'>[src] bleeps electronically.</span>", 2)
