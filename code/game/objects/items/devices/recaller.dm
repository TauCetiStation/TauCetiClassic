...
/obj/item/device/gangtool/attack_self(mob/user)
	...
	if(!gang)
		...
		if(points >= 25)
			dat += "(25 Influence) <a href='?src=\ref[src];purchase=pistol'>9mm Pistol</a><br>"
		else
			dat += "(25 Influence) 9mm Pistol<br>"

		if(points >= 10)
			dat += "(10 Influence) <a href='?src=\ref[src];purchase=ammo'>9mm Ammo</a><br>"
		else
			dat += "(10 Influence) 9mm Ammo<br>"
