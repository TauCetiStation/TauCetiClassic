...
/obj/item/toy/crayon
	...
	suicide_act(mob/user)
		to_chat(viewers(user), "<span class='warning'><b>[user] is jamming the [src.name] up \his nose and into \his brain. It looks like \he's trying to commit suicide.</b></span>")
