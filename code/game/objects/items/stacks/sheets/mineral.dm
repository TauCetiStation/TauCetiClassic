...
var/global/list/datum/stack_recipe/plastic_recipes = list ( \
	...
	new/datum/stack_recipe("plastic knife", /obj/item/weapon/kitchenknife/plastic, 1, on_floor = 1), \
	new/datum/stack_recipe("plastic bag", /obj/item/weapon/storage/bag/plasticbag, 3, on_floor = 1), \
	new/datum/stack_recipe("sign backing", /obj/item/sign_backing, 4, on_floor = 1)
	)
