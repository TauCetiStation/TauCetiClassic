...
var/global/list/datum/stack_recipe/wood_recipes = list (
	...
	new/datum/stack_recipe("blue fancy table parts", /obj/item/weapon/table_parts/wood/fancy/blue, 2),
	new/datum/stack_recipe("cyan fancy table parts", /obj/item/weapon/table_parts/wood/fancy/cyan, 2),
	new/datum/stack_recipe("green fancy table parts", /obj/item/weapon/table_parts/wood/fancy/green, 2),
	new/datum/stack_recipe("orange fancy table parts", /obj/item/weapon/table_parts/wood/fancy/orange, 2),
	new/datum/stack_recipe("purple fancy table parts", /obj/item/weapon/table_parts/wood/fancy/purple, 2),
	...
	new/datum/stack_recipe("grave marker", /obj/structure/gravemarker/cross, 2, time = 5, max_per_turf = 1, build_outline = TRUE),
