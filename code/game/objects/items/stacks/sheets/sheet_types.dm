...
/*		new/datum/stack_recipe("science airlock assembly", /obj/structure/door_assembly/door_assembly_science, 4, time = 50, max_per_turf = 1, build_outline = TRUE), \ */
	...
	new/datum/stack_recipe("fence", /obj/structure/fence/metal, 2, time = 25, max_per_turf = 1, build_outline = TRUE),
...
var/global/list/datum/stack_recipe/wood_recipes = list (
	...
	new/datum/stack_recipe("fence", /obj/structure/fence/wood, 2, time = 25, max_per_turf = 1, build_outline = TRUE),
