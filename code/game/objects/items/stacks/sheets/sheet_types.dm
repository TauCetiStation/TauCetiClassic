...
/*		new/datum/stack_recipe("science airlock assembly", /obj/structure/door_assembly/door_assembly_science, 4, time = 50, max_per_turf = 1, build_outline = TRUE), \ */
	...
	new/datum/stack_recipe("reflector frame", /obj/structure/reflector, 5, max_per_turf = 1, build_outline = TRUE, required_skills = list(/datum/skill/construction = SKILL_LEVEL_TRAINED), time = 20)
)
