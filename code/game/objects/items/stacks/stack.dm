...
/obj/item/stack
	...
	var/full_w_class = SIZE_NORMAL // The weight class the stack should have at amount > 2/3rds max_amount
	var/is_fusion_fuel
...
/obj/item/stack/proc/update_weight()
	if(amount <= (max_amount * (1 / 3)))
		w_class = clamp(full_w_class - 2, SIZE_TINY, full_w_class)
	else if (amount <= (max_amount * (2 / 3)))
		w_class = clamp(full_w_class - 1, SIZE_TINY, full_w_class)
	else
