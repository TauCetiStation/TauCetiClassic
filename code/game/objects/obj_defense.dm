...
/obj/attack_hulk(mob/living/user)
	...
	user.visible_message("<span class='danger'>[user] smashes [src][damage ? "" : ", without leaving a mark"]!</span>", "<span class='danger'>You smash [src][damage ? "" : ", without leaving a mark"]!</span>", null, COMBAT_MESSAGE_RANGE)
	return TRUE
