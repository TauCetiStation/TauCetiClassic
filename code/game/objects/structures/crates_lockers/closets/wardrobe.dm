...
/obj/structure/closet/wardrobe/pink/PopulateContents()
	for (var/i in 1 to 3)
		new /obj/item/clothing/under/colored/pink(src)
...
/obj/structure/closet/wardrobe/green/PopulateContents()
	for (var/i in 1 to 3)
		new /obj/item/clothing/under/colored/green(src)
	for (var/i in 1 to 3)
		new /obj/item/clothing/shoes/black(src)
	//for (var/i in 1 to 2)
...
/obj/structure/closet/wardrobe/orange/PopulateContents()
	for (var/i in 1 to 3)
		new /obj/item/clothing/under/colored/orange(src)
...
/obj/structure/closet/wardrobe/yellow/PopulateContents()
	for (var/i in 1 to 3)
		new /obj/item/clothing/under/colored/yellow(src)
		new /obj/item/clothing/shoes/orange(src)
	//for (var/i in 1 to 2)
...
/obj/structure/closet/wardrobe/white/PopulateContents()
	for (var/i in 1 to 3)
		new /obj/item/clothing/under/colored/white(src)
...
/obj/structure/closet/wardrobe/grey/PopulateContents()
	for (var/i in 1 to 3)
		new /obj/item/clothing/under/colored/grey(src)
	for (var/i in 1 to 3)
		new /obj/item/clothing/shoes/black(src)
	for (var/i in 1 to 3)
...
/obj/structure/closet/wardrobe/mixed/PopulateContents()
	...
	new /obj/item/clothing/under/colored/blue(src)
	new /obj/item/clothing/under/colored/yellow(src)
	new /obj/item/clothing/under/colored/green(src)
	new /obj/item/clothing/under/colored/orange(src)
	new /obj/item/clothing/under/colored/pink(src)
	new /obj/item/clothing/under/colored/red(src)
	//new /obj/item/clothing/under/colored/lightblue(src)
	//new /obj/item/clothing/under/colored/aqua(src)
	//new /obj/item/clothing/under/colored/purple(src)
	//new /obj/item/clothing/under/colored/lightpurple(src)
	//new /obj/item/clothing/under/colored/lightgreen(src)
	//new /obj/item/clothing/under/colored/darkblue(src)
	//new /obj/item/clothing/under/colored/darkred(src)
	//new /obj/item/clothing/under/colored/lightred(src)
	//new /obj/item/clothing/mask/bandana/red(src)
	//new /obj/item/clothing/mask/bandana/red(src)
