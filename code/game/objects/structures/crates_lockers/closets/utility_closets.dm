...
/obj/structure/closet/freezer/PopulateContents()
	...
	if(prob(5))
		new /obj/item/weapon/reagent_containers/food/snacks/jundarek(src)

/obj/structure/closet/freezer/open()
	. = ..()
	set_light(2, 0.5, "#ffaa66")

/obj/structure/closet/freezer/close()
	. = ..()
	set_light(0, 0)
...
/obj/structure/closet/small_freezer/PopulateContents()
	...
	new /obj/item/weapon/storage/box/donkpockets(src)
	if(prob(20))
		new /obj/random/foods/drink_can(src)
	if(prob(5))
		new /obj/item/weapon/reagent_containers/food/drinks/bottle/beer(src)

/obj/structure/closet/small_freezer/open()
	. = ..()
	set_light(2, 0.5, "#ffaa66")

/obj/structure/closet/small_freezer/close()
	. = ..()
	set_light(0, 0)
