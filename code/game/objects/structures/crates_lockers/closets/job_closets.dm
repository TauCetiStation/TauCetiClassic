...
/obj/structure/closet/theatrecloset/PopulateContents()
	switch (rand(1, 21))
		...
		if (3)
			new /obj/item/clothing/mask/breath/gas/sexymime(src)
		...
		if (11)
			...
			new /obj/item/clothing/mask/breath/gas/plaguedoctor(src)
		if( 12)
			new /obj/item/clothing/under/owl(src)
			new /obj/item/clothing/mask/breath/gas/owl_mask(src)
		if (13)
		...
		if (16)
			...
			if (prob(25))
				new /obj/item/clothing/mask/breath/gas/cyborg(src)
		if (17)
		...
		if (21)
			new /obj/item/clothing/mask/breath/gas/sexyclown(src)
