...
/obj/structure/closet/theatrecloset/PopulateContents()
	switch (rand(1, 21))
		...
		if (3)
			...
			new /obj/item/clothing/under/dress/sexymime(src)
		if (4)
		...
		if (5)
			new /obj/item/clothing/under/dress/schoolgirl(src)
			new /obj/item/clothing/head/kitty(src)
		if (6)
			new /obj/item/clothing/under/dress/blackskirt(src)
		...
		if (21)
			...
			new /obj/item/clothing/under/dress/sexyclown(src)
