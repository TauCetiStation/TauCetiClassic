...
/obj/structure/dispenser
	...
	cases = list("портативный раздатчик баллонов", "портативного раздатчика баллонов", "портативному раздатчику баллонов", "портативный раздатчик баллонов", "портативным раздатчиком баллонов", "портативном раздатчике баллонов")
