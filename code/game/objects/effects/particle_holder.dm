...
/obj/effect/abstract/particle_holder/atom_init(mapload, particle_path = /particles/smoke, particle_flags = NONE)
	. = ..()
	if(!loc)
		stack_trace("particle holder was created with no loc!")
		return INITIALIZE_HINT_QDEL

	if(loc.plane == FLOOR_PLANE)
	...
	if(particle_flags & PARTICLE_NO_TRANSFORM)
