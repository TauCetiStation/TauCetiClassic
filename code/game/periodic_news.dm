...
/datum/news_announcement/changling_meta
	...
	message = {"
Новая угроза в секторе Тау Кита

До недавнего времени обстановка в секторе была довольно спокойной, но буквально несколько дней назад начала поступать волна сообщений о найденных высушенных трупах. Очевидцы сравнивают это с проделками существ из древних земных мифов - вампиров, и очень этим обеспокоены. Такие случаи имели место быть и раньше, однако им не придавали должного внимания, а власти списывали всё на случайность, но не в этот раз.

Участившиеся случаи вызывают серьёзное беспокойство, а чиновники в свою очередь призывают сохранять спокойствие и грозятся ввести комендантский час. Мы связались с НаноТрайзен, которая обладает наибольшим контролем в нашем секторе. Рассказать о текущей ситуации нам согласился уполномоченный представитель корпорации Эрнест Медичи: "В данный момент в управлении обсуждают возможность введения комендантского часа, а в будущем и увеличение военного контингента в секторе. Вскоре будет официальный комментарий об этой ситуации".

На данный момент существует несколько популярных версий о причинах смерти этих сотрудников. Некоторые из них пробирают до мурашек! Небольшая группа учёных с tau ceti f и вовсе заявила, что это штамм чёртового птичьего гриппа передающегося от воксов! Всегда знал, что с этими кочевниками что-то не чисто! В свою очередь НТ в  пресс релизе заявила, что это результаты деятельности неких "генокрадов". Также чиновники решили опубликовать один очень занимательный документ, в котором, как они заявляют, сказано всё. Выглядит как очередная попытка сказать, что у них всё под контролем, придумали себе инопланетян и генокрадов, и говорят что они всё знают! Сколько уже было таких сказок? Сколько раз они нас обманывали? Чувствую, если не принять никаких мер, мы и дальше останемся в неведении. Напомню нашим читателям, что подобные ситуации – далеко не исключение!
	"}
