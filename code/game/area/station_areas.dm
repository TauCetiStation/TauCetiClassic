...
/area/station/engineering/break_room
	...
	cases = list("комната отдыха ИО", "комнаты отдыха ИО", "комнате отдыха ИО", "комната отдыха ИО", "комнатой отдыха ИО", "комнате отдыха ИО")
...
/area/station/maintenance
	cases = list ("технический туннель", "технического туннеля", "техническому туннелю", "технический туннель", "техническим туннелем", "техническом туннеле")
...
/area/station/maintenance/eva
	...
	cases = list ("технический туннель ВКД", "технического туннеля ВКД", "техническому туннелю ВКД", "технический туннель ВКД", "техническим туннелем ВКД", "техническом туннеле ВКД")
	icon_state = "fpmaint"

/area/station/maintenance/escape
	name = "Escape Shuttle Maintenance"
	cases = list ("технический туннель отбытия", "технического туннеля отбытия", "техническому туннелю отбытия", "технический туннель отбытия", "техническим туннелем отбытия", "техническом туннеле отбытия")
	icon_state = "fmaint"

/area/station/maintenance/dormitory
	name = "Dormitory Maintenance"
	cases = list ("технический туннель дормиторий", "технического туннеля дормиторий", "техническому туннелю дормиторий", "технический туннель дормиторий", "техническим туннелем дормиторий", "техническом туннеле дормиторий")
	icon_state = "fsmaint"

/area/station/maintenance/chapel
	name = "Chapel Maintenance"
	cases = list ("технический туннель церкви", "технического туннеля церкви", "техническому туннелю церкви", "технический туннель церкви", "техническим туннелем церкви", "техническом туннеле церкви")
	icon_state = "fsmaint"

/area/station/maintenance/medbay
	name = "Medbay Maintenance"
	cases = list ("технический туннель медблока", "технического туннеля медблока", "техническому туннелю медблока", "технический туннель медблока", "техническим туннелем медблока", "техническом туннеле медблока")
	icon_state = "asmaint"

/area/station/maintenance/science
	name = "Science Maintenance"
	cases = list ("технический туннель ОИР", "технического туннеля ОИР", "техническому туннелю ОИР", "технический туннель ОИР", "техническим туннелем ОИР", "техническом туннеле ОИР")
	icon_state = "asmaint"

/area/station/maintenance/bridge
	name = "Bridge Maintenance"
	cases = list ("технический туннель мостика", "технического туннеля мостика", "техническому туннелю мостика", "технический туннель мостика", "техническим туннелем мостика", "техническом туннеле мостика")
	icon_state = "maintcentral"

/area/station/maintenance/cargo
	name = "Cargo Maintenance"
	cases = list ("технический туннель ОС", "технического туннеля ОС", "техническому туннелю ОС", "технический туннель ОС", "техническим туннелем ОС", "техническом туннеле ОС")
	icon_state = "pmaint"

/area/station/maintenance/engineering
	name = "Engineering Maintenance"
	cases = list ("технический туннель ИО", "технического туннеля ИО", "техническому туннелю ИО", "технический туннель ИО", "техническим туннелем ИО", "техническом туннеле ИО")
	icon_state = "amaint"
...
/area/station/maintenance/atmos
	...
	cases = list ("технический туннель атмосферного отдела", "технического туннеля атмосферного отдела", "техническому туннелю атмосферного отдела", "технический туннель атмосферного отдела", "техническим туннелем атмосферного отдела", "техническом туннеле атмосферного отдела")
	icon_state = "amaint"
...
/area/station/solar/auxport
	...
	cases = list("носовые северо-западные солнечные панели", "носовых северо-западных солнечных панелей", "носовым северо-западным солнечным панелям", "носовые северо-западные солнечные панели", "носовыми северо-западными солнечными панелями", "носовых северо-западных солнечных панелях")
	icon_state = "panelsA"

/area/station/solar/auxstarboard
	name = "Fore Starboard Solar Array"
	cases = list("носовые северо-восточные солнечные панели", "носовых северо-восточных солнечных панелей", "носовым северо-восточным солнечным панелям", "носовые северо-восточные солнечные панели", "носовыми северо-восточными солнечными панелями", "носовых северо-восточных солнечных панелях")
	icon_state = "panelsA"

/area/station/solar/starboard
	name = "Aft Starboard Solar Array"
	cases = list("кормовые юго-восточные солнечные панели", "кормовых юго-восточных солнечных панелей", "кормовым юго-восточным солнечным панелям", "кормовые юго-восточные солнечные панели", "кормовыми юго-восточными солнечными панелями", "кормовых юго-восточных солнечных панелях")
	icon_state = "panelsS"

/area/station/solar/port
	name = "Aft Port Solar Array"
	cases = list("кормовые юго-западные солнечные панели", "кормовых юго-западных солнечных панелей", "кормовым юго-западным солнечным панелям", "кормовые юго-западные солнечные панели", "кормовыми юго-западными солнечными панелями", "кормовых юго-западных солнечных панелях")
	icon_state = "panelsP"

/area/station/maintenance/auxsolarport
	name = "Fore Port Solar Maintenance"
	cases = list("носовые северо-западные технические тоннели", "носовых северо-западных технических тоннелей", "носовым северо-западным техническим тоннелям", "носовые северо-западные технические тоннели", "носовыми северо-западными техническими тоннелями", "носовых северо-западных технических тоннелях")
	icon_state = "SolarcontrolA"

/area/station/maintenance/starboardsolar
	name = "Aft Starboard Solar Maintenance"
	cases = list("кормовые юго-восточные технические тоннели", "кормовых юго-восточных технических тоннелей", "кормовым юго-восточным техническим тоннелям", "кормовые юго-восточные технические тоннели", "кормовыми юго-восточными техническими тоннелями", "кормовых юго-восточных технических тоннелях")
	icon_state = "SolarcontrolS"

/area/station/maintenance/portsolar
	name = "Aft Port Solar Maintenance"
	cases = list("кормовые юго-западные солнечные тоннели", "кормовых юго-западных технических тоннелей", "кормовым юго-западным техническим тоннелям", "кормовые юго-западные технические тоннели", "кормовыми юго-западными техническими тоннелями", "кормовых юго-западных технических тоннелях")
	icon_state = "SolarcontrolP"

/area/station/maintenance/auxsolarstarboard
	name = "Fore Starboard Solar Maintenance"
	cases = list("носовые северо-восточные технические тоннели", "носовых северо-восточных технических тоннелей", "носовым северо-восточным техническим тоннелям", "носовые северо-восточные технические тоннели", "носовыми северо-восточными техническими тоннелями", "носовых северо-восточных технических тоннелях")
	icon_state = "SolarcontrolA"
...
/area/station/bridge/comms
	...
	cases = list("коммуникационное реле", "коммуникационного реле", "коммуникационному реле", "коммуникационное реле", "коммуникационным реле", "коммуникационной реле")
