...
/area/station/engineering/equip
	...
	cases = list("склад ИО", "склада ИО", "складу ИО")
...
/area/station/maintenance/brigright
	...
	cases = list("технические туннели брига на правом борту", "технических туннелей брига на правом борту", "техническим туннелям брига на правом борту", "технические туннели брига на правом борту", "техническими туннелями брига на правом борту", "технических туннелях брига на правом борту")
	icon_state = "fmaint"

/area/station/maintenance/brig
	name = "Port Brig Maintenance"
	cases = list("западные технические туннели брига", "западных технических туннелей брига", "западным техническим туннелям брига", "западные технические туннели брига", "западными техническими туннелями брига", "западных технических туннелях брига")
	icon_state = "fmaint"
