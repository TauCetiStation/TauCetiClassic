...
/area/station/maintenance/brigright
	...
	cases = list("восточные тех. туннели брига", "восточных тех. туннелей брига", "восточным тех. туннелям брига", "восточные тех. туннели брига", "восточными тех. туннелями брига", "восточных тех. туннелях брига")
	icon_state = "fmaint"

/area/station/maintenance/brig
	name = "Port Brig Maintenance"
	cases = list("западные тех. туннели брига", "западных тех. туннелей брига", "западным тех. туннелям брига", "западные тех. туннели брига", "западными тех. туннелями брига", "западных тех. туннелях брига")
	icon_state = "fmaint"
