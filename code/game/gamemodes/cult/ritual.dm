...
/obj/item/weapon/book/tome
	...
	tomedat = {"<html>
				...
				<b>Пригласить в культ: </b>Join Blood Self<br>
				...
				В отличии от руны поднятия мертвеца, эта не требует приготовлений или сосуда. Вместо поглощения жизненной силы из жертвы, она будет высасывать вашу. Встаньте на руну и активируйте ее. Если призрак будет стоять на руне, то он матерализуется и будет жить до тех пор, пока вы стоите на ней или пока вы не умерете. Вы можете положить листок с именем на руну, чтобы новое тело выглядело как человек с этим именем.<br>
				...
				Позволяет снять наручники и отстегнуть от стула культиста, где бы он не находился. Вам понадобятся три человка, для проведения ритуала. Активация руны оказывает сильное воздействие на тела участников ритуала.<br>
				<h3>Оглушить</h3>
				...
				<h3>Ошеломление</h3>
				В отличии от прочих рун, эта предназначена для использования в форме талисмане. Если активировоть напрямую - выпускает немного темной энергии и ошелмоляет всех вокруг. Если ею насытить талисман, то вы сможете высвободить всю ее энергию и направить в одного человека, ошеломляя его так сильно, что тот даже не сможет говорить. Эффект временный и быстро пропадает.<br>
				<h3>Призыв брони</h3>
				...
				Может быть активирована только в качестве талисмана. Призывает пустой камень душ, который можно насыть лишь живой душой. Процесс поимки души довольно щепетильный и требует жертвопринощения. В момент последнего вздоха жертвы поднесите камень к телу, чтобы поймать его душу.
				<h3>Смена тел</h3>
