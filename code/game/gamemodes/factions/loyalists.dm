...
/datum/mutiny_scenario/money/get_third_report()
	...
	report_dat += "Переведите все реквезированные у бывших сотрудников корпорации средства и содержимое счёта станции в наличные.<br>"
...
/datum/mutiny_scenario/racism/get_first_report()
	...
	report_dat += "Центральное Командование временно отстраняет всех глав и других представителей коммандования не из числа людей от работы на станции.<br>"
	return report_dat
...
/datum/mutiny_scenario/racism/get_second_report()
	...
	report_dat += "Центральное Командование хочет пригласить наших новых партнёров на станцию.<br>"
...
/datum/mutiny_scenario/racism/get_third_report()
	...
	report_dat += "Центральное Командование также требует для них ношение одежды прикрывающей все части тела, окроме глаз, пока они находятся на станции.<br>"
	return report_dat
...
/datum/mutiny_scenario/brutality/get_third_report()
	...
	report_dat += "По их заверениям, стоит поставить данную продукции Шахтёрской сети на астероидном поясе в вашей системе.<br>"
...
/datum/mutiny_scenario/mine/get_third_report()
	...
	report_dat += "Центральное Командование приказывает поставить все ресурсы, которые есть на астероиде, даже если прийдётся весь его вскопать.<br>"
