...
На этой станции был обнаружен артефакт, дарующий людям Силу. Вы, и ещё один ситх, смогли внедриться сюда в качестве работников.
...
Для насильного конверта, используйте третий навык - промывку мозгов.
