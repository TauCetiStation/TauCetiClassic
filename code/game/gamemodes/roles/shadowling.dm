...
/datum/role/shadowling/Greet(greeting, custom)
	...
	to_chat(antag.current, "<b>В этой слабой оболочке вы способны лишь: Enthrall - поработить не просвещенного, Hatch - облочиться в свою истинную форму(находится во вкладке Shadowling Evolution в верхней-правой части экрана), и Hivemind Commune - общаться с себе подобными братьями и рабами.</b>")
