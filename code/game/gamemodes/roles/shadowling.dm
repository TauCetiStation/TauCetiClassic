...
/datum/role/shadowling/Greet(greeting, custom)
	...
	to_chat(antag.current, "<b>В этой слабой оболочке вы способны лишь: Enthrall - проработить не просвященого, Hatch - облочиться в свою истиную форму(находится во вкладке Shadowling Evolution в верхней-правой части экрана), и Hivemind Commune - общаться с себе подобными братьями и рабами.</b>")
