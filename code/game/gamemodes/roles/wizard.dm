...
/datum/role/wizard/proc/equip_wizard(mob/living/carbon/human/wizard_mob)
	...
	to_chat(wizard_mob, "<span class='info'>У вас в карманах вы сможете найти Свиток Телепортации, который телепортирует вас в указаное место под покровом дыма. Используйте его при надобности.</span>")
	wizard_mob.mind.store_memory("<B>Помните:</B> не забудьте приготовить свои заклинания.")
