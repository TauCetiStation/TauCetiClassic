...
/datum/role/changeling/Greet(greeting, custom)
	...
	to_chat(antag.current, "<span class='notice'>Мы Генокрад, существо из далеких уголков космоса. У нас есть задачи на этой станции которые нужно выполнить используя свою сообразительность и при необходимости свои генетические возможности(возле вкладки Status в правой-верхней части экрана, у вас появилась вкладка Changelling в которой вы можете приобрети и использовать свои способности).</span>")
