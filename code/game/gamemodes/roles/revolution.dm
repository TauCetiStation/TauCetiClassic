...
/datum/role/rev_leader
	...
	restricted_jobs = list("Security Cadet", "Security Officer", "Warden", "Detective", "Blueshield Officer", "AI", "Cyborg","Captain", "Head of Personnel", "Head of Security", "Chief Engineer", "Research Director", "Chief Medical Officer", "Internal Affairs Agent")
