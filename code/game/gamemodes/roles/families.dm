/datum/role/gangster
	...
	restricted_jobs = list("Head of Personnel", "Security Cadet", "AI", "Cyborg", "Security Officer", "Warden", "Detective", "Blueshield Officer", "Head of Security", "Captain", "Internal Affairs Agent")
