/datum/objective/save_station
	explanation_text = "Сохраните целостность станции от критических разрушений. Хотя бы 85% станции должна остаться целой"

/datum/objective/save_station/check_completion()
	if(SSticker.station_was_nuked || SSticker.nar_sie_has_risen)
...
/datum/objective/save_station/gang
