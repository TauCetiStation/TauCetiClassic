/datum/objective/gang/rob_nt
	explanation_text = "У нашего поставщика дури возникли некоторые проблемы. Чтобы ему помочь нужны бабки. Попытайтесь где-то найти хотя бы 2000 кредитов наличкой."
