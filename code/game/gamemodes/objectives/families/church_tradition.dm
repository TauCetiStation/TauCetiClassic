/datum/objective/gang/church_tradition
	explanation_text = "Босс хочет, чтобы ко всем нашим уважаемым коллегам относились с должным уважением. Если друг упадет, убедись, что его должны похоронят в гробу. И защитите жизни всех священников, чтобы обеспечить надлежащий уход за трупами."
