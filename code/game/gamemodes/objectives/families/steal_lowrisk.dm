...
/datum/objective/gang/steal_lowrisk/all
	...
	var/static/todays_steal_objectives=list(pick(items_to_steal),pick(items_to_steal),pick(items_to_steal))

/datum/objective/gang/steal_lowrisk/all/proc/get_steal_objective()
