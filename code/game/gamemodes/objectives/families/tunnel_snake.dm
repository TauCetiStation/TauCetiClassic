/datum/objective/gang/tunnel_snake
	explanation_text = "ТУННЕЛЬНЫЕ ЗМЕИ РУЛЯТ!!! Убедись, что все это знаю, заставь хотя бы 25% людей на станции носить любую часть нашей униформу! ТУННЕЛЬНЫЕ ЗМЕИ РУЛЯТ!!!"
