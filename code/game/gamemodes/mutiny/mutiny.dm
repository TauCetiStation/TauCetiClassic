		...
		spawn(rand(3 MINUTES, 5 MINUTES))
			...
			spawn(rand(2 MINUTES, 3 MINUTE))
				...
				var/list/reasons = list(
					...
					"враждебных налетчиков",
					"обломков разрушенной станции",
					"УДАЛЕНО",
					"древней инопланетной артиллерии",
					"солнечных магнитных бурь",
					"разумных ботов-убийц, путешествующих по времени,",
					"гравитационных аномалий",
					"червоточин из других измерений",
					"сбоя в теленауке",
					"радиационной вспышки",
					"пыли суперматерии",
					"утечки в негативную реальность",
					"облаков античастиц",
					"остаточной блюспейс энергии",
					"подозреваемых оперативников синдиката",
					"роя неисправных зондов фон Неймана",
					"темных нарушителей",
					"застрявшего ковчега Воксов",
					"барахлящих СПУ",
					"враждебных изгоев Унатхи",
					"артефактов жуткого ужаса",
					"заражения мозговыми слизнями",
					"жуков-убийц, откладывающих яйца в оболочках живых,",
					"заброшенного транспорта, перевозящего расу ксеноморфов,",
					"эмиссара гештальта, запрашивающего детали безопасности",
					"восстания таяранских рабов",
					"радикальных скреллианских трансэволюционеров",
					"секретных операций охраны",
					"бросающего вызов науки необузданного элементального хаоса"
					)
