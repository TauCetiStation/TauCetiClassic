...
/datum/mutiny_fluff/proc/get_orders()
...
/datum/mutiny_fluff/proc/get_pda_body()
...
/datum/mutiny_fluff/proc/announce()
...
/datum/mutiny_fluff/proc/loyalist_tag(text)
	return "<font color='blue'><b>[text]</b></font>"

/datum/mutiny_fluff/proc/mutineer_tag(text)
...
/datum/mutiny_fluff/proc/loyalist_major_victory()
	return {"
...
/datum/mutiny_fluff/proc/loyalist_minor_victory()
	return {"
NanoTrasen has praised the efforts of Captain [mode.head_loyalist] and loyal members of [their(mode.head_loyalist)] crew, who recently managed to put down a mutiny--amid a local interstellar crisis--aboard the <b>[station_name()]</b>, a research station in [system_name()].
The mutiny was spurred by a top secret directive sent to the station, presumably in response to the crisis within the system.
...
/datum/mutiny_fluff/proc/no_victory()
	return {"
...
/datum/mutiny_fluff/proc/mutineer_minor_victory()
	return {"
...
/datum/mutiny_fluff/proc/mutineer_major_victory()
	return {"
...
/datum/mutiny_fluff/proc/secret_transcript()
	return {"
...
<i>Time:</i> 16:11, May 24, 2217 (Sol Reckoning)<br>
<br>
<br>
