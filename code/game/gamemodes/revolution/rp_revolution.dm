...
/datum/game_mode/revolution/rp_revolution/add_revolutionary(datum/mind/rev_mind)
	...
	to_chat(rev_mind.current, "<span class=warning'><FONT size = 3> You are now a revolutionary! Help your cause. Do not harm your fellow freedom fighters. You can identify your comrades by the red \</span>"R\" icons, and your leaders by the blue \"R\" icons. Help them kill, capture or convert the heads to win the revolution!</FONT>")
