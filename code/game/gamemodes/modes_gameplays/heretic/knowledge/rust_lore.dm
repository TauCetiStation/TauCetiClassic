...
/datum/heretic_knowledge/blade_upgrade/rust/do_melee_effects(mob/living/source, mob/living/target, obj/item/weapon/sickly_blade/blade)
...
/datum/heretic_knowledge/ultimate/rust_final
	...
	var/area/ritual_location = /area/station/bridge
...
/datum/heretic_knowledge/ultimate/rust_final/proc/on_life(mob/living/source, seconds_per_tick, times_fired)
	...
	need_mob_update += source.adjustHalLoss(-base_heal_amt * 4, updating_stamina = FALSE)
