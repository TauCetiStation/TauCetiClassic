...
/proc/fire_curse_hand(mob/living/carbon/victim, turf/forced_turf, range = 8, projectile_type = /obj/item/projectile/curse_hand/hel)
	...
	var/obj/item/projectile/hand = new projectile_type(spawn_turf)
