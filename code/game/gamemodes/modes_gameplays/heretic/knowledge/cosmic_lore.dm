...
/datum/heretic_knowledge/blade_upgrade/cosmic/do_melee_effects(mob/living/source, mob/living/target, obj/item/weapon/sickly_blade/blade)
	...
	if(second_target_resolved)
		...
		playsound(get_turf(second_target_resolved), 'sound/effects/cosmic_energy.ogg', 25, FALSE)
		...
		if(third_target_resolved)
			...
			playsound(get_turf(third_target_resolved), 'sound/effects/cosmic_energy.ogg', 50, FALSE)
			need_mob_update = FALSE
...
/datum/heretic_knowledge/spell/cosmic_expansion
	...
	action_to_add = /obj/effect/proc_holder/spell/conjure/cosmic_expansion
	cost = 1
...
/datum/heretic_knowledge/ultimate/cosmic_final/on_finished_recipe(mob/living/user, list/selected_atoms, turf/loc)
	...
	var/datum/role/heretic/heretic_datum = user.mind.GetRoleByType(/datum/role/heretic)
	...
	var/obj/effect/proc_holder/spell/conjure/cosmic_expansion/cosmic_expansion_spell = locate() in user.actions
