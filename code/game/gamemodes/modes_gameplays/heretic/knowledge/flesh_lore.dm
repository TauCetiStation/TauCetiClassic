...
/datum/heretic_knowledge/limited_amount/flesh_grasp/on_gain(mob/user, datum/role/heretic/our_heretic)
	RegisterSignal(user, COMSIG_HERETIC_MANSUS_GRASP_ATTACK, PROC_REF(on_mansus_grasp))

/datum/heretic_knowledge/limited_amount/flesh_grasp/on_lose(mob/user, datum/role/heretic/our_heretic)
...
/datum/heretic_knowledge/limited_amount/flesh_ghoul/proc/apply_to_ghoul(mob/living/ghoul)
	LAZYADD(created_items, WEAKREF(ghoul))
	ADD_TRAIT(ghoul, TRAIT_MUTE, STATUS_EFFECT_TRAIT)

/// Callback for the ghoul status effect - Tracks all of our ghouls and applies effects
/datum/heretic_knowledge/limited_amount/flesh_ghoul/proc/remove_from_ghoul(mob/living/ghoul)
	LAZYREMOVE(created_items, WEAKREF(ghoul))
	REMOVE_TRAIT(ghoul, TRAIT_MUTE, STATUS_EFFECT_TRAIT)
...
/datum/heretic_knowledge/blade_upgrade/flesh/do_melee_effects(mob/living/source, mob/living/target, obj/item/weapon/sickly_blade/blade)
...
/datum/heretic_knowledge/summon/stalker
	name = "Lonely Ritual"
	desc = "Allows you to transmute kidneys, a tongue, a pen and a piece of paper to create a Stalker. \
...
/datum/heretic_knowledge/ultimate/flesh_final
	...
	announcement_text = "%SPOOKY% Неутихаемый вихрь! Реальность развернута. ВСКИНУВ СВОИ РУКИ, ЛОРД НОЧИ, %NAME% ВОЗНЕССЯ! Бойтесь же его бесприкаянной руки! %SPOOKY%"
