...
/obj/effect/lock_portal/proc/teleport(mob/living/teleportee)
	...
	//get it?
	var/obj/machinery/door/doorstination = (inverted ? !ishereticormonster(teleportee) : ishereticormonster(teleportee)) ? destination.our_airlock : find_random_airlock()
	...
	if(!ishereticormonster(teleportee))
