/mob/living/carbon/human/proc/equip_vox_raider()
	...
	switch(vox_tick)
		if(1) // Vox raider!
			equip_to_slot_or_del(new /obj/item/clothing/suit/space/rig/vox/carapace, SLOT_WEAR_SUIT)
			equip_to_slot_or_del(new /obj/item/clothing/head/helmet/space/rig/vox/carapace, SLOT_HEAD)
		...
		if(2) // Vox engineer!
			equip_to_slot_or_del(new /obj/item/clothing/suit/space/rig/vox/pressure, SLOT_WEAR_SUIT)
			equip_to_slot_or_del(new /obj/item/clothing/head/helmet/space/rig/vox/pressure, SLOT_HEAD)
		...
		if(3) // Vox saboteur!
			equip_to_slot_or_del(new /obj/item/clothing/suit/space/rig/vox/stealth, SLOT_WEAR_SUIT)
			equip_to_slot_or_del(new /obj/item/clothing/head/helmet/space/rig/vox/stealth, SLOT_HEAD)
			equip_to_slot_or_del(new /obj/item/weapon/storage/belt/utility/full, SLOT_BELT)
			equip_to_slot_or_del(new /obj/item/clothing/glasses/thermal, SLOT_GLASSES) // REPLACE WITH CODED VOX ALTERNATIVE.
		...
		if(4) // Vox medic!
			equip_to_slot_or_del(new /obj/item/clothing/suit/space/rig/vox/medic, SLOT_WEAR_SUIT)
			equip_to_slot_or_del(new /obj/item/clothing/head/helmet/space/rig/vox/medic, SLOT_HEAD)
