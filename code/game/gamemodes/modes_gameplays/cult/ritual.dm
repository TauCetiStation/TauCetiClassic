...
/obj/item/weapon/book/tome/attack_self(mob/living/carbon/human/user)
	...
	if (length(cult_runes) >= CULT_RUNES_LIMIT + length(cult.members)) //including the useless rune at the secret room, shouldn't count against the limit of 25 runes - Urist
