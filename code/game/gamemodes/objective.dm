...
/datum/objective/heist/loot/check_completion()
	...
	for(var/obj/O in get_area_type(/area/shuttle/vox/arkship))
...
/datum/objective/heist/salvage/check_completion()
	...
	for(var/obj/item/O in get_area_type(/area/shuttle/vox/arkship))
...
/datum/objective/heist/robbery/check_completion()
	heist_rob_total = 0
	for(var/atom/movable/AM in get_area_type(/area/shuttle/vox/arkship))
		heist_recursive_price_check(AM)
