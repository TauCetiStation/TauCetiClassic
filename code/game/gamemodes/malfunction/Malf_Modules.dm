...
/datum/AI_Module/proc/BuyedUsesHandle()
...
/datum/AI_Module/large/disable_rcd
	...
	verb_caller = /client/proc/disable_rcd
...
/datum/AI_Module/small/blackout
	...
	uses = 3
	verb_caller = /client/proc/blackout
...
/datum/AI_Module/small/reactivate_camera
	...
	uses = 10
	verb_caller = /client/proc/reactivate_camera
...
/client/proc/reactivate_camera()
	...
	if(!length(disabled_cameras))
		to_chat(cur_AI, "No cameras found or all cameras in your field of view is either active, or not repairable.")
		return
			
	var/obj/machinery/camera/sel_cam = input(cur_AI, "Reactivate Camera","Choose Object") in disabled_cameras
	if(!sel_cam)
		return
	...
	to_chat(cur_AI, "Camera successully reactivated!")
