...
/datum/game_mode/infestation/proc/greet_xeno(datum/mind/xeno)
	to_chat(xeno.current, "<span class='green'><B>You are a Xenomorph.</b></span>")
	to_chat(xeno.current, "<span class='green'><B>Your current alien form is a facehugger.</b></span>")
	to_chat(xeno.current, "<span class='green'><B>Go find some monkeys, corgi or a sleeping human.</b></span>")
	to_chat(xeno.current, "<span class='green'><B>To leap at someones face, you simply start with left mouse button click.</b></span>")
	to_chat(xeno.current, "<span class='green'><B>Then check your tail action button, there will be leap available.</b></span>")
	to_chat(xeno.current, "<span class='green'><B>Leap isnt instant, keep that in mind. There is 1-2 seconds delay, before you can actually leap.</b></span>")
	to_chat(xeno.current, "<span class='green'><B>You target also must be near, after you prepares to leap.</b></span>")
	to_chat(xeno.current, "<span class='notice'>Use :A to hivetalk.</span>")
	to_chat(xeno.current, "<span class='green'>------------------</span>")
