...
/datum/game_mode/heist/proc/greet_vox(datum/mind/raider)
	...
	<font color='red'>[sanitize_alt("Крайне рекомендуется ознакомиться вот с этой статьей или найти аналог - http://tauceti.ru/wiki/Vox_Raider")]</font><BR>
	...
	[sanitize_alt("- Стелометы (spike thrower) имеют бесконечный заряд, однако восполнение \"шипов\" происходит раз в 10 секунд и как любое оружие такого типа - способно откинуть космонавта на 5 квадратов и даже пристрелить к бочке, двери, стене что как минимум обездвижет вашу цель пока она не вытащит застрявший шип.")]<BR>
