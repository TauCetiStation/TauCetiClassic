/obj/effect/proc_holder/changeling/strained_muscles
	...
	helptext = "Использование этой способности быстро оставит вас без сил. Тяжёлые предметы, такие как скафандры, всё ещё замедляют движение. Не может быть использовано в форме обезьяны."
	genomecost = 3
	req_human = 1
