...
/obj/effect/proc_holder/changeling/sting/cryo
	...
	desc = "Мы незаметно жалим человека коктейлем из химикатов, замораживающих его тело."
	helptext = "Не заметен для жертвы, хотя она, скорее всего, поймет, что внезапно начала замерзать."
...
/obj/effect/proc_holder/changeling/sting/LSD
	...
	helptext = "Жалит цель мощными галлюциногенными химикатами. Цель не замечает укуса. Эффект наступает через 30-60 секунд."
...
/obj/effect/proc_holder/changeling/sting/transformation
	...
	desc = "Мы незаметно жалим человека, вводя ретровирус, заставляющий жертву трансформироваться."
	helptext = "Укол не заметен для окружающих. Жертва трансформируется так же, как генокрад."
...
/obj/effect/proc_holder/changeling/sting/silence
	name = "Жало Безмолвья"
	desc = "Мы незаметно жалим человека, делая его полностью глухим и немым на короткое время."
