...
/obj/effect/proc_holder/changeling/weapon/shield
	...
	helptext = "Органическая ткань не может противостоять повреждениям вечно, щит сломается после слишком сильного удара. Чем больше геномов вы поглотили, тем он сильнее. Нельзя использовать в форме обезьяны."
	chemical_cost = 20
	genomecost = 2
	genetic_damage = 12
	req_human = 1
...
/obj/effect/proc_holder/changeling/suit/organic_space_suit
	...
	helptext = "Вы должны постоянно ремонтировать такую форму, чтобы она оставалась герметичной, сокращая производство химикатов, пока вы защищены. Сброс костюма повреждает наши геномы. Не может использоваться в форме обезьяны."
	chemical_cost = 20
	genomecost = 2
	genetic_damage = 8
	req_human = 1
...
/obj/effect/proc_holder/changeling/suit/armor
	...
	desc = "Мы превращаем нашу кожу в прочный хитин, защищающий от повреждений."
	helptext = "Поддержание брони требует небольшого расхода химикатов. Броня устойчива против физических повреждений, но не защищает от лазеров. Сброс брони повреждает ваши геномы. Не может использоваться в форме обезьяны."
	chemical_cost = 25
	genomecost = 2
	genetic_damage = 10
	req_human = 1
