...
/obj/effect/proc_holder/changeling/suit/armor
	...
	helptext = "Уход за броней требует небольшого расхода химикатов. Броня устойчива против физических повреждений, но не защищает от лазеров. Сброс брони повреждает ваши геномы. Не может использоваться в форме обезьяны."
	chemical_cost = 25
	genomecost = 2
	genetic_damage = 10
	req_human = 1
