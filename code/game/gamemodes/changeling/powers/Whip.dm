/obj/effect/proc_holder/changeling/weapon/whip
	...
	helptext = "В зависимости от интента, позволяет хватать, сбивать с ног, атаковать на небольшой дистанции. Требует много химикатов за каждое использование. Нельзя использовать в форме обезьяны."
	chemical_cost = 20
	genomecost = 4
	genetic_damage = 12
	req_human = 1
