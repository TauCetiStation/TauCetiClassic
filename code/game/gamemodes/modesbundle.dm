...
/datum/modesbundle/all/secret/New()
	black_types = subtypesof(/datum/game_mode/mix) + subtypesof(/datum/game_mode/ivent) + list(/datum/game_mode/extended, /datum/game_mode/malfunction, /datum/game_mode/junkyard)
	..()
