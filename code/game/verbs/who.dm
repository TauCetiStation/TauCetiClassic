...
#define SW_TR(CKEY, RANK, EXTRA) "<tr><td>&emsp;[CKEY]</td><td><b>[SSholiday.get_staffwho_prefix(CKEY.ckey) ? SSholiday.get_staffwho_prefix(ckey) + " " : "B"][RANK]</b></td><td>[EXTRA]</td></tr>"
