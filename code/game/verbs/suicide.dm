...
/mob/living/silicon/pai/verb/suicide()
	...
	if(answer == "Yes")
		...
		for (var/mob/M in viewers(T))
			M.show_message("<span class='notice'>[src] flashes a message across its screen, \</span>"Wiping core files. Please acquire a new personality to continue using pAI device functions.\"", 3, "<span class='notice'>[src] bleeps electronically.</span>", 2)
		death(0)
	else
