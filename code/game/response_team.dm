...
/client/verb/JoinResponseTeam()
	...
	/*	if(admin_emergency_team)
		...
		for (var/obj/effect/landmark/L in landmarks_list) if (L.name == "Commando")
			...
			if(!leader_selected)
				to_chat(new_commando, "<b>As member of the Emergency Response Team, you answer to your leader and CentCom officials with higher priority and captain with lower</b>")
			else
