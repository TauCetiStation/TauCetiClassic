...
/datum/dna/proc/check_integrity(mob/living/carbon/human/character)
	if(character)
		if(length(uni_identity) != 39)
			...
			temp = add_zero2(num2hex((character.natural_r_hair),1), 3)
			temp += add_zero2(num2hex((character.natural_b_hair),1), 3)
			temp += add_zero2(num2hex((character.natural_g_hair),1), 3)
			temp += add_zero2(num2hex((character.natural_r_facial),1), 3)
			temp += add_zero2(num2hex((character.natural_b_facial),1), 3)
			temp += add_zero2(num2hex((character.natural_g_facial),1), 3)
