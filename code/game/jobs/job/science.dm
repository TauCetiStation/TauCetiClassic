/datum/job/rd
	...
	access = list(
		...
		access_RC_announce, access_keycard_auth, access_tcomsat, access_gateway, access_xenoarch, access_maint_tunnels,  access_eva
	)
	salary = 250
...
/datum/job/xenoarchaeologist
	...
	selection_color = "#ffeeff"
	idtype = /obj/item/weapon/card/id/sci
	access = list(access_research, access_xenoarch, access_eva)
	salary = 190
