/datum/job/chief_engineer
	...
	skill_sets = list("Chief Engineer" = /datum/skillset/ce)
	/*
		HEY YOU!
...
/datum/job/engineer
	...
	skill_sets = list("Station Engineer" = /datum/skillset/engineer)
	salary = 160
...
/datum/job/atmos
	...
	skill_sets = list("Atmospheric Technician" = /datum/skillset/atmostech)
...
/datum/job/technical_assistant
	...
	skill_sets = list("Technical Assistant" = /datum/skillset/technicassistant)
