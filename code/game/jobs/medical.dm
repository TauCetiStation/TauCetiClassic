...
/datum/job/cmo
	...
	access = list(
		...
		access_medbay_storage, access_medical_barrier
	)
	salary = 250
...
/datum/job/doctor
	...
	access = list(access_medical, access_morgue, access_surgery, access_maint_tunnels, access_medbay_storage, access_medical_barrier)
	salary = 160
	alt_titles = list(
...
/datum/job/paramedic
	...
	selection_color = "#ffeef0"
	idtype = /obj/item/weapon/card/id/med
	access = list(access_medical, access_morgue, access_paramedic, access_maint_tunnels, access_external_airlocks, access_sec_doors, access_research, access_medbay_storage, access_engineering_lobby, access_medical_barrier)
	salary = 120
...
/datum/job/chemist
	...
	selection_color = "#ffeef0"
	idtype = /obj/item/weapon/card/id/med
	access = list(access_medical, access_chemistry, access_medbay_storage, access_medical_barrier)
	salary = 150
...
/datum/job/geneticist
	...
	selection_color = "#ffeef0"
	idtype = /obj/item/weapon/card/id/med
	access = list(access_medical, access_morgue, access_genetics, access_research, access_medbay_storage, access_medical_barrier)
	salary = 180
	minimal_player_ingame_minutes = 960
...
/datum/job/virologist
	...
	selection_color = "#ffeef0"
	idtype = /obj/item/weapon/card/id/med
	access = list(access_medical, access_virology, access_medbay_storage, access_medical_barrier)
...
/datum/job/psychiatrist
	...
	selection_color = "#ffeef0"
	idtype = /obj/item/weapon/card/id/med
	access = list(access_medical, access_psychiatrist, access_medbay_storage, access_medical_barrier)
...
/datum/job/intern
	...
	selection_color = "#ffeef0"
	idtype = /obj/item/weapon/card/id/med
	access = list(access_medical, access_medical_barrier)
	salary = 50
