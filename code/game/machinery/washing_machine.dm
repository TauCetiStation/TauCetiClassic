var/global/list/dyed_item_types = list(
	DYED_UNIFORM = list(
		DYE_RED = /obj/item/clothing/under/red,
		DYE_ORANGE = /obj/item/clothing/under/orange,
		DYE_YELLOW = /obj/item/clothing/under/yellow,
		DYE_GREEN = /obj/item/clothing/under/green,
		DYE_BLUE = /obj/item/clothing/under/blue,
		DYE_PURPLE = /obj/item/clothing/under/purple,
		DYE_WHITE = /obj/item/clothing/under/white,
