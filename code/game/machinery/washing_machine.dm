var/global/list/dyed_item_types = list(
	DYED_UNIFORM = list(
		DYE_RED = /obj/item/clothing/under/colored/red,
		DYE_ORANGE = /obj/item/clothing/under/colored/orange,
		DYE_YELLOW = /obj/item/clothing/under/colored/yellow,
		DYE_GREEN = /obj/item/clothing/under/colored/green,
		DYE_BLUE = /obj/item/clothing/under/colored/blue,
		DYE_PURPLE = /obj/item/clothing/under/colored/purple,
		DYE_WHITE = /obj/item/clothing/under/colored/white,
	...
	DYED_SOFTCAP = list(
		...
		DYE_GREY = /obj/item/clothing/head/soft/grey,
		DYE_CMO = /obj/item/clothing/head/soft/paramed,
		DYE_CARGO = /obj/item/clothing/head/soft/cargo,
