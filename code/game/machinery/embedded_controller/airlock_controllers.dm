...
/obj/machinery/embedded_controller/radio/airlock_controller/generate_connections_management()
	...
	if(!airlock_sensors_showed)
		...
		if(chamber_sensor)
			. += "<li><b>Chamber  - <font color='green'>Connected</font> | <a href='?src=\ref[src];disconnect=chamber_sensor'>Disconnect</a></b></li>"
		else
			. += "<li><b>Chamber  - <font color='red'>Not connected</font> | <a href='?src=\ref[src];connect=sensor;type=chamber'>Connect</a></b></li>"
	...
	if(!airpumps_showed)
		...
		if(!airpumps.len)
			. += "<li><b>[airpump_number]  - <font color='red'>Not connected</font> | <a href='?src=\ref[src];connect=airpump'>Connect</a></b></li>"

		else
			for(var/airpump in airpumps)
				. += "<li><b>[airpump_number]  - <font color='green'>Connected</font> | <a href='?src=\ref[src];disconnect=airpump;airpump=[airpump_number]'>Disconnect</a></b></li>"
				airpump_number++
...
/obj/machinery/embedded_controller/radio/advanced_airlock_controller/generate_connections_management()
	...
	if(!airlock_sensors_showed)
		...
		if(interior_sensor)
			. += "<li><b>Internal  - <font color='green'>Connected</font> | <a href='?src=\ref[src];disconnect=interior_sensor'>Disconnect</a></b></li>"
		else
			. += "<li><b>Internal  - <font color='red'>Not connected</font> | <a href='?src=\ref[src];connect=sensor;type=interior'>Connect</a></b></li>"

		if(exterior_sensor)
			. += "<li><b>External  - <font color='green'>Connected</font> | <a href='?src=\ref[src];disconnect=exterior_sensor'>Disconnect</a></b></li>"
		else
			. += "<li><b>External  - <font color='red'>Not connected</font> | <a href='?src=\ref[src];connect=sensor;type=exterior'>Connect</a></b></li>"
