...
/obj/item/weapon/circuitboard/labor_shuttle/flight_comp
	name = "Circuit board (Labor Camp Shuttle flight computer)"
	build_path = /obj/machinery/computer/labor_shuttle/flight_comp
	origin_tech = "programming=2"
