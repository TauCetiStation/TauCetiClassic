/obj/machinery/computer/cloning
	...
	cases = list("консоль для капсулы клонирования", "консоли для капсулы клонирования", "консоли для капсулы клонирования", "консоль для капсулы клонирования", "консолью для капсулы клонирования", "консоли для капсулы клонирования")
	...
	switch(src.menu)
		if(1)
			...
			if (isnull(src.scanner))
				...
				dat += "Lock status: <a href='byond://?src=\ref[src];lock=1'>[src.scanner.locked ? "Заблокирован" : "Разблокирован"]</a><br>"
