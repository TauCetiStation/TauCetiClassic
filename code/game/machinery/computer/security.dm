...
//RECORD FUNCTIONS
		if("Search Records")
			var/t1 = sanitize(input("Search String: (Partial Name or ID or Fingerprints or Rank)", "Secure. records", null, null)  as text, usr)
...
//RECORD DELETE
		...
		if("Add Entry")
			if(!istype(active2, /datum/data/record))
				return
			var/a2 = active2
			var/t1 = sanitize(input("Add Comment:", "Secure. records", null, null)  as message, usr)
			...
			switch(href_list["field"])
				if("name")
					if(istype(active1, /datum/data/record))
						var/t1 = sanitize(input("Please input name:", "Secure. records", input_default(active1.fields["name"]), null)  as text, usr)
						if(!t1 || active1 != a1)
							return FALSE
						active1.fields["name"] = t1
				if("id")
					if(istype(active2, /datum/data/record))
						var/t1 = sanitize(input("Please input id:", "Secure. records", input_default(active1.fields["id"]), null)  as text, usr)
						if(!t1 || active1 != a1)
							return FALSE
						active1.fields["id"] = t1
				if("fingerprint")
					if(istype(active1, /datum/data/record))
						var/t1 = sanitize(input("Please input fingerprint hash:", "Secure. records", input_default(active1.fields["fingerprint"]), null)  as text, usr)
						if(!t1 || active1 != a1)
							return FALSE
				...
				if("mi_crim")
					if(istype(active2, /datum/data/record))
						var/t1 = sanitize(input("Please input minor disabilities list:", "Secure. records", input_default(active2.fields["mi_crim"]), null)  as text, usr)
						if (!t1 || active2 != a2)
							return FALSE
						active2.fields["mi_crim"] = t1
				if("mi_crim_d")
					if(istype(active2, /datum/data/record))
						var/t1 = sanitize(input("Please summarize minor dis.:", "Secure. records", input_default(active2.fields["mi_crim_d"]), null)  as message, usr)
						if (!t1 || active2 != a2)
							return FALSE
						active2.fields["mi_crim_d"] = t1
				if("ma_crim")
					if(istype(active2, /datum/data/record))
						var/t1 = sanitize(input("Please input major diabilities list:", "Secure. records", input_default(active2.fields["ma_crim"]), null)  as text, usr)
						if (!t1 || active2 != a2)
							return FALSE
						active2.fields["ma_crim"] = t1
				if("ma_crim_d")
					if (istype(active2, /datum/data/record))
						var/t1 = sanitize(input("Please summarize major dis.:", "Secure. records", input_default(active2.fields["ma_crim_d"]), null)  as message, usr)
						if(!t1 || active2 != a2)
							return FALSE
						active2.fields["ma_crim_d"] = t1
				if("notes")
					if(istype(active2, /datum/data/record))
						var/t1 = sanitize(input("Please summarize notes:", "Secure. records", input_default(active2.fields["notes"]), null)  as message, usr)
						if (!t1 || active2 != a2)
							return FALSE
				...
				if("species")
					if (istype(active1, /datum/data/record))
						var/t1 = sanitize(input("Please enter race:", "General records", input_default(active1.fields["species"]), null) as message, usr)
