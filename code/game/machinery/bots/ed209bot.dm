...
/obj/machinery/bot/secbot/ed209/look_for_perp()
	...
	for(var/mob/living/L in view(12, src)) //Let's find us a criminal
		...
		if(threatlevel >= 4)
			...
			if(!lasercolor)
				playsound(src, pick('sound/voice/ed209_20sec.ogg', 'sound/voice/EDPlaceholder.ogg'), VOL_EFFECTS, null, FALSE)
...
/obj/machinery/bot/secbot/ed209/proc/shootAt(mob/target)
	...
	//	playsound(src, 'ed209_shoot.ogg', VOL_EFFECTS, null, FALSE)
