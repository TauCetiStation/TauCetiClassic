...
/proc/Broadcast_Message(var/datum/radio_frequency/connection, var/mob/M,
						...
						var/message, scrambled_message, var/name, var/job, var/realname, var/vname,
	 ...
	 /* ###### Send the message ###### */
		...
		if (length(heard_masked))
			for (var/mob/R in heard_masked)
				R.hear_radio(message, scrambled_message, verbage, speaking, part_a, part_b, part_c, M, 0, name)

		/* --- Process all the mobs that heard the voice normally (understood) --- */

		if (length(heard_normal))
			for (var/mob/R in heard_normal)
				R.hear_radio(message, scrambled_message, verbage, speaking, part_a, part_b, part_c, M, 0, realname)

		/* --- Process all the mobs that heard the voice normally (did not understand) --- */

		if (length(heard_voice))
			for (var/mob/R in heard_voice)
				R.hear_radio(message, scrambled_message, verbage, speaking, part_a, part_b, part_c, M,0, vname)
		...
		if (length(heard_garbled))
			for (var/mob/R in heard_garbled)
				R.hear_radio(message, scrambled_message, verbage, speaking, part_a, part_b, part_c, M, 1, vname)
		...
		if (length(heard_gibberish))
			for (var/mob/R in heard_gibberish)
				R.hear_radio(message, scrambled_message, verbage, speaking, part_a, part_b, part_c, M, 1)
