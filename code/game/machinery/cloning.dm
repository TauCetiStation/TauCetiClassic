...
/obj/item/weapon/disk/data/demo
	...
	cases = list("диск с информацией об Императоре Человечества", "диска с информацией об Императоре Человечества", "диску с информацией об Императоре Человечества", "диск с информацией об Императоре Человечества", "диском с информацией об Императоре Человечества", "диске с информацией об Императоре Человечества")
	read_only = 1
...
/obj/item/weapon/disk/data/monkey
	...
	cases = list("диск с информацией об Мистере Маглзе", "диска с информацией об Мистере Маглзе", "диску с информацией об Мистере Маглзе", "диск с информацией об Мистере Маглзе", "диском с информацией об Мистере Маглзе", "диске с информацией о Мистере об Мистере Маглзе")
	read_only = 1
...
/obj/item/weapon/paper/Cloning
	...
	Поздравляем, ваша станция приобрела аппарат H-87!<br>
	...
	Эти дискеты используются для передачи генетической информации.
