...
/obj/item/weapon/paper/Cloning
	...
	<i>Сообщаем вам, что аппарат не умеет клонировать мартышек и прочих маленьких созданий, включая и неорганические. До такого мы пока не дошли. Гематомы могут привести к ошибкам в сканировании.</i><br>
