...
/obj/item/weapon/disk/data/demo
	...
	cases = list("диск об Императоре Человечества", "диска об Императоре Человечества", "диску об Императоре Человечества", "диск об Императоре Человечества", "диском об Императоре Человечества", "диске об Императоре Человечества")
	read_only = 1
