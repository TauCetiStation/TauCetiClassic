...
/obj/item/weapon/disk/data
	...
	cases = list("ДНК-диск", "ДНК-диска", "ДНК-диску", "ДНК-диск", "ДНК-диском", "ДНК-диске")
	icon = 'icons/obj/cloning.dmi'
...
/obj/item/weapon/disk/data/demo
	...
	cases = list("ДНК-диск 'Бог-Император Человечества'", "ДНК-диска 'Бог-Император Человечества'", "ДНК-диску 'Бог-Император Человечества'", "ДНК-диск 'Бог-Император Человечества'", "ДНК-диском 'Бог-Император Человечества'", "ДНК-диске 'Бог-Император Человечества'")
	read_only = 1
...
/obj/item/weapon/disk/data/monkey
	...
	cases = list("ДНК-диск 'Мистер Магглс'", "ДНК-диска 'Мистер Магглс'", "ДНК-диску о 'Мистер Магглс'", "ДНК-диск о 'Мистер Магглс'", "ДНК-диском 'Мистер Магглс'", "ДНК-диске 'Мистер Магглс'")
	read_only = 1
