...
/obj/machinery/vending/eva/mining
	...
	icon_state = "evamine"
	products = list(/obj/item/device/modkit/mining/tajaran = 3, /obj/item/device/modkit/mining/unathi = 3, /obj/item/device/modkit/mining/skrell = 3, /obj/item/device/modkit = 5, /obj/item/device/modkit/mining/vox = 3)
