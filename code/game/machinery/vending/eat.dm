/obj/machinery/vending/boozeomat
	...
	light_color = "#77beda"
	products = list(
		/obj/item/weapon/reagent_containers/food/drinks/bottle/gin = 2,
		/obj/item/weapon/reagent_containers/food/drinks/bottle/whiskey = 2,
		/obj/item/weapon/reagent_containers/food/drinks/bottle/tequilla = 2,
		/obj/item/weapon/reagent_containers/food/drinks/bottle/vodka = 2,
		/obj/item/weapon/reagent_containers/food/drinks/bottle/vermouth = 2,
		/obj/item/weapon/reagent_containers/food/drinks/bottle/rum = 2,
		/obj/item/weapon/reagent_containers/food/drinks/bottle/wine = 2,
		/obj/item/weapon/reagent_containers/food/drinks/bottle/cognac = 2,
		/obj/item/weapon/reagent_containers/food/drinks/bottle/kahlua = 2,
		/obj/item/weapon/reagent_containers/food/drinks/bottle/beer = 4,
		/obj/item/weapon/reagent_containers/food/drinks/bottle/ale = 2,
		...
		/obj/item/weapon/reagent_containers/food/drinks/bottle/cream = 2,
		/obj/item/weapon/reagent_containers/food/drinks/cans/tonic = 2,
		/obj/item/weapon/reagent_containers/food/drinks/cans/cola = 2,
		/obj/item/weapon/reagent_containers/food/drinks/cans/sodawater = 5,
		...
		/obj/item/weapon/reagent_containers/food/drinks/bottle/grenadine = 2,
...
/obj/machinery/vending/snack
	...
	light_color = "#d00023"
	products = list(
		/obj/item/weapon/reagent_containers/food/snacks/candy/candybar = 3,
		/obj/item/weapon/reagent_containers/food/drinks/dry_ramen = 1,
		/obj/item/weapon/reagent_containers/food/drinks/dry_ramen/hell_ramen = 2,
...
/obj/machinery/vending/chinese
	...
	light_color = "#d00023"
	products = list(
		/obj/item/weapon/reagent_containers/food/snacks/chinese/chowmein = 2,
		/obj/item/weapon/reagent_containers/food/snacks/chinese/tao = 2,
		/obj/item/weapon/reagent_containers/food/snacks/chinese/sweetsourchickenball = 2,
		/obj/item/weapon/reagent_containers/food/snacks/chinese/newdles = 2,
		/obj/item/weapon/reagent_containers/food/snacks/chinese/rice = 2,
...
/obj/machinery/vending/cola
	...
	products = list(
		...
		/obj/item/weapon/reagent_containers/food/drinks/cans/iced_tea = 5,
...
/obj/machinery/vending/junkfood
	...
	icon_state = "junkfood"
	products = list(
		/obj/item/weapon/reagent_containers/food/snacks/monkeyburger = 1,
		/obj/item/weapon/reagent_containers/food/snacks/cheeseburger = 2,
		/obj/item/weapon/reagent_containers/food/snacks/fries/cardboard = 2,
		/obj/item/weapon/reagent_containers/food/snacks/cheesyfries/cardboard = 2,
		/obj/item/weapon/reagent_containers/food/snacks/hotdog = 3,
		/obj/item/weapon/reagent_containers/food/drinks/cans/cola = 3,
		/obj/item/weapon/reagent_containers/food/drinks/cans/space_up = 3,
		/obj/item/weapon/reagent_containers/food/drinks/cans/dr_gibb = 4,
	)
	prices = list(
...
/obj/machinery/vending/donut
	...
	products = list(
		...
		/obj/item/weapon/reagent_containers/food/snacks/donut/classic = 2,
		/obj/item/weapon/reagent_containers/food/snacks/donut/choco = 2,
		/obj/item/weapon/reagent_containers/food/snacks/donut/banana = 2,
		/obj/item/weapon/reagent_containers/food/snacks/donut/berry = 2,
		/obj/item/weapon/reagent_containers/food/snacks/donut/cherryjelly = 2,
	)
	prices = list(
