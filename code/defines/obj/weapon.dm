...
/obj/item/weapon/legcuffs/bola/after_throw(datum/callback/callback)
	..()
	playsound(src,'sound/weapons/bolathrow.ogg', VOL_EFFECTS)
...
/obj/item/weapon/storage/part_replacer/proc/play_rped_sound()
	...
	if(alt_sound && prob(1))
		playsound(src, alt_sound, VOL_EFFECTS)
	else
		playsound(src, pshoom_or_beepboopblorpzingshadashwoosh, VOL_EFFECTS)
