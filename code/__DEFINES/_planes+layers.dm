...
#define BELOW_CONTAINERS_LAYER          2.55   // Below closets, crates...
#define CONTAINER_STRUCTURE_LAYER       2.6   // Layer for closets, crates, bags, racks
#define STRUCTURE_LAYER                 2.8   // Layer for tables
