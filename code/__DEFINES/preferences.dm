...
// #define CHAT_GHOSTSIGHT	8 // free bit flag
#define CHAT_PRAYER		16
#define CHAT_RADIO		32
#define CHAT_ATTACKLOGS	64
#define CHAT_DEBUGLOGS	128
// This place is currently untaken! Feel free to put some CHAT_BLAHBLAH here
// #define CHAT_LOOC		256
#define CHAT_GHOSTRADIO 512
#define CHAT_GHOSTNPC	1024
#define CHAT_CKEY		2048

#define TOGGLES_DEFAULT_CHAT (CHAT_OOC|CHAT_DEAD|CHAT_GHOSTEARS|CHAT_PRAYER|CHAT_RADIO|CHAT_GHOSTRADIO|CHAT_GHOSTNPC|CHAT_ATTACKLOGS|CHAT_CKEY)
