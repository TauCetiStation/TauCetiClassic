...
#define NO_SLIP_WHEN_CREEPING (1<<0)
#define SLIDE                (1<<1)
#define GALOSHES_DONT_HELP   (1<<2)
#define SLIDE_ICE            (1<<3)

//movement intent defines for the m_intent var
#define MOVE_INTENT_CREEP "creep"
...
#define STAMINA_DEFAULT_MAXIMUM       150
#define STAMINA_DEFAULT_RESIST_COST  -4
#define STAMINA_DEFAULT_RUN_THRESHOLD 10
#define STAMINA_ITEM_ATTACK_COST(w_class) (-2 * w_class)