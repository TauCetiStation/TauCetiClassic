...
#define MAP_CARGO_ACCOUNT_NUMBER_PLACEHOLDER "CargoAccount"
#define MAP_VENDOR_ACCOUNT_NUMBER_PLACEHOLDER "VendorAccount"
#define MAP_STATION_ACCOUNT_NUMBER_PLACEHOLDER "StationAccount"
