...
#define MOLES_N2ATMOS        (MOLES_N2STANDARD*50) // use those
...
#define BREATH_USED_PART    (1 / 6)
#define HUMAN_NEEDED_OXYGEN (MOLES_CELLSTANDARD * BREATH_PERCENTAGE * 0.16) // unused TODO check feature and for define below.

#define SOUND_MINIMUM_PRESSURE 10

#define PRESSURE_DAMAGE_COEFFICIENT 4 // The amount of pressure damage someone takes is equal to (pressure / HAZARD_HIGH_PRESSURE)*PRESSURE_DAMAGE_COEFFICIENT, with the maximum of MAX_PRESSURE_DAMAGE.
#define    MAX_HIGH_PRESSURE_DAMAGE 7 // 4 // This used to be 20... I got this much random rage for some retarded decision by polymorph?! Polymorph now lies in a pool of blood with a katana jammed in his spleen. ~Errorage --PS: The katana did less than 20 damage to him :(
#define         LOW_PRESSURE_DAMAGE 3 // 2 // The amount of damage someone takes when in a low pressure area. (The pressure threshold is so low that it doesn't make sense to do any calculations, so it just applies this flat value).
...
#define  FLOOR_HEAT_TRANSFER_COEFFICIENT 0.4 // unused TODO
...
// Defines how much of certain gas do the Atmospherics tanks start with. Values are in kpa per tile (assuming 20C) (!!this is not about tank !objects!, this is used by premade turfs mapped in atmosia!!)
