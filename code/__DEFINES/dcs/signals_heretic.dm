...
/// From /obj/effect/proc_holder/spell/in_hand/mansus_grasp/cast_on_hand_hit : (mob/living/source, mob/living/target)
...
/// From /obj/effect/proc_holder/spell/in_hand/mansus_grasp/cast_on_secondary_hand_hit : (mob/living/source, atom/target)
...
/// From /obj/item/weapon/sickly_blade/afterattack : (mob/living/source, mob/living/target)
#define COMSIG_HERETIC_BLADE_ATTACK "blade_attack"
/// From /obj/item/weapon/sickly_blade/ranged_interact_with_atom (without proximity) : (mob/living/source, mob/living/target)
