...
#define MARK_READY     "Готов <span style='color:lime'>☑</span>"
#define MARK_NOT_READY "Готов <span style='color:red'>☒</span>"
	...
	<html>
		...
		<body>
			<div class="container_nav">
				<a class="menu_a" href='?src=\ref[src];lobby_setup=1'>Персонаж</a>
	"}
