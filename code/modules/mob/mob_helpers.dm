...
proc/slur(phrase)
	...
	while(counter>=1)
		...
		if(rand(1,3)==3)
			...
			if(lletter=="÷")	newletter="ù" //246->249
			if(lletter=="å")	newletter="è" //229->232
		switch(rand(1,15))
			if(1 to 4)
...
// TODO:CYRILLIC èñïîëüçîâàòü lowertext_plus
/proc/stutter(text)
	...
	//alphabet.Add("Ã¡","Ã¢","Ã£","Ã¤","Ã¦","Ã§","Ã©","Ãª","Ã«","Ã¬","Ã­","Ã¯","Ã°","Ã±","Ã²","Ã´","Ãµ","Ã¶","Ã·","Ã¸","Ã¹")
