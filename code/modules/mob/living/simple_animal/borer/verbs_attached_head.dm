/obj/item/verbs/borer/attached_head/verb/borer_speak(message as text)
	set category = "Alien"
...
/mob/living/simple_animal/borer/proc/night_vision()
	...
	if(channeling && !channeling_night_vision)
		...
		channeling = TRUE
		channeling_night_vision = TRUE
		see_in_dark = 8
		see_invisible = SEE_INVISIBLE_OBSERVER_NOLIGHTING
		host.see_in_dark = 8
		host.see_invisible = SEE_INVISIBLE_OBSERVER_NOLIGHTING
		//spawn()
