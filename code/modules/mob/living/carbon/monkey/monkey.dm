...
/mob/living/carbon/monkey/say(var/message, scrambled_message = "", var/datum/language/speaking = null, var/verb="says", var/alt_name="", var/italics=0, var/message_range = world.view, var/list/used_radios = list())
	if(stat)
		return
	...
	..(message, scrambled_message, speaking, verb, alt_name, italics, message_range, used_radios)
