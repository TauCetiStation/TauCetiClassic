...
/mob/living/carbon/slime/do_attack_animation(atom/A, end_pixel_y, has_effect = TRUE, visual_effect_icon = ATTACK_EFFECT_SLIME, visual_effect_color = global.slime_colors[colour])
	. = ..()

/mob/living/carbon/slime/rainbow/do_attack_animation(atom/A, end_pixel_y, has_effect = TRUE, visual_effect_icon = ATTACK_EFFECT_SLIME, visual_effect_color = global.slime_colors[pick(global.slime_colors)])
	. = ..()
