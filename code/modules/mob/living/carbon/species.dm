...
/datum/species/proc/call_digest_proc(mob/living/M, datum/reagent/R, multiplier) // Humans don't have a seperate proc, but need to return TRUE so general proc is called.
	return TRUE
...
/datum/species/golem/call_digest_proc(mob/living/M, datum/reagent/R, multiplier)
	return R.on_golem_digest(M, multiplier)
...
/datum/species/slime/call_digest_proc(mob/living/M, datum/reagent/R, multiplier)
	return R.on_slime_digest(M, multiplier)
