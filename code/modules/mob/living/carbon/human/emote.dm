...
/mob/living/carbon/human/verb/pose()
	...
	pose =  sanitize(input(usr, "This is [src]. \He is...", "Pose", null)  as text, usr)
...
/mob/living/carbon/human/verb/set_flavor()
	...
	flavor_text =  sanitize(input(usr, "Please enter your new flavour text.", "Flavour text", null)  as text, usr)
