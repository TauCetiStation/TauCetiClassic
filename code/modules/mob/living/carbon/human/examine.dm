...
/proc/hasHUD(mob/M, hudtype)
	if(istype(M, /mob/living/carbon/human))
		...
		switch(hudtype)
			if("security")
				return istype(H.glasses, /obj/item/clothing/glasses/hud/security) || istype(H.glasses, /obj/item/clothing/glasses/hud/sechud) || istype(H.glasses, /obj/item/clothing/glasses/hud/secmed)
			if("medical")
