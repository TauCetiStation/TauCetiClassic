/mob/living/carbon/human/bullet_act(obj/item/projectile/P, def_zone)
	...
	if(istype(P, /obj/item/projectile/bullet/weakbullet))
		var/datum/organ/external/BP = get_organ(def_zone) // We're checking the outside, buddy!
	...
	if(istype(P, /obj/item/projectile/energy/bolt))
		...
		BP = organs_by_name[check_zone(def_zone)]
	...
	if(istype(P, /obj/item/projectile/bullet))
		...
		var/datum/organ/external/BP = organs_by_name[check_zone(def_zone)]
...
/mob/living/carbon/human/getarmor(def_zone, type)
	...
	if(def_zone)
		...
		var/datum/organ/external/BP = get_organ(def_zone)
...
/mob/living/carbon/human/proc/attacked_by(obj/item/I, mob/living/user, def_zone)
	...
	var/datum/organ/external/BP = get_organ(target_zone)
	if (!BP)
		return 0
	if(BP.status & ORGAN_DESTROYED)
