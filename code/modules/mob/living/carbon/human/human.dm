		...
		for(var/mob/living/carbon/human/pluvian_spirit/spirit in player_list)
			if(spirit.my_corpse == src && spirit.client)
				...
				if(answer == "Yes")
					...
					message_admins("Pluvian [key_name(spirit.my_corpse)] is living saint now [ADMIN_JMP(spirit.my_corpse)]")
					log_admin("Pluvian [key_name(spirit.my_corpse)] is living saint now  [ADMIN_JMP(spirit.my_corpse)]")
