	...
	if (getBrainLoss() >= 60 && stat != DEAD)
		if(prob(3))
			if(config.rus_language)//TODO:CYRILLIC dictionary?
				switch(pick(1,2,3))
					if(1)
						say(pick("азазаа!", "я не смалгей!", "’ќ— ’”≈—ќ—!", "[pick("", "ебучий трейтор")] [pick("морган", "моргун", "морген", "мрогун")] [pick("джемес", "джамес", "джаемес")] грефонет мин¤ шпасит;е!!!", "ти можыш дать мне [pick("тилипатию","халку","эпиллепсию")]?", "’јчу стать боргом!", "ѕќ«ќвите детектива!", "’очу стать мартышкой!", "’¬ј“≈“ √–»‘ќЌ≈“№ ћ»Ќя!!!!", "Ўј“ќЋ!"))
					if(2)
						say(pick(" ак мин[JA_PLACEHOLDER]ть руки?","ебучие фурри!", "ѕодебил", "ѕрокл[JA_PLACEHOLDER]тые трапы!", "лолка!", "вжжжжжжжжж!!!", "джеф скваааад!", "Ѕ–јЌƒ≈ЌЅ”–√!", "Ѕ”ƒјѕ≈Ў“!", "ѕј””””” !!!!", "ѕ” јЌ ЅќћЅјЌ”Ћ!", "ѕ”Ў ј", "–≈¬ј ѕќ÷ќЌџ", "ѕати на хопа!"))
					if(3)
						emote("drool")
			else
				switch(pick(1,2,3))
