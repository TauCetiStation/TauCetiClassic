		...
		switch(BP.name)
			if("chest")
				if(HAS_TRAIT(src, TRAIT_PUMPED_CHEST))
					standing += mutable_appearance('icons/mob/human_races/special_overlays.dmi', "pumped_chest", -BODY_LAYER)
			if("groin")
				if(HAS_TRAIT(src, TRAIT_PUMPED_LEGS))
					standing += mutable_appearance('icons/mob/human_races/special_overlays.dmi', "pumped_groin", -BODY_LAYER)
			if("left arm")
				if(HAS_TRAIT(src, TRAIT_PUMPED_ARMS))
					standing += mutable_appearance('icons/mob/human_races/special_overlays.dmi', "pumped_L_arm", -BODY_LAYER)
			if("right arm")
				if(HAS_TRAIT(src, TRAIT_PUMPED_ARMS))
					standing += mutable_appearance('icons/mob/human_races/special_overlays.dmi', "pumped_R_arm", -BODY_LAYER)
			if("left leg")
				if(HAS_TRAIT(src, TRAIT_PUMPED_LEGS))
					standing += mutable_appearance('icons/mob/human_races/special_overlays.dmi', "pumped_L_leg", -BODY_LAYER)
			if("right leg")
				if(HAS_TRAIT(src, TRAIT_PUMPED_LEGS))
					standing += mutable_appearance('icons/mob/human_races/special_overlays.dmi', "pumped_R_leg", -BODY_LAYER)
