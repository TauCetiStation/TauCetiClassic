...
/obj/machinery/computer/drone_control/interact(user)
	if(istype(user, /mob/living/silicon/robot/drone/maintenance))
...
/obj/machinery/computer/drone_control/Topic(href, href_list)
	...
	if (href_list["setarea"])
		...
		var/mob/living/silicon/robot/drone/maintenance/D = locate(href_list["resync"])
		...
		var/mob/living/silicon/robot/drone/maintenance/D = locate(href_list["shutdown"])
