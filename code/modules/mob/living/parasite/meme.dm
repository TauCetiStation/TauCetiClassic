...
mob/living/parasite/meme/verb/SubtleJump(mob/living/carbon/human/target in mob_list)
	set category = "Meme"
...
mob/living/parasite/meme/verb/ObviousJump(mob/living/carbon/human/target in mob_list)
	set category = "Meme"
...
mob/living/parasite/meme/verb/AttunedJump(mob/living/carbon/human/target in mob_list)
	set category = "Meme"
