...
/datum/religion_rites/standing/legacy/can_start(mob/living/user, obj/structure/altar_of_gods/AOG)
	if(!..())
		return FALSE
	if(!AOG)
...
/datum/religion_rites/standing/legacy/on_chosen(mob/living/user, obj/structure/altar_of_gods/AOG)
