...
/datum/religion_rites/spawn_item/create_armor
	name = "Create armor"
	desc = "Creates a religion armor in the name of God"
	ritual_length = (50 SECONDS)
	ritual_invocations = list("The Holy Spirit, who defending our souls from demons...",
						"...Please, give me your holy present from the Heaven Forge...",
						"...Give me protection from the heretics...",
						"...Give me the armor to protect the Holy sepulchre...",
						"...Surrounded by enemies...",
						"...I remain faithful to you...",
						"...Chip in ad coder enim curatio, ille fessus...",)
