...
/datum/religion_rites/standing/consent/synthconversion
	...
	ritual_invocations = list("Согласно внутреннему устройству твоему...", //если есть перевод лучше предлогайте
...
/datum/religion_rites/standing/consent/invite
	...
	ritual_invocations = list("Владычица Преблагословенная, возьми под Свой покров семью мою...",
						"...Всели в сердца супруга моего и чад наших мир, любовь и непрекословие всему доброму...",
						"...не допусти никого из семьи моей до разлуки и тяжкаго расставания...",
