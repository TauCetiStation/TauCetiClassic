...
/datum/religion_rites/standing/pray
	...
	ritual_invocations = list("Господи помилуй, О Гопсподи помилуй...",
							  "...Воставше от сна, припадаем Тебе, Блаже, и ангельскую песнь вопспаем Тебе",
							  "...Свят будь, Боже, Богородица помилуй нас...",
							  "...Господи помилуй...",
							  "...Боже, очисти меня грешного, как никогда сотворив благое перед Тобою...",
							  "...но избави меня от лукаваго, и да будет во мне воля Твоя...",
...
/datum/religion_rites/standing/animation
	...
	ritual_invocations = list("Я обращаюсь к вам - силы Всевышнего...",
							  "...данные из света, данные мудростью возвратившихся богов...",
							  "...Они наделили (замена анимации в RU, голем занят големом) человеческими страстями и чувствами...", // временая замена термина, надо думать
							  "...(замена анимации в RU, голем занят големом), пришедшая из Нового Царства, радуйся свету!...",)
...
/datum/religion_rites/standing/revive_animal
	...
	ritual_invocations = list("Я скажу, прошепчу, тихо произнесу такие слова...",
							  ...
							  "...Вы должны вытравить все целиком, отогнать заразу из тела животного...",
							  "...Пусть она уйдут в сырую землю, с водой уйдет и не вернется обратно...",
