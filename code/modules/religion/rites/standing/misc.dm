...
/datum/religion_rites/standing/pray
	...
	ritual_invocations = list("Господи помилуй, О Гопсподи помилуй...",
							  ...
							  "...но избаави мя от лукаваго, и да будет во мне воля Твоя...",
							  "...да неосужденно отверзу уста моя недостойная и восхвалю имя Твоу святое...",
...
/datum/religion_rites/standing/animation
	...
	ritual_invocations = list("Я обращаюсь к вам - силы Господа...",
							  "...данный из света, данный мудростью возвращенных богов...",
							  "...Они наделяли анимацию человеческими страстями и чувствами...",
							  "...Анимация, пришедшая из Нового Царства, радуйся свету!...",)
	invoke_msg = "Я обращаюсь к вам! Я взываю! Очнись ото сна!"
	favor_cost = 80
...
/datum/religion_rites/standing/spook
	...
	ritual_invocations = list("Я призываю сюда души людей, я отправляю твою душу к потустороннему вору, в черное зеркало...",
							  ...
							  "...мучить вас, пытать вас, пытать вас всех, истощать вас, уничтожать вас...",
							  "...Я вселяю зло в твою душу...",
							  "...Я впускаю зло в твою голову, в твое сердце, в твою печень, в твою кровь...",
							  "...Я не приказываю...",
							  "...Как я уже сказал, так и будет! Я закрываю на ключ, закрываю на замок...")
...
/datum/religion_rites/standing/illuminate
	...
	ritual_invocations = list("Иди ко мне, огонек...",
							  ...
							  "...ибо я нарушаю ваш покой не только из любопытства...")
...
/datum/religion_rites/standing/revive_animal
	...
	ritual_invocations = list("Я скажу, прошепчу, тихо произнесу такие слова...",
							  "...Пусть каждая болезнь оставит вас...",
							  "...Ты не узнаешь, что испытываешь мучения, боль и страдание...",
							  "...Никто не может причинить  вреда...",
							  "...Вы должны отравить все целиком, выгнать хвосты из тела животного...",
							  "...Пусть они уйдут в сырую землю, вода уйдет и не вернется обратно...",
							  "...Бог помогает и мои слова укрепляются...",)
	invoke_msg = "...Пусть будет так!"
	favor_cost = 150
