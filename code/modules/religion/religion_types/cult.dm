/datum/religion/cult
	...
	// Motivation to kill!
	var/list/possible_human_phrases = list("Я убью тебя", "Ты чё?", "Я вырву твое сердце", "Я выпью твою кровь", "Я уничтожу тебя", "Молись, сука", "Тебе въебать?", "Я вырву и съем твои кишки", "Моргало выколю", "Эй ты", "Я измельчу тебя на мелкие кусочки и выброшу их в чёрную дыру", "Пошёл нахуй", "Ты умрешь в ужасных судорогах", "Ильс'м уль чах", "Твое призвание - это чистить канализацию на Марсе", "Тупое животное", "АХ-ХА-ХА-ХА-ХА-ХА", "Что б ты бобов объелся", "Ёбаный в рот этого ада", "Эй обезьяна свинорылая", "Обабок бля", "Ну ты и маслёнок",\
	 						"Пиздакряк ты тупой", "Твои потраха съедят свиньи вместе с помоями, а мозг будут разрывать на куски бездомные кошки.", "Твою плоть разорвут падальщики, а кишки съедят крысы!", "Тупоголовый дегенерат", "Ты никому не нужный биомусор!", "Ты тупое ничтожество!", "Тупорылое чмо!", "Ты кусок дерьма засохший на заднице выебаного синдикатовца!", "Лучшеб ты у папы на трусах засох!")
