...
/obj/machinery/disposal/proc/expel(obj/structure/disposalholder/H)
	...
	var/turf/target
	playsound(src, 'sound/machines/hiss.ogg', VOL_EFFECTS, null, FALSE)
...
/obj/structure/disposalholder/relaymove(mob/user)
	...
	playsound(src, 'sound/effects/clang.ogg', VOL_EFFECTS, null, FALSE)
...
/obj/structure/disposaloutlet/proc/expel(obj/structure/disposalholder/H)
	...
	playsound(src, 'sound/machines/warning-buzzer.ogg', VOL_EFFECTS, null, FALSE)
