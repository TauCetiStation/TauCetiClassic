...
/datum/design/ripley_torso
	...
	materials = list(MAT_METAL=36000, MAT_GLASS=13000)
...
/datum/design/odysseus_chassis
	...
	materials = list(MAT_METAL=19000)
	construction_time = 100
	starts_unlocked = TRUE
...
/datum/design/odysseus_torso
	...
	materials = list(MAT_METAL=23000)
...
/datum/design/odysseus_head
	...
	materials = list(MAT_METAL=5000, MAT_GLASS=9000)
	construction_time = 100
	starts_unlocked = TRUE
	category = list("Odysseus")
...
/datum/design/gygax_torso
	...
	materials = list(MAT_METAL=46000, MAT_GLASS=18000, MAT_DIAMOND=1600)
...
/datum/design/gygax_head
	...
	materials = list(MAT_METAL=16000, MAT_GLASS=10000, MAT_DIAMOND=1600)
	construction_time = 200
	starts_unlocked = TRUE
	category = list("Gygax")
...
/datum/design/gygax_left_arm
	...
	materials = list(MAT_METAL=30000, MAT_DIAMOND=800)
	construction_time = 200
	starts_unlocked = TRUE
	category = list("Gygax")
...
/datum/design/gygax_left_leg
	...
	materials = list(MAT_METAL=35000, MAT_DIAMOND=800)
	construction_time = 200
	starts_unlocked = TRUE
	category = list("Gygax")
...
/datum/design/gygax_armour
	...
	materials = list(MAT_METAL=50000, MAT_DIAMOND=8000)
...
/datum/design/ultra_torso
	...
	materials = list(MAT_METAL=68750, MAT_GLASS=25000, MAT_DIAMOND=2000)
	construction_time = 300
	starts_unlocked = TRUE
	category = list("Gygax Ultra")
...
/datum/design/ultra_head
	...
	materials = list(MAT_METAL=31250, MAT_GLASS=12500, MAT_DIAMOND=2000)
	construction_time = 200
	starts_unlocked = TRUE
	category = list("Gygax Ultra")
...
/datum/design/ultra_left_arm
	...
	materials = list(MAT_METAL=43750, MAT_DIAMOND=1000)
	construction_time = 200
	starts_unlocked = TRUE
	category = list("Gygax Ultra")
...
/datum/design/ultra_left_leg
	...
	materials = list(MAT_METAL=50000, MAT_DIAMOND=1000)
	construction_time = 200
	starts_unlocked = TRUE
	category = list("Gygax Ultra")
...
/datum/design/ultra_armour
	...
	materials = list(MAT_METAL=75000, MAT_DIAMOND=20000)
	construction_time = 600
	starts_unlocked = TRUE
	category = list("Gygax Ultra")
...
/datum/design/durand_torso
	...
	materials = list(MAT_METAL=55000, MAT_GLASS=10000, MAT_SILVER=8000)
	construction_time = 300
	starts_unlocked = TRUE
	category = list("Durand")
...
/datum/design/durand_head
	...
	materials = list(MAT_METAL=25000, MAT_GLASS=15000, MAT_SILVER=2500)
	construction_time = 200
	starts_unlocked = TRUE
	category = list("Durand")
...
/datum/design/durand_left_arm
	...
	materials = list(MAT_METAL=35000, MAT_SILVER=3200)
	construction_time = 200
	starts_unlocked = TRUE
	category = list("Durand")
...
/datum/design/durand_left_leg
	...
	materials = list(MAT_METAL=40000, MAT_SILVER=3200)
	construction_time = 200
	starts_unlocked = TRUE
	category = list("Durand")
...
/datum/design/durand_armour
	...
	materials = list(MAT_METAL=50000, MAT_URANIUM=25000)
	construction_time = 600
	starts_unlocked = TRUE
	category = list("Durand")
...
/datum/design/vindicator_torso
	...
	materials = list(MAT_METAL=60000, MAT_GLASS=23000, MAT_SILVER=8000)
...
/datum/design/vindicator_head
	...
	materials = list(MAT_METAL=30000, MAT_GLASS=13000, MAT_SILVER=2500)
...
/datum/design/vindicator_left_arm
	...
	materials = list(MAT_METAL=40000, MAT_SILVER=2500)
	construction_time = 220
	starts_unlocked = TRUE
	category = list("Vindicator")
...
/datum/design/vindicator_left_leg
	...
	materials = list(MAT_METAL=50000, MAT_SILVER=2500)
	construction_time = 220
	starts_unlocked = TRUE
	category = list("Vindicator")
...
/datum/design/vindicator_armour
	...
	materials = list(MAT_METAL=60000, MAT_URANIUM=12000)
