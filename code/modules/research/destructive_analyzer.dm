...
/obj/machinery/r_n_d/destructive_analyzer/proc/finish_deconstructing()
	...
	if(linked_console)
		...
		if(linked_console.linked_lathe)
			var/list/loaded_item_materials = params2numberlist(loaded_item.materials)
			for(var/material as anything in loaded_item_materials)
				linked_console.linked_lathe.loaded_materials[material].amount += round(min((linked_console.linked_lathe.max_material_storage - linked_console.linked_lathe.TotalMaterials()), (loaded_item_materials[material]*(decon_mod/10))))
