...
/obj/item/weapon/vampiric/process()
	...
	if(charges >= 3)
		if(prob(5))
			...
			playsound(src, pick('sound/hallucinations/growl1.ogg','sound/hallucinations/growl2.ogg','sound/hallucinations/growl3.ogg'), VOL_EFFECTS, null, null, -3)

	if(charges >= 1)
		if(shadow_wights.len < 5 && prob(5))
			shadow_wights.Add(new /obj/effect/shadow_wight(src.loc))
			playsound(src, 'sound/effects/ghost.ogg', VOL_EFFECTS, null, null, -3)
			charges -= 0.1
...
/obj/item/weapon/vampiric/proc/bloodcall(mob/living/carbon/human/M)
	...
	if(istype(M))
		playsound(src, pick('sound/hallucinations/wail.ogg','sound/hallucinations/veryfar_noise.ogg','sound/hallucinations/far_noise.ogg'), VOL_EFFECTS, null, null, -3)
		nearby_mobs.Add(M)
...
/obj/effect/shadow_wight/process()
	if(src.loc)
		...
		if(M)
			playsound(src, pick('sound/hallucinations/behind_you1.ogg', VOL_EFFECTS,\
