/obj/structure/artifact/bluespace_crystal
	...
	anchored = TRUE
	light_color = "#24c1ff"
	first_effect = /datum/artifact_effect/tesla
...
/obj/structure/artifact/bluespace_crystal/atom_init()
	. = ..()
...
/obj/structure/artifact/bluespace_crystal/init_artifact_type()
	return

/obj/structure/artifact/bluespace_crystal/tesla_act(power)
	tesla_zap(src, 1, power / 2)
	return

/obj/structure/artifact/bluespace_crystal/deconstruct(disassembled)
...
/obj/structure/artifact/bluespace_crystal/take_damage(damage_amount, damage_type, damage_flag, sound_effect, attack_dir)
	. = ..()
	if(.)
		var/power = round(. / 10)
...
/obj/structure/artifact/bluespace_crystal/proc/teleport()
...
/obj/structure/artifact/bluespace_crystal/ex_act(severity)
