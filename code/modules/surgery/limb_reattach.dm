...
/datum/surgery_step/limb/can_use(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	var/list/bodypart_data = target.species.has_bodypart["[target_zone]"]
	return !isnull(bodypart_data)
...
/datum/surgery_step/limb/connect/begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	var/obj/item/bodypart/BP = target.get_bodypart(target_zone)
	user.visible_message("[user] starts connecting tendons and muscles in [target]'s [BP.amputation_point] with [tool].",
		                      "You start connecting tendons and muscle in [target]'s [BP.amputation_point].")
	..()

/datum/surgery_step/limb/connect/end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	var/obj/item/bodypart/BP = target.get_bodypart(target_zone)
	user.visible_message("<span class='notice'>[user] has connected tendons and muscles in [target]'s [BP.amputation_point] with [tool].</span>",
		                   "<span class='notice'>You have connected tendons and muscles in [target]'s [BP.amputation_point] with [tool].</span>")
...
/datum/surgery_step/limb/connect/fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	var/obj/item/bodypart/BP = target.get_bodypart(target_zone)
	user.visible_message("<span class='warning'> [user]'s hand slips, damaging [target]'s [BP.amputation_point]!</span>",
		                     "<span class='warning'> Your hand slips, damaging [target]'s [BP.amputation_point]!</span>")
...
/datum/surgery_step/limb/attach/can_use(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/bodypart/tool)
	if (!..())
		return 0
	var/obj/item/bodypart/BP = target.get_bodypart(target_zone)
...
/datum/surgery_step/limb/attach/begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	user.visible_message("[user] starts attaching [BP.name] to [target]'s [BP.amputation_point].",
		                     "You start attaching [BP.name] to [target]'s [BP.amputation_point].")

/datum/surgery_step/limb/attach/end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/bodypart/tool)
	if(user.dropItemToGround(tool) && tool.replace_stump(target))
		var/obj/item/bodypart/BP = tool
		user.visible_message("<span class='notice'>[user] has attached [target]'s [BP.name] to the [BP.amputation_point].</span>",
			                   "<span class='notice'>You have attached [target]'s [BP.name] to the [BP.amputation_point].</span>")
...
/datum/surgery_step/limb/mechanize/end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/robot_parts/tool)
	if(user.dropItemToGround(tool) && tool.replace_stump(target, tool.part))
		var/obj/item/bodypart/BP = target.get_bodypart(target_zone)
