...
/datum/surgery_step/brain/skull
	...
	/obj/item/weapon/kitchenknife = 50
	)
...
/datum/surgery_step/brain/skull/begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	user.visible_message("[user] starts to unscrew the metal panel using the [tool].",
 "You start unscrewing the metal panel with the [tool].")
	..()

/datum/surgery_step/brain/skull/end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	user.visible_message("<span class='notice'>[user] unscrewed the panel using the \the [tool].</span>",
	"<span class='notice'>You unscrewed the panel with \the [tool].</span>")
	target.op_stage.skull = 1
...
/datum/surgery_step/brain/mend/begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	user.visible_message("[user] starts screwing the panel to the cortical stack using [tool].",
	"[user] starts screwing the panel to the cortical stack using [tool].")
	..()

/datum/surgery_step/brain/mend/end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	user.visible_message("<span class='notice'>[user] screw the panel to the cortical stack using [tool].</span>",
	"<span class='notice'>You screw the panel to the cortical stack using [tool].</span>")
	target.op_stage.skull = 0
	target.op_stage.brain_cut = 0
	target.op_stage.brain_fix = 0
