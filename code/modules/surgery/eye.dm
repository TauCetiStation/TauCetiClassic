...
/datum/surgery_step/eye/manipulation/remove/end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	var/obj/item/organ/external/BP = target.get_bodypart(target_zone)
	var/obj/item/organ/internal/cyberimp/eyes/eyes = target.get_organ_slot("eye_sight")
	var/obj/item/organ/internal/cyberimp/eyes/hud/hud = target.get_organ_slot("eye_hud")
	var/obj/item/organ/internal/cyberimp/eyes/shield/shield = target.get_organ_slot("eye_shield")
