...
var/global/list/dreams = list(
	"идентификационная карта","бутылка","знакомое лицо","член экипажа","ящик с инструментами","офицер охраны","капитан",
	...
	"глава персонала","глава охраны","старший инженер","директор исследований","главврач",
...
var/global/list/nightmares = list(
	"Ктулху","культист","культист","ритуалы","кровь","кишки","смерть","ужас","бездна","проклятие","знак","тень","страх","огромный паук",
