	...
	while(client && hallucination > 20)
		...
		switch(halpick)
			...
			if(41 to 65)
				...
				switch(rand(1,12))
					if(1)
						src.playsound_local(null, 'sound/machines/airlock/airlockToggle.ogg', 100)
					if(2)
						if(prob(50))
							src.playsound_local(null, 'sound/effects/Explosion1.ogg', 100)
						else
							src.playsound_local(null, 'sound/effects/Explosion2.ogg', 100)
					if(3)
						src.playsound_local(null, 'sound/effects/explosionfar.ogg', 100)
					if(4)
						src.playsound_local(null, 'sound/effects/Glassbr1.ogg', 100)
					if(5)
						src.playsound_local(null, 'sound/effects/Glassbr2.ogg', 100)
					if(6)
						src.playsound_local(null, 'sound/effects/Glassbr3.ogg', 100)
					if(7)
						src.playsound_local(null, 'sound/machines/twobeep.ogg', 100)
					if(8)
						src.playsound_local(null, 'sound/machines/windowdoor.ogg', 100)
					if(9)
						//To make it more realistic, I added two gunshots (enough to kill)
						src.playsound_local(null, 'sound/weapons/guns/gunshot_heavy.ogg', 100)
						spawn(rand(10,30))
							src.playsound_local(null, 'sound/weapons/guns/gunshot_heavy.ogg', 100)
					if(10)
						src.playsound_local(null, 'sound/weapons/smash.ogg', 100)
					if(11)
						//Same as above, but with tasers.
						src.playsound_local(null, 'sound/weapons/guns/gunpulse_Taser.ogg', 100)
						spawn(rand(10,30))
							send_sound(src, 'sound/weapons/guns/gunpulse_Taser.ogg', 100)
				//Rare audio
					if(12)
//These sounds are (mostly) taken from Hidden: Source
						...
						src.playsound_local(null, pick(creepyasssounds), 100)
			if(66 to 70)
				//Flashes of danger
				//src << "Danger Flash"
				if(!halbody)
	...
	while(1)
		...
		if(get_dist(src,my_target) > 1)
			...
			if(prob(15))
				...
				if(weapon_name)
					my_target.playsound_local(null, "swing_hit", 100)
					...
					my_target.playsound_local(null, "punch", 100)
