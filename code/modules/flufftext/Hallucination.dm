	...
	while(client && hallucination > 20)
		...
		switch(halpick)
			...
			if(41 to 65)
				...
				switch(rand(1,12))
					if(1)
						playsound_local(null, 'sound/machines/airlock/airlockToggle.ogg', VOL_EFFECTS, null, FALSE)
					if(2)
						if(prob(50))
							playsound_local(null, 'sound/effects/Explosion1.ogg', VOL_EFFECTS, null, FALSE)
						else
							playsound_local(null, 'sound/effects/Explosion2.ogg', VOL_EFFECTS, null, FALSE)
					if(3)
						playsound_local(null, 'sound/effects/explosionfar.ogg', VOL_EFFECTS, null, FALSE)
					if(4)
						playsound_local(null, 'sound/effects/Glassbr1.ogg', VOL_EFFECTS, null, FALSE)
					if(5)
						playsound_local(null, 'sound/effects/Glassbr2.ogg', VOL_EFFECTS, null, FALSE)
					if(6)
						playsound_local(null, 'sound/effects/Glassbr3.ogg', VOL_EFFECTS, null, FALSE)
					if(7)
						playsound_local(null, 'sound/machines/twobeep.ogg', VOL_EFFECTS, null, FALSE)
					if(8)
						playsound_local(null, 'sound/machines/windowdoor.ogg', VOL_EFFECTS, null, FALSE)
					if(9)
						//To make it more realistic, I added two gunshots (enough to kill)
						playsound_local(null, 'sound/weapons/guns/gunshot_heavy.ogg', VOL_EFFECTS, null, FALSE)
						spawn(rand(10,30))
							playsound_local(null, 'sound/weapons/guns/gunshot_heavy.ogg', VOL_EFFECTS, null, FALSE)
					if(10)
						playsound_local(null, 'sound/weapons/smash.ogg', VOL_EFFECTS, null, FALSE)
					if(11)
						//Same as above, but with tasers.
						playsound_local(null, 'sound/weapons/guns/gunpulse_Taser.ogg', VOL_EFFECTS, null, FALSE)
						spawn(rand(10,30))
							playsound_local(null, 'sound/weapons/guns/gunpulse_Taser.ogg', VOL_EFFECTS, null, FALSE)
				//Rare audio
					if(12)
//These sounds are (mostly) taken from Hidden: Source
						...
						playsound_local(null, pick(creepyasssounds), VOL_EFFECTS, null, FALSE)
			if(66 to 70)
				//Flashes of danger
				//src << "Danger Flash"
				if(!halbody)
	...
	while(1)
		...
		if(get_dist(src,my_target) > 1)
			...
			if(prob(15))
				...
				if(weapon_name)
					my_target.playsound_local(null, "swing_hit", VOL_EFFECTS)
					...
					my_target.playsound_local(null, "punch", VOL_EFFECTS)
