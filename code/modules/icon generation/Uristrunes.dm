...
/proc/animate_rune(icon/input, rune_color = "#00000000", border_color = "#c8000000", rune_color2 = "#00000000", border_color2 = "#d8380000", alpha = 255, alpha2 = 255, frames = rune_animation)
	var/rr1 = HEX_VAL_RED(rune_color)
	var/rg1 = HEX_VAL_GREEN(rune_color)
	var/rb1 = HEX_VAL_BLUE(rune_color)
	var/ra1 = HEX_VAL_ALPHA(rune_color)
	var/rr2 = HEX_VAL_RED(rune_color2)
	var/rg2 = HEX_VAL_GREEN(rune_color2)
	var/rb2 = HEX_VAL_BLUE(rune_color2)
	var/ra2 = HEX_VAL_ALPHA(rune_color2)
	var/br1 = HEX_VAL_RED(border_color)
	var/bg1 = HEX_VAL_GREEN(border_color)
	var/bb1 = HEX_VAL_BLUE(border_color)
	var/ba1 = HEX_VAL_ALPHA(border_color)
	var/br2 = HEX_VAL_RED(border_color2)
	var/bg2 = HEX_VAL_GREEN(border_color2)
	var/bb2 = HEX_VAL_BLUE(border_color2)
	var/ba2 = HEX_VAL_ALPHA(border_color2)
