...
/proc/blood_compatible(blood_donor, blood_recipient)
	var/static/list/blood_recipient_can_receive = list(
		BLOOD_A_PLUS   =  list(BLOOD_A_PLUS = TRUE, BLOOD_A_MINUS = TRUE, BLOOD_O_PLUS = TRUE, BLOOD_O_MINUS = TRUE),
		BLOOD_A_MINUS  =  list(BLOOD_A_MINUS = TRUE, BLOOD_O_MINUS = TRUE),
		BLOOD_B_PLUS   =  list(BLOOD_B_PLUS = TRUE, BLOOD_B_MINUS = TRUE, BLOOD_O_PLUS = TRUE, BLOOD_O_MINUS = TRUE),
		BLOOD_B_MINUS  =  list(BLOOD_B_MINUS = TRUE, BLOOD_O_MINUS = TRUE),
		BLOOD_O_PLUS   =  list(BLOOD_O_PLUS = TRUE, BLOOD_O_MINUS = TRUE),
		BLOOD_O_MINUS  =  list(BLOOD_O_MINUS = TRUE),
		BLOOD_AB_PLUS  =  list(BLOOD_A_PLUS = TRUE, BLOOD_A_MINUS = TRUE, BLOOD_B_PLUS = TRUE, BLOOD_B_MINUS = TRUE, BLOOD_O_PLUS = TRUE, BLOOD_O_MINUS = TRUE, BLOOD_AB_PLUS = TRUE, BLOOD_AB_MINUS = TRUE),
		BLOOD_AB_MINUS =  list(BLOOD_A_MINUS = TRUE, BLOOD_B_MINUS = TRUE, BLOOD_O_MINUS = TRUE, BLOOD_AB_MINUS = TRUE)
		)
