...
//		If FALSE then we dont care about using fork/spoon(example: an egg)	//
	...
	var/cant_be_put_on_plate = FALSE // etc. - soups and salads(also junkfood) cant be put on plate.
...
//	list_reagents = list("nutriment" = 4, "sugar" = 2) // So here we add the reagents inside the snack that we need
//
//////////////////////////////////////////////////////////////////////////////
