...
//	slot_flags = SLOT_FLAGS_BELT
	...
	toolspeed = 50 //moving the delay to an item var so R&D can make improved picks. --NEO
...
/obj/item/weapon/pickaxe/plasmacutter
	...
	damtype = "fire"
	toolspeed = 20 //Can slice though normal walls, all girders, or be used in reinforced wall deconstruction/ light thermite on fire
...
/obj/item/weapon/pickaxe/drill/jackhammer
	...
	toolspeed = 40 //Drills 3 tiles in front of user
...
/obj/item/weapon/pickaxe/drill/diamond_drill //When people ask about the badass leader of the mining tools, they are talking about ME!
	...
	toolspeed = 15 //Digs through walls, girders, and can dig up sand
