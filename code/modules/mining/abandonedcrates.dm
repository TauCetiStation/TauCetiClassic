...
/obj/structure/closet/crate/secure/loot/proc/SpawnGoodLoot()
	...
	switch(rand(1, 3))
		if(1)
			new/obj/item/kinetic_upgrade/resources(src)
			new/obj/item/kinetic_upgrade/range(src)
			new/obj/item/kinetic_upgrade/damage(src)
			new/obj/item/kinetic_upgrade/speed(src)
		if(2)
