...
/obj/machinery/mineral/equipment_locker
	...
	var/list/prize_list = list(
		...
		new /datum/data/mining_equipment("Accelerator cooldown upgrade",  /obj/item/kinetic_upgrade/cooldown,								     1500),
		new /datum/data/mining_equipment("Accelerator damage upgrade",    /obj/item/kinetic_upgrade/damage,								         1500),
		new /datum/data/mining_equipment("Accelerator range upgrade",     /obj/item/kinetic_upgrade/range,								         1500),
		new /datum/data/mining_equipment("Accelerator AOE upgrade",       /obj/item/kinetic_upgrade/aoe/turfs,								     2500),
