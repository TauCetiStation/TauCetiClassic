...
/client/proc/cmd_admin_pm(client/C, msg = null)
	...
	to_chat(C, recieve_message,"emojiAllowed")
	to_chat(src, "<font color='blue'>[send_pm_type]PM to-<b>[get_options_bar(C, holder ? 1 : 0, holder ? 1 : 0, 1)]</b>: [msg]</font>","emojiAllowed")
