...
client/proc/staffhelp(msg, help_type = null)
	...
	var/ref_mob = "\ref[mob]"
	msg = "<span class='notice'><b><font color=[colour]>[prefix]: </font>[get_options_bar(mob, 2, 1, 1, TRUE)][ai_found ? " (<A HREF='?_src_=holder;adminchecklaws=[ref_mob]'>CL</A>)" : ""]:</b> [msg]</span>"
