...
//Spawns commandos and equips them.
	for(var/obj/effect/landmark/L in landmarks_list)
		...
		if (L.name == "Commando")
			...
			to_chat(new_commando, "<span class='notice'>You are a Special Ops. [!leader_selected?</span>"commando":"<B>LEADER</B>"] in the service of Central Command. Check the table ahead for detailed instructions.\nYour current mission is: <span class=warning'><B>[input]</B></span>")
