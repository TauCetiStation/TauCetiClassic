...
/mob/living/carbon/human/proc/equip_syndicate_commando(syndicate_leader_selected = 0)
	...
	if (!syndicate_leader_selected)
		equip_to_slot_or_del(new /obj/item/clothing/suit/space/syndicate/edgy(src), slot_wear_suit)
	else
		equip_to_slot_or_del(new /obj/item/clothing/suit/space/syndicate/edgy/leader(src), slot_wear_suit)
	equip_to_slot_or_del(new /obj/item/clothing/gloves/combat(src), slot_gloves)
	if (!syndicate_leader_selected)
		equip_to_slot_or_del(new /obj/item/clothing/head/helmet/space/syndicate/edgy(src), slot_head)
	else
		equip_to_slot_or_del(new /obj/item/clothing/head/helmet/space/syndicate/edgy/leader(src), slot_head)
