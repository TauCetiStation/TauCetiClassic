...
/client/proc/cmd_admin_dress(mob/living/carbon/human/M in mob_list)
	...
	switch(dresscode)
		...
		if("velocity officer")
			M.equip_to_slot_or_del(new /obj/item/clothing/under/det/retpoluniform(M), SLOT_W_UNIFORM)
		...
		if("velocity chief")
			...
			M.equip_to_slot_or_del(new /obj/item/clothing/suit/storage/det_suit/retpolcoat(M), SLOT_WEAR_SUIT)
