...
/client/proc/cmd_admin_dress(mob/living/carbon/human/M in mob_list)
	...
	switch(dresscode)
		...
		if ("tournament janitor")
			...
			M.put_in_backpack_if_possible(new /obj/item/stack/tile/plasteel)
			M.put_in_backpack_if_possible(new /obj/item/stack/tile/plasteel)
			M.put_in_backpack_if_possible(new /obj/item/stack/tile/plasteel)
			M.put_in_backpack_if_possible(new /obj/item/stack/tile/plasteel)
			M.put_in_backpack_if_possible(new /obj/item/stack/tile/plasteel)
		...
		if("blue wizard")
			...
			M.put_in_backpack_if_possible(new /obj/item/weapon/storage/box)
		...
		if("captain")
			...
			L.imp_in = M
			L.implanted = 1
			var/obj/item/bodypart/BP = M.bodyparts_by_name[BP_HEAD]
			BP.implants += L
			L.part = BP
		if("hop")
		...
		if("mime")
			...
			M.put_in_backpack_if_possible(new /obj/item/weapon/storage/box/survival)
			M.put_in_backpack_if_possible(new /obj/item/toy/crayon/mime)
			M.put_in_backpack_if_possible(new /obj/item/weapon/reagent_containers/food/drinks/bottle/bottleofnothing)
		...
		if("clown")
			...
			M.equip_to_slot_or_del(new /obj/item/clothing/mask/gas/clown_hat(M), slot_wear_mask)
			M.put_in_backpack_if_possible(new /obj/item/weapon/storage/box/survival)
			M.put_in_backpack_if_possible(new /obj/item/weapon/reagent_containers/food/snacks/grown/banana)
			M.put_in_backpack_if_possible(new /obj/item/weapon/bikehorn)
			M.put_in_backpack_if_possible(new /obj/item/weapon/stamp/clown)
			M.put_in_backpack_if_possible(new /obj/item/toy/crayon/rainbow)
			M.put_in_backpack_if_possible(new /obj/item/weapon/storage/fancy/crayons)
			M.put_in_backpack_if_possible(new /obj/item/toy/waterflower)
