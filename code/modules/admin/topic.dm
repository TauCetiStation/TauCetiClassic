	...
	if(href_list["makeAntag"])
		...
		switch(href_list["makeAntag"])
			if("1")
				...
				var/success = makeAntag(null, /datum/faction/traitor, count, FROM_PLAYERS)
			...
			if("2")
				...
				var/success = makeAntag(null, /datum/faction/changeling, count, FROM_PLAYERS)
			...
			if("5")
				...
				var/success = makeAntag(null, /datum/faction/malf_silicons, count, FROM_PLAYERS)
			...
			if("6")
				...
				var/success = makeAntag(null, /datum/faction/wizards, count, FROM_GHOSTS)
			...
			if("7")
				...
				var/success = makeAntag(null, /datum/faction/infestation, count, FROM_GHOSTS)
			...
			if("8")
				...
				var/success = makeAntag(null, /datum/faction/heist, count, FROM_GHOSTS)
