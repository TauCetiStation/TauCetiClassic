...
//		stickyban(href_list["stickyban"],href_list)
	...
	if(href_list["makeAntag"])
		...
		message_admins("<span class='notice'>[key_name(usr)] [ticker.delay_end ? </span>"delayed the round end" : "has made the round end normally"].")
		...
		message_admins("<span class='notice'>[key_name_admin(usr)] has used rudimentary transformation on [key_name_admin(M)]. Transforming to [href_list[</span>"simplemake"]]; deletemob=[delmob]")
