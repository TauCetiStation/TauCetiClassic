...
/obj/item/clothing/head/hardhat/yellow/visor
	name = "защитная каска с визором"
	cases = list("защитная каска с визором", "защитной каски с визором", "защитной каске с визором", "защитную каску с визором", "защитной каской с визором", "защитной каске с визором")
