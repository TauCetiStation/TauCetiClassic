...
/obj/item/clothing/suit/armor/vest/fullbody
	name = "fullbody armor"
	cases = list("полнотелый бронежилет", "полнотельного бронежилета", "полнотелому бронежилету", "полнотельный бронежилет", "полнотелым бронежилетом", "полнотелом бронежилете")
...
/obj/item/clothing/suit/storage/flak/police/fullbody
	...
	cases = list("полнотелый полицейский бронежилет", "полнотельного полицейского бронежилета", "полнотелому полицейскому бронежилету", "полнотелый полицейский бронежилет", "полнотелым полицейским бронежилетом", "полнотелом полицейском бронежилете")
...
/obj/item/clothing/suit/storage/flak/police/fullbody/heavy
	...
	cases = list("тяжелый полнотелый бронежилет", "тяжелого полнотелого бронежилета", "тяжелому полнотелому бронежилету", "тяжелый полнотелый бронежилет", "тяжелым полнотелым бронежилетом", "тяжелом полнотелом бронежилете")
...
/obj/item/clothing/suit/marinad
	name = "marine armor"
	cases = list("бронежилет морпеха", "бронежилета морпеха", "бронежилету морпеха", "бронежилет морпеха", "бронежилетом морпеха", "бронежилете морпеха")
...
/obj/item/clothing/suit/armor/vest/leather
	...
	cases = list("бронированное пальто", "бронированного пальто", "бронированному пальто", "бронированное пальто", "бронированным пальто", "бронированном пальто")
...
/obj/item/clothing/suit/armor/hos
	name = "armored coat"
	cases = list("бронированная шинель", "бронированной шинели", "бронированной шинели", "бронированную шинель", "бронированной шинелью", "бронированной шинели")
...
/obj/item/clothing/suit/armor/riot
	name = "riot suit"
	cases = list("защитный костюм для подавления беспорядков", "защитного костюма для подавления беспорядков", "защитному костюму для подавления беспорядков", "защитный костюм для подавления беспорядков", "защитным костюмом для подавления беспорядков", "защитном костюме для подавления беспорядков")
...
/obj/item/clothing/suit/armor/bulletproof
	...
	cases = list("пуленепробиваемый полнотелый бронежилет", "пуленепробиваемого полнотелого бронежилета", "пуленепробиваемому полнотелому бронежилету", "пуленепробиваемый полнотелый бронежилет", "пуленепробиваемым полнотелым бронежилетом", "пуленепробиваемом полнотелом бронежилете")
...
/obj/item/clothing/suit/armor/laserproof
	...
	cases = list("аблятивный полнотелый бронежилет", "аблятивного полнотелого бронежилета", "аблятивному полнотелому бронежилету", "аблятивный полнотелый бронежилет", "аблятивным полнотелым бронежилетом", "аблятивном полнотелом бронежилете")
...
/obj/item/clothing/suit/armor/laserproof/police
	...
	cases = list("аблятивный полицейский бронежилет", "аблятивного полицейского бронежилета", "аблятивному полицейскому бронежилету", "аблятивный полицейский бронежилет", "аблятивным полицейским бронежилетом", "аблятивном полицейском бронежилете")
...
/obj/item/clothing/suit/armor/swat
	name = "swat suit"
	cases = list("костюм спецназа", "костюма спецназа", "костюму спецназа", "костюм спецназа", "костюмом спецназа", "костюме спецназа")
...
/obj/item/clothing/suit/armor/syndilight
	...
	desc = "Легкий бронированный жилет, предназначенный для разведывательных миссий. Обеспечивает надежную защиту, несмотря на всю легкость. Теперь в полнотелом формате!"
