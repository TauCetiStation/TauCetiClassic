...
/obj/item/clothing/suit/storage/flak/police
	...
	desc = "Бронежилет, защищающий от незначительных повреждений. На нём прикреплена разрузка, позволяющая хранить до четырёх предметов, а также индивидуальная окраска в цветах \'ОБОП\'."
...
/obj/item/clothing/suit/storage/flak/police/fullbody/heavy
	...
	desc = "Комплект брони, используемый подразделениями специального назначения \'ОБОП\'. Правосудие будет соблюдено."
