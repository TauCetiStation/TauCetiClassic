...
/obj/item/clothing/suit/armor/vest/leather
	...
	desc = "Легкий кожаный бронированный плащ, предназначенный для повседневного ношения высокопоставленными офицерами. Украшен гербом безопасности НаноТранзен."
...
/obj/item/clothing/suit/armor/hos
	name = "armored coat"
	cases = list("армированное пальто", "армированного пальто", "армированному пальто", "армированное пальто", "армированным пальто", "армированном пальто")
