...
/obj/item/clothing/mask/gas/fawkes/mad/equipped(mob/living/user, slot)
	. = ..()
	if(slot == SLOT_WEAR_MASK)
		user.emote("scream")
		ADD_TRAIT(user, TRAIT_WHISPERER, GENERIC_TRAIT)

/obj/item/clothing/mask/gas/fawkes/mad/dropped(mob/living/user)
	. = ..()
