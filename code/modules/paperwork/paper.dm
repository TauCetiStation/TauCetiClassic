...
/obj/item/weapon/paper/cloning_log
	...
	Нам было поручено протестировать последнюю модель капсулы для клонирования от Thinktronic. Мы останемся в доке на неделю перед запуском, но начнем тесты прямо сейчас. \
