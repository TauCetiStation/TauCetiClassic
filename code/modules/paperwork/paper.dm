...
/obj/item/weapon/paper/cloning_lab
	name = "paper - 'Аппарат Клонирования H-11. Инструкция."
	info = {"<h4>Начало работы.</h4>
	Поздравляю, вы испытываете экспериментальное устройство клонирования H-11!<br>
	
Использование H-11 почти так же просто, как операция на мозге! Просто вставьте целевого гуманоида в сканирующую камеру и выберите опцию клонирования, чтобы начать процесс<br>
	<b>Это все.!</b><br>
	<i>Обратите внимание, система клонирования не может сканировать неорганическую жизнь или мелких приматов. Сканирование может завершиться неудачей, если субъект получил серьезное повреждение головного мозга
.</i><br>
	<p>Предоставленная система Г.О.Р.Ш.О.К. произведет желаемый клон. Стандартное время созревания клона составляет примерно 90 секунд.
	Модуль клонирования может быть разблокирован рано после завершения первоначального созревания.</p><br>
	<i>Обратите внимание, что полученные клоны будут иметь дефект развития в результате генетического дрейфа.  Мы надеемся уменьшить это с помощью дальнейшего тестирования.
<br>
	Клоны также могут испытывать потерю памяти и радикальные изменения личности в результате процесса клонирования.</i><br>
	<br>
	<font size=1>Данная технология произведена по лицензии компании Thinktronic Systems, LTD.</font>"}
...
/obj/item/weapon/paper/cloning_log
	...
	но инженеры уверяют меня, что это безопасно и нет абсолютно никакого риска того, что внешние крылья отломятся от ускорения.<br>
	Нам было поручено протестировать последнюю модель модуля клонирования Thinktronic. Мы пробудем в доке неделю перед стартом, но начнем прямо сейчас. \
	Если двигатель так быстр, как они говорят, у нас может не хватить времени провести все рутинные тесты на клонированном объекте!<br>
	<br>
	<h4>День 2</h4>
	Мы клонировали неизвестный труп, который был передан нам медицинской бригадой. Генетическая репликация достаточно хороша, чтобы позволить субъекту выжить вне капсулы, \
	но повреждение клеток остается проблемой для его долгосрочного выживания. В целях безопасности мы будем держать его в карантине.<br>
	Мы оставили ему несколько книг, но, очевидно, были слишком оптимистичны в отношении его умственных способностей. Его мозг, похоже, страдает от того же клонирующего распада, \
	который был вызван
предыдущими моделями. Мы проведем дальнейшие тесты, чтобы увидеть, есть ли улучшения.<br>
	<h4>День 4</h4>
	похоже, мы запустимся даже раньше, чем ожидалось! Судя по всему, пресса начинает терять интерес, поэтому мы вынуждены прервать предполетные проверки \
	и дать им о чем-нибудь поговорить. Надеюсь, это закончится увеличением финансирования...<br>
	Весь экипаж был приглашен в главный зал, где у нас есть места для начального сверхсветового ускорения. К сожалению, клон не может покинуть карантинную комнату. \

	без риска заражения, поэтому мы пристегнем его к кровати и будем надеяться на лучшее. В любом случае, если что-то пойдет не так, мы сможем вырастить еще одного клона.
	<br>
