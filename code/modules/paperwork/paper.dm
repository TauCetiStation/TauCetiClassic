...
/obj/item/weapon/paper/psc
	...
	<p>Данный документ подтверждает, что держатель документа (далее Сотрудник) является сотрудником частного охранного предприятия, нанятого для охраны активов Отдела Снабжения.</p>
	<p>Сотрудник имеет право на владение и использование пистолета G17 GEN3 и/или тайзера и средств личной защиты в целях охраны активов Карго.</p>
	<p>Ношение шлема регламентируется СОП-ом: ношение в зелёный код строго воспрещается.</p>
	<p>При неправомерном применении спецсредств офицеры охраны имеют право изъять пистолет, тайзер и средства личной защиты.</p>"}
