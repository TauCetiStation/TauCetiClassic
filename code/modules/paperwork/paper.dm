...
/obj/item/weapon/paper/psc
	...
	<p>Сотрудник имеет право на владение и использование пистолета W&J PP и средств личной защиты в целях охраны активов Карго.</p>
	<p>При неправомерном применении спецсредств офицеры охраны имеют право изъять пистолет и средства личной защиты.</p>"}
