...
/obj/item/weapon/paper/derelict_biologistnote
	name = "note"
	info = {"Директор, оставил отчёт о вскрытии в офисе, в надёжном месте. Заберите скорее, и желательно ссожите после прочтения. Про мой палец ещё можно соврать, а если отчёт прочитает кто то ещё, то паники не миновать."}