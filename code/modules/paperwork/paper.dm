...
/obj/item/weapon/paper/mentats_recipe
	...
	<p style="text-align:center">Дозировка не менее 0.4 единиц, Передозировка отсутсвует. Желательно применять в дозах по 0.5 единиц. Эффект длится 5 стандартных стационных минут вне зависимости от дозировки. Повышает навыки&nbsp;&nbsp;</p>
