...
/obj/item/weapon/paper/brig_arsenal
	...
	<b>3 пулестойких комплекта</b>:<small><ul><li> Пулестойкий шлем<li>3 Пулестойкая броня
	</ul></small>
...
.</i><br>
	<p>Предоставленная система CLONEPOD произведет желаемый клон. Стандартное время созревания клона составляет примерно 90 секунд.
...
/obj/item/weapon/paper/cloning_log
	...
	info = {"<h4>День 1</h4>
	Мы очень рады быть частью первого экипажа НК Irmanda!!<br>
