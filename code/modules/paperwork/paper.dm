...
/obj/item/weapon/paper/derelict_tokamakguide
	...
	4. Если внутри камеры посторонний объект/никакой из выше перечисленных пунктов не помог снизить нестабильность - выключай поле, НО ТОЛЬКО ЕСЛИ ТЕМПЕРАТУРА ПЛАЗМЫ НИЖЕ 1000 КЕЛЬВИНОВ. Если она выше, то немедленно выключи гиротрон и подачу топлива, и жди пока оно остынет. <br> /
