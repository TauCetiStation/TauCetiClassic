...
/obj/item/weapon/paper/mentats_recipe
	name = "paper - 'Заметка о новом препарате (Ментаты)"
	info = {"<p style="text-align:center">Наши ученные смогли разработать формулу нового химиката</p>
	<h1 style="text-align:center">Ментаты</h1>
	<p style="text-align:center">Данный химикат позволяет улучшить когнитивные и моторные навыки человека на определенное время.</p>
	<h2 style="text-align:center">Рецепт:</h2>
	<ul>
		<li style="text-align: center;">Алкизин: 15 единиц</li>
		<li style="text-align: center;">Метилфенидат: 15 единиц</li>
		<li style="text-align: center;">Розовый сок (Перемолотые мозги): 50 единиц</li>
	</ul>
	<p style="text-align:center">Катализатор: форон 5 единиц.</p>
	<h2 style="text-align:center">Применение:</h2>
	<p style="text-align:center">Дозировка не менее 0.4 единиц, Передозировка отсутствует. Желательно применять в дозах по 0.5 единиц. Эффект длится 5 стандартных станционных минут вне зависимости от дозировки. Повышает способности в зависимости от использованного серого сока.</p>
	<h2 style="text-align:center">Примечания:</h2>
	<ul>
		<li style="text-align: center;">Воксы, дионы и скреллы невосприимчивы к данному веществу из-за другого устройства мозга.</li>
		<li style="text-align: center;">Распространять данный рецепт следует с осторожностью.</li>
		<li style="text-align: center;">При употреблении 50 единиц розового сока человек может перенять навыки исходного материала. При употреблении необходим медицинский контроль.</li>
		<li style="text-align: center;">Смешивать розовый сок не рекомендуется, поскольку продуктом является серый сок. Тесты так же проводились с использованием стазис колб</li>
	</ul>"}
