...
/obj/item/weapon/paper/derelict_tokamakguide
	...
	Два плюс четыре равно шесть. Столько же у нас и инжекторов. Загрузи все полученные стержни внутрь всех шести инжекторов, и отправляйся обратно к консолям. <br> /
