...
/obj/item/device/camera/abstract/captureimage(atom/target, mob/user, flag)
	var/mobs = ""
	var/list/mob_names = list()

	var/list/seen = hear(world.view, target)
	...
	return createpicture(user, temp, mobs, mob_names, flag)
