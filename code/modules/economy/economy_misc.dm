...
/proc/setup_machines()
	...
	for(var/obj/machinery/sleeper/Sleep in global.sleeper_machines)
		Sleep.seller_account_number = get_account_number_from_placeholder_or_null(Sleep.seller_account_number)
