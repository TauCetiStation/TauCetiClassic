...
/obj/item/device/detective_scanner/afterattack(atom/target, mob/user, proximity, params)
	...
	if (istype(target, /obj/effect/decal/cleanable/blood) || istype(target, /obj/effect/largerune) || istype(target, /obj/effect/fanatics_rune) || istype(target, /obj/effect/rune) || istype(target, /obj/effect/decal/cleanable/blood/gibs))
