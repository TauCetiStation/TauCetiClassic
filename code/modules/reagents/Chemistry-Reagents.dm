...
/datum/reagent
	...
	var/taste_message = "горечь" //life's bitter by default. Cool points for using a span class for when you're tasting <span class='userdanger'>LIQUID FUCKING DEATH</span>
