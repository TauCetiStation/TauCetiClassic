...
/obj/item/weapon/reagent_containers/borghypo/peace
	...
	volume = 5	//rezadon are toxic > 7 units. no need to poison people by accident
	reagent_ids = list("cryptobiolin", "rezadone") //rezadon heals broken faces after a fight
