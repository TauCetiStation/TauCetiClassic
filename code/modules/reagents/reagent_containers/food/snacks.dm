...
/obj/item/weapon/reagent_containers/food/snacks/loadedbakedpotato
	...
	cases = list("загруженный печёный картофель", "загруженного печеного картофеля", "загруженному печеному картофелю", "	загруженный печеный картофель", "загруженным печеным картофелем", "загруженном печеном картофеле")
	desc = "Totally baked."
