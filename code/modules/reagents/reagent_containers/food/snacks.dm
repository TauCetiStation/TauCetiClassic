...
/obj/item/weapon/reagent_containers/food/snacks/weirdcheesewedge/atom_init()
	. = ..()
...
/obj/item/weapon/reagent_containers/food/snacks/pistachios/atom_init()
	. = ..()
	reagents.add_reagent("plantmatter", 2)
	reagents.add_reagent("sugar", 4)
	reagents.add_reagent("sodiumchloride", 1)
...
/obj/item/weapon/reagent_containers/food/snacks/tastybread/atom_init()
	. = ..()
	reagents.add_reagent("nutriment", 2)
	reagents.add_reagent("sugar", 4)
...
/obj/item/weapon/reagent_containers/food/snacks/raw_bacon
	name = "raw bacon"
	desc = "It's fleshy and pink! God's gift to man in uncooked form."
...
obj/item/weapon/reagent_containers/food/snacks/liquidfood/atom_init()
	. = ..()
	reagents.add_reagent("nutriment", 20)
...
/obj/item/weapon/reagent_containers/food/snacks/salmonmeat/atom_init()
	. = ..()
	reagents.add_reagent("protein", 3)
	reagents.add_reagent("vitamin", 2)
...
/obj/item/weapon/reagent_containers/food/snacks/catfishmeat/atom_init()
	. = ..()
	reagents.add_reagent("protein", 3)
	reagents.add_reagent("vitamin", 2)
...
/obj/item/weapon/reagent_containers/food/snacks/sliceable/Ebi_maki
	...
	icon_state = "Ebi_maki"
	slice_path = /obj/item/weapon/reagent_containers/food/snacks/sushi_Ebi
	slices_num = 4
	bitesize = 3

/obj/item/weapon/reagent_containers/food/snacks/sliceable/Ebi_maki/atom_init()
	. = ..()
	reagents.add_reagent("nutriment", 8)
...
/obj/item/weapon/reagent_containers/food/snacks/sushi_Ebi/atom_init()
	. = ..()
	reagents.add_reagent("nutriment", 2)

/obj/item/weapon/reagent_containers/food/snacks/sliceable/Ikura_maki
	name = "ikura makiroll"
	desc = "A large unsliced roll of Ikura Sushi."
	icon_state = "Ikura_maki"
	slice_path = /obj/item/weapon/reagent_containers/food/snacks/sushi_Ikura
	slices_num = 4
	bitesize = 3

/obj/item/weapon/reagent_containers/food/snacks/sliceable/Ikura_maki/atom_init()
	. = ..()
	reagents.add_reagent("nutriment", 8)
	reagents.add_reagent("protein", 4)
...
/obj/item/weapon/reagent_containers/food/snacks/sushi_Ikura/atom_init()
	. = ..()
	reagents.add_reagent("nutriment", 2)
	reagents.add_reagent("protein", 1)

/obj/item/weapon/reagent_containers/food/snacks/sliceable/Sake_maki
	name = "sake makiroll"
	desc = "A large unsliced roll of Sake Sushi."
	icon_state = "Sake_maki"
	slice_path = /obj/item/weapon/reagent_containers/food/snacks/sushi_Sake
	slices_num = 4
	bitesize = 3

/obj/item/weapon/reagent_containers/food/snacks/sliceable/Sake_maki/atom_init()
	. = ..()
	reagents.add_reagent("nutriment", 8)
...
/obj/item/weapon/reagent_containers/food/snacks/sushi_Sake/atom_init()
	. = ..()
	reagents.add_reagent("nutriment", 2)

/obj/item/weapon/reagent_containers/food/snacks/sliceable/SmokedSalmon_maki
	name = "smoked salmon makiroll"
	desc = "A large unsliced roll of Smoked Salmon Sushi."
	icon_state = "SmokedSalmon_maki"
	slice_path = /obj/item/weapon/reagent_containers/food/snacks/sushi_SmokedSalmon
	slices_num = 4
	bitesize = 3

/obj/item/weapon/reagent_containers/food/snacks/sliceable/SmokedSalmon_maki/atom_init()
	. = ..()
	reagents.add_reagent("nutriment", 8)
...
/obj/item/weapon/reagent_containers/food/snacks/sushi_SmokedSalmon/atom_init()
	. = ..()
	reagents.add_reagent("nutriment", 2)

/obj/item/weapon/reagent_containers/food/snacks/sliceable/Tamago_maki
	name = "tamago makiroll"
	desc = "A large unsliced roll of Tamago Sushi."
	icon_state = "Tamago_maki"
	slice_path = /obj/item/weapon/reagent_containers/food/snacks/sushi_Tamago
	slices_num = 4
	bitesize = 3

/obj/item/weapon/reagent_containers/food/snacks/sliceable/Tamago_maki/atom_init()
	. = ..()
	reagents.add_reagent("nutriment", 8)
...
/obj/item/weapon/reagent_containers/food/snacks/sushi_Tamago/atom_init()
	. = ..()
	reagents.add_reagent("nutriment", 2)

/obj/item/weapon/reagent_containers/food/snacks/sliceable/Inari_maki
	name = "inari makiroll"
	desc = "A large unsliced roll of Inari Sushi."
	icon_state = "Inari_maki"
	slice_path = /obj/item/weapon/reagent_containers/food/snacks/sushi_Inari
	slices_num = 4
	bitesize = 3

/obj/item/weapon/reagent_containers/food/snacks/sliceable/Inari_maki/atom_init()
	. = ..()
	reagents.add_reagent("nutriment", 8)
...
/obj/item/weapon/reagent_containers/food/snacks/sushi_Inari/atom_init()
	. = ..()
	reagents.add_reagent("nutriment", 2)

/obj/item/weapon/reagent_containers/food/snacks/sliceable/Masago_maki
	name = "masago makiroll"
	desc = "A large unsliced roll of Masago Sushi."
	icon_state = "Masago_maki"
	slice_path = /obj/item/weapon/reagent_containers/food/snacks/sushi_Masago
	slices_num = 4
	bitesize = 3

/obj/item/weapon/reagent_containers/food/snacks/sliceable/Masago_maki/atom_init()
	. = ..()
	reagents.add_reagent("nutriment", 8)
	reagents.add_reagent("protein", 4)
...
/obj/item/weapon/reagent_containers/food/snacks/sushi_Masago/atom_init()
	. = ..()
	reagents.add_reagent("nutriment", 2)
	reagents.add_reagent("protein", 1)

/obj/item/weapon/reagent_containers/food/snacks/sliceable/Tobiko_maki
	name = "tobiko makiroll"
	desc = "A large unsliced roll of Tobiko Sushi."
	icon_state = "Tobiko_maki"
	slice_path = /obj/item/weapon/reagent_containers/food/snacks/sushi_Tobiko
	slices_num = 4
	bitesize = 3

/obj/item/weapon/reagent_containers/food/snacks/sliceable/Tobiko_maki/atom_init()
	. = ..()
	reagents.add_reagent("nutriment", 8)
	reagents.add_reagent("protein", 4)
...
/obj/item/weapon/reagent_containers/food/snacks/sushi_Tobiko/atom_init()
	. = ..()
	reagents.add_reagent("nutriment", 2)
	reagents.add_reagent("protein", 1)

/obj/item/weapon/reagent_containers/food/snacks/sliceable/TobikoEgg_maki
	name = "tobiko and egg makiroll"
	desc = "A large unsliced roll of Tobkio and Egg Sushi."
	icon_state = "TobikoEgg_maki"
	slice_path = /obj/item/weapon/reagent_containers/food/snacks/sushi_TobikoEgg
	slices_num = 4
	bitesize = 3

/obj/item/weapon/reagent_containers/food/snacks/sliceable/TobikoEgg_maki/atom_init()
	. = ..()
	reagents.add_reagent("nutriment", 8)
	reagents.add_reagent("protein", 4)
...
/obj/item/weapon/reagent_containers/food/snacks/sushi_TobikoEgg/atom_init()
	. = ..()
	reagents.add_reagent("nutriment", 2)
	reagents.add_reagent("protein", 1)

/obj/item/weapon/reagent_containers/food/snacks/sliceable/Tai_maki
	name = "tai makiroll"
	desc = "A large unsliced roll of Tai Sushi."
	icon_state = "Tai_maki"
	slice_path = /obj/item/weapon/reagent_containers/food/snacks/sushi_Tai
	slices_num = 4
	bitesize = 3

/obj/item/weapon/reagent_containers/food/snacks/sliceable/Tai_maki/atom_init()
	. = ..()
	reagents.add_reagent("nutriment", 8)
...
/obj/item/weapon/reagent_containers/food/snacks/sushi_Tai/atom_init()
	. = ..()
	reagents.add_reagent("nutriment", 2)
...
/obj/item/weapon/reagent_containers/food/snacks/sushi_Unagi/atom_init()
	. = ..()
	reagents.add_reagent("nutriment", 2)
...
/obj/item/weapon/reagent_containers/food/snacks/onionrings/atom_init()
	. = ..()
	reagents.add_reagent("nutriment", 3)
...
/obj/item/weapon/reagent_containers/food/snacks/mashed_potatoes/atom_init()
	. = ..()
	reagents.add_reagent("nutriment", 5)
