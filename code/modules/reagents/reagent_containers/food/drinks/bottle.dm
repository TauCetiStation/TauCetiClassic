...
/obj/item/weapon/reagent_containers/food/drinks/bottle/verb/spin_bottle()
	...
	if(!stop_spin_bottle)
		...
		if(isturf(loc))
			...
			playsound(src, 'sound/items/glasses/bottle_spin.ogg', VOL_EFFECTS_MASTER, 1000, TRUE)
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/pickup(mob/living/user)
	...
	if(reagents.total_volume > 0)
		playsound(user, 'sound/items/glasses/bottle_take-liquid.ogg', VOL_EFFECTS_MASTER, 1000, TRUE)
	else
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/dropped(mob/user)
	...
	if(isturf(loc) && (user.loc != loc))
		if(reagents.total_volume > 0)
			playsound(user, 'sound/items/glasses/bottle_put-liquid.ogg', VOL_EFFECTS_MASTER, 1000, TRUE)
		else
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/afterattack(atom/target, mob/user, proximity, params)
	...
	if(target.is_open_container())
		if(reagents.total_volume && target.reagents.maximum_volume && target.reagents.total_volume < target.reagents.maximum_volume)
			playsound(user, 'sound/items/glasses/bottle_pouring.ogg', VOL_EFFECTS_MASTER, 800, TRUE)
