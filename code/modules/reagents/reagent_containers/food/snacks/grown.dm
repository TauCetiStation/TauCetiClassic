...
/obj/item/weapon/reagent_containers/food/snacks/grown/glowberries
	...
	desc = "Гроздь не только питательных ягод. Слабо светится в темноте."
	var/light_on = 1
...
/obj/item/weapon/reagent_containers/food/snacks/grown/goldapple
	...
	desc = "На яблоке красуется слово 'Прекраснейший'." // От древнегреческого τῇ καλλίστῃ (ti kallisti) - прекраснейший
...
/obj/item/weapon/reagent_containers/food/snacks/grown/lemon
	...
	desc = "Если жизнь дает тебе лимоны, скажи спасибо, что это не лаймы."
	icon_state = "lemon"
	potency = 20
