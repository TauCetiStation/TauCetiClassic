...
/datum/reagent/consumable/drink/gourd_juice/on_general_digest(mob/living/M)
	...
	if(prob(10))
		to_chat(H, "<span class='warning'>Ещё немного, и вы проблюетесь...</span>")
