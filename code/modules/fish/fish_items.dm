...
/obj/item/weapon/fish/shark/attackby(var/obj/item/weapon/O, var/mob/user as mob)
...
/obj/item/weapon/fish/catfish/attackby(var/obj/item/weapon/O, var/mob/user as mob)
	if(is_sharp(O))
...
/obj/item/weapon/fish/salmon/attackby(var/obj/item/weapon/O, var/mob/user as mob)
	if(is_sharp(O))
		to_chat(user, "You carefully clean and gut \the [src.name].")
...
/obj/item/weapon/fish/babycarp/attackby(var/obj/item/weapon/O, var/mob/user as mob)
	if(is_sharp(O))
		to_chat(user, "You carefully clean and gut \the [src.name].")
