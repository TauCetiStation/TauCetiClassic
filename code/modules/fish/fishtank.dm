...
/obj/machinery/fishtank
	...
	var/max_integrity = 50 		// like max_health of the windows
	var/obj_integrity = 50
...
/obj/machinery/fishtank/wall/CanPass(turf/T)
	return FALSE
...
/obj/machinery/fishtank/proc/take_damage(damage = 0, damage_type = BRUTE, sound_effect = 1)
	var/initialhealth = obj_integrity
	var/message = 1
	if(!damage)
		return
	...
	if(obj_integrity <= 0)
		...
		if(message)
			if(obj_integrity < max_integrity / 4 && initialhealth >= max_integrity / 4)
				visible_message("[src] looks like it's about to shatter!" )
			else if(obj_integrity < max_integrity / 2 && initialhealth >= max_integrity / 2)
				visible_message("[src] looks seriously damaged!" )
			else if(obj_integrity < max_integrity * 3/4 && initialhealth >= max_integrity * 3/4)
				visible_message("Cracks begin to appear in [src]!" )
	update_icon()

/obj/machinery/fishtank/proc/shatter(display_message = 1)
