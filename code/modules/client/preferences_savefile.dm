...
/datum/preferences/proc/load_saved_character(dir)
	...
	job_civilian_high = sanitize_integer(job_civilian_high, 0, 16777216, initial(job_civilian_high))
	job_civilian_med = sanitize_integer(job_civilian_med, 0, 16777216, initial(job_civilian_med))
	job_civilian_low = sanitize_integer(job_civilian_low, 0, 16777216, initial(job_civilian_low))
	job_medsci_high = sanitize_integer(job_medsci_high, 0, 16777216, initial(job_medsci_high))
	job_medsci_med = sanitize_integer(job_medsci_med, 0, 16777216, initial(job_medsci_med))
	job_medsci_low = sanitize_integer(job_medsci_low, 0, 16777216, initial(job_medsci_low))
	job_engsec_high = sanitize_integer(job_engsec_high, 0, 16777216, initial(job_engsec_high))
	job_engsec_med = sanitize_integer(job_engsec_med, 0, 16777216, initial(job_engsec_med))
	job_engsec_low = sanitize_integer(job_engsec_low, 0, 16777216, initial(job_engsec_low))
