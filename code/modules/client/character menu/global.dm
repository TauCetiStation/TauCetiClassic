/datum/preferences/proc/ShowGlobal(mob/user)
	...
	. += 		"<td width='50%'>"
	. += 			"<table width='100%'>"
	. += 				"<tr><td colspan='3'><b>UI Style:</b> <a href='?_src_=prefs;preference=ui'><b>[UI_style]</b></a></td></tr>"
	. += 				"<tr><td colspan='3'><b>Custom UI</b>(recommended for White UI):<td></tr>"
	. += 				"<tr><td width='42%'>Color: <a href='?_src_=prefs;preference=UIcolor'><b>[UI_style_color]</b></a><td bgcolor='[UI_style_color]'><td width='40%'></td></td></td></tr>"
	. += 				"<tr><td colspan='3'>Alpha(transparency): <a href='?_src_=prefs;preference=UIalpha'><b>[UI_style_alpha]</b></a></td></tr>"
	. += 				"<tr><td colspan='3'><a href='?_src_=prefs;task=reset'>Reset custom UI</a></td></tr>"
	if(config.allow_Metadata)
		. +=			"<tr><td colspan='3'><br><b>OOC Notes:</b><br><a href='?_src_=prefs;preference=metadata;task=input'>[length(metadata)>0?"[sanitize_popup(copytext(metadata, 1, 37))]...":"\[...\]"]</a></td></tr>"
	. += 			"</table>"
	. += 		"</td>"
	. += 		"<td>"
	. += 			"<table width='100%'>"
