/datum/preferences/proc/ShowGlobal(mob/user)
	...
	. += 		"<td width='50%'>"
	. += 			"<table width='100%'>"
	. += 				"<tr><td><b>UI Style:</b> <a href='byond://?_src_=prefs;preference=ui'><b>[UI_style]</b></a></td></tr>"
	. += 				"<tr><td><b>Custom UI</b>(recommended for White UI):<td></tr>"
	. += 				"<tr><td><a href='byond://?_src_=prefs;preference=UIcolor'><b>Change color</b></a> <table border cellspacing='0' style='display:inline;' bgcolor='[UI_style_color]'><tr><td width='20' height='15'></td></tr></table></td></tr>"
	. += 				"<tr><td>Alpha(transparency): <a href='byond://?_src_=prefs;preference=UIalpha'><b>[UI_style_alpha]</b></a></td></tr>"
	...
	. += 				"<tr><td>TGUI Scaling:</b> <a href='byond://?_src_=prefs;preference=window_scale'><b>[window_scale ? "Larger windows (default)" : "Smaller zoom"]</a></td></tr>"
	...
	. +=			"<tr><td><br><b>OOC Notes: </b><a href='byond://?_src_=prefs;preference=metadata;task=input'>[length(metadata)>0?"[copytext_char(metadata, 1, 3)]...":"\[...\]"]</a></td></tr>"
	//if(user.client) TG
	//	if(user.client.holder)
	//		. += "<b>Announce Login:</b> <a href='byond://?_src_=prefs;preference=announce_login'>[(toggles & ANNOUNCE_LOGIN)?"On":"Off"]</a><br>"

	//	if(unlock_content || check_rights_for(user.client, R_ADMIN))
	//		. += "<b>OOC:</b> <span style='border: 1px solid #161616; background-color: [ooccolor ? ooccolor : normal_ooc_colour];'>&nbsp;&nbsp;&nbsp;</span> <a href='byond://?_src_=prefs;preference=ooccolor;task=input'>Change</a><br>"

	//	if(unlock_content)
	//		. += "<b>BYOND Membership Publicity:</b> <a href='byond://?_src_=prefs;preference=publicity'>[(toggles & MEMBER_PUBLIC) ? "Public" : "Hidden"]</a><br>"
	//		. += "<b>Ghost Form:</b> <a href='byond://?_src_=prefs;task=input;preference=ghostform'>[ghost_form]</a><br>"
	. += 			"</table>"
	. += 		"</td>"
	. += 		"<td>"
	. += 			"<table width='100%'>"
	...
	. += 					"<td><a href='byond://?_src_=prefs;preference=ghost_ears'><b>[(chat_toggles & CHAT_GHOSTEARS) ? "All Speech" : "Nearest Creatures"]</b></a></td>"
	. += 				"</tr>"
	. +=				"<tr>"
	. += 					"<td width='45%'>Ghost hear NPCs:</td>"
	. += 					"<td><a href='byond://?_src_=prefs;preference=npc_ghost_ears'><b>[(chat_toggles & CHAT_GHOSTNPC) ? "All Speech" : "Nearest Creatures"]</b></a></td>"
	. += 				"</tr>"
	. += 				"<tr>"
	. += 					"<td width='45%'>Ghost sight:</td>"
	. += 					"<td><a href='byond://?_src_=prefs;preference=ghost_sight'><b>[(chat_ghostsight == CHAT_GHOSTSIGHT_ALL) ? "All Emotes" : ((chat_ghostsight == CHAT_GHOSTSIGHT_ALLMANUAL) ? "All manual-only emotes" : "Nearest Creatures")]</b></a></td>"
	. += 				"</tr>"
	. += 				"<tr>"
	. += 					"<td width='45%'>Ghost radio:</td>"
	. += 					"<td><a href='byond://?_src_=prefs;preference=ghost_radio'><b>[(chat_toggles & CHAT_GHOSTRADIO) ? "All Chatter" : "Nearest Speakers"]</b></a></td>"
	. += 				"</tr>"
	. += 				"<tr>"
	. += 					"<td width='45%'>OOC:</td>"
	. += 					"<td><a href='byond://?_src_=prefs;preference=see_ooc'><b>[(chat_toggles & CHAT_OOC) ? "Shown" : "Hidden"]</b></a></td>"
	. += 				"</tr>"
	. += 				"<tr>"
	. += 					"<td width='45%'>LOOC:</td>"
	...
	. += 					"<td><a href='byond://?_src_=prefs;preference=lobbyanimation'><b>[lobbyanimation ? "Enabled" : "Disabled"]</b></a></td>"
	. += 				"</tr>"
	. += 				"<tr>"
	...
	. += 					"<td><a href='byond://?_src_=prefs;preference=see_animations'><b>[(toggles & SHOW_ANIMATIONS) ? "Yes" : "No"]</b></a></td>"
	. += 				"</tr>"
	. += 				"<tr>"
	. += 					"<td width='45%'>Progress Bar:</td>"
	. += 					"<td><a href='byond://?_src_=prefs;preference=see_progbar'><b>[(toggles & SHOW_PROGBAR) ? "Yes" : "No"]</b></a></td>"
	. += 				"</tr>"
	. +=				"<tr>"
	. += 					"<td width='45%'>Name of Items:</td>"
	. +=					"<td><a href='byond://?_src_=prefs;preference=tooltip_show'><b>[tooltip ? "Hide" : "Show"]</b></a></td>"
	. += 				"</tr>"
	. +=				"<tr>"
	. += 					"<td width='45%'>Change Font of Names of Items:</td>"
	. +=					"<td><a href='byond://?_src_=prefs;preference=change_font_tooltip'><b>Change</b></a></td>"
	. += 				"</tr>"
	. +=				"<tr>"
	. += 					"<td width='45%'>Change Names Size:</td>"
	. +=					"<td><a href='byond://?_src_=prefs;preference=change_size_tooltip'><b>[tooltip_size]</b></a></td>"
	. += 				"</tr>"
	. += 			"</table>"
	. += 		"</td>"
	. += 	"</tr>"
