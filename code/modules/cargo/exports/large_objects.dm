...
/datum/export/large/reagent_dispenser
	cost = 20 // +0-30 depending on amount of reagents left
	var/contents_cost = 30
...
/datum/export/large/reagent_dispenser/beer
	unit_name = "beer keg"
	contents_cost = 200 //beer is more expensive than fuel...based
...
/datum/export/large/singularitygen
	cost = 400 // If you have one left after engine setup, sell it.
