...
/obj/machinery/atmospherics/components/trinary/network_expand(datum/pipe_network/new_network, obj/machinery/atmospherics/pipe/reference)
	if(reference == node1)
		qdel(network1)
...
/obj/machinery/atmospherics/components/trinary/return_network(obj/machinery/atmospherics/reference)
	build_network()
...
/obj/machinery/atmospherics/components/trinary/reassign_network(datum/pipe_network/old_network, datum/pipe_network/new_network)
...
/obj/machinery/atmospherics/components/trinary/return_network_air(datum/pipe_network/reference)
