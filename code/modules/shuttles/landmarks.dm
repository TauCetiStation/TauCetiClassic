...
/obj/effect/shuttle_landmark/atom_init()
	..()
...
/obj/effect/shuttle_landmark/atom_init_late()
...
/obj/effect/shuttle_landmark/automatic/atom_init()
	..()
...
/obj/effect/shuttle_landmark/automatic/clearing/atom_init_late()
	..()
	var/list/victims = circlerangeturfs(get_turf(src), radius)
	for(var/turf/T in victims)
		if(!istype(T, /turf/space))
			T.ChangeTurf(/turf/space) //OUR VERSION OF SHUTTLES FLY ONLY IN SPACE! (maybe, this will be fixes in future)
