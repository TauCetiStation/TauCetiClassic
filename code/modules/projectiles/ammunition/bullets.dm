...
/obj/item/ammo_casing/shotgun/buckshot
	name = "buckshot shell"
	desc = "Дробинка 12-го калибра типа \"картечь\"."
	icon_state = "gshell"
	pellets = 7
...
/obj/item/ammo_casing/shotgun/beanbag
	name = "beanbag shell"
	desc = "Дробинка 12-го калибра типа \"травмат\"."
	icon_state = "bshell"
...
/obj/item/ammo_casing/shotgun/stunshot
	name = "stun shell"
	desc = "Дробинка 12-го калибра типа \"электрошок\"."
...
/obj/item/ammo_casing/shotgun/incendiary
	...
	desc = "Дробинка 12-го калибра типа \"зажигательная\"."
	icon_state = "ishell"
...
/obj/item/ammo_casing/shotgun/dart
	name = "shotgun darts"
	desc = "Дробинка 12-го калибра типа \"дротик\"."
	icon_state = "cshell"
