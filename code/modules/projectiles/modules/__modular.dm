...
#define GRIP /obj/item/modular/grip
#define ACCESSORY /obj/item/modular/accessory
#define LENS /obj/item/ammo_casing/energy
#define MAGAZINE_INTERNAL /obj/item/ammo_box/magazine/internal
