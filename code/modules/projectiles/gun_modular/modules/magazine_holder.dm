...
/obj/item/gun_modular/module/magazine_holder/main_action(datum/pipe_system/process/process)

	var/datum/pipe_system/component/data/gun_ammo_box/ammo_box_component = new (src, ammo_box)
...
/obj/item/gun_modular/module/magazine_holder/init_default_components_module()
	...
	var/datum/pipe_system/component/check/get_ammo/get_ammo_check = new(src, null, null)
	var/datum/pipe_system/component/proc_gun/ammo_box_get_round/ammo_box_get_round_proc = new(src)
