...
/obj/item/weapon/spikethrower/process()
	...
	if(spikes < max_spikes && world.time > last_regen + spike_gen_time)
		playsound(src, 'sound/weapons/guns/reload_newspike.ogg', VOL_EFFECTS, 30, null, -5)
		spikes++
		last_regen = world.time
		update_icon()
...
/obj/item/weapon/spikethrower/proc/Fire(atom/target, mob/living/user, params, reflex = 0)
	...
	if(spikes <= 0)
		playsound(src, 'sound/weapons/guns/outofspikes.ogg', VOL_EFFECTS, null, null, -6)
	...
	playsound(src, 'sound/weapons/guns/gunshot_spikethrower.ogg', VOL_EFFECTS, null, null, -5)
