...
/obj/item/weapon/gun/energy/laser/big //the bigger version of lasrifle with bigger powercell
	...
	desc = "Стандартное оружие, предназначенное для убийства с помощью концентрированных энергетических зарядов. Этот экземпляр имеет батарейку повышенной емкости и обладает большими габаритами."
	m_amt = 4000
