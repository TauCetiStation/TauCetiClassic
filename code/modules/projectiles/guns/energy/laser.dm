...
/obj/item/weapon/gun/energy/xray
	name = "xray laser gun"
	desc = "Мощное лазерное оружие, способное испускать концентрированные рентгеновские лучи.Мощное лазерное оружие, способное испускать концентрированные рентгеновские лучи."
	icon_state = "xray"
	item_state = null
