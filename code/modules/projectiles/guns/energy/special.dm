...
/obj/item/weapon/gun/energy/syndiborg_printer
	name = "cyborg smg"
	desc = "An SMG that fires 3D-printed flechettes. They are slowly resupplied using the cyborg's internal power source."
	icon_state = "borg_smg"
...
/obj/item/weapon/gun/energy/syndiborg_printer/update_icon()
	return
