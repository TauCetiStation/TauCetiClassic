...
/obj/item/weapon/gun/energy/sniperrifle
	name = "sniper rifle"
	desc = "Разработанная компанией W&J, снайперская винтовка W2500-E созданна из лёгковесных материалов и обладает вмонтированной УМНОЙ системой прицеливания."
