...
/obj/item/weapon/gun/energy/taser/select_fire(mob/living/user)
	if(!handle_fumbling(user,src, SKILL_TASK_TRIVIAL, list(/datum/skill/police = SKILL_LEVEL_TRAINED), message_self = "<span class='notice'>You fumble around figuring out how to switch mode on [src]...</span>"))
		return
	..()
