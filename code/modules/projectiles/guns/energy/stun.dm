...
/obj/item/weapon/gun/energy/taser/select_fire(mob/living/user)
	if(!handle_fumbling(user,src, SKILL_TASK_TRIVIAL, SKILL_POLICE, SKILL_POLICE_TRAINED, message_self = "<span class='notice'>You fumble around figuring out how to switch mode on [src]...</span>"))
		return
	..()
