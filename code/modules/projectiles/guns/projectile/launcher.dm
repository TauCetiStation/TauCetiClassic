...
/obj/item/weapon/gun/projectile/m79/attackby(obj/item/A, mob/user)
	...
	if(num_loaded)
		playsound(src, 'sound/weapons/guns/reload_m79.ogg', VOL_EFFECTS)
...
/obj/item/weapon/gun/projectile/m79/attack_self(mob/user)
	open = !open
	if(open)
		playsound(src, 'sound/weapons/guns/m79_out.ogg', VOL_EFFECTS)
		if(chambered)
		...
		playsound(src, 'sound/weapons/guns/m79_in.ogg', VOL_EFFECTS)
		open = 0
