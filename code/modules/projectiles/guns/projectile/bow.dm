...
/obj/item/weapon/crossbow/proc/increase_tension(mob/user)
	...
	if(tension>=max_tension)
		...
		user.visible_message("[usr] натягивает тетеву [src]!", "Вы продолжаете натягивать тетеву [src]!")
		spawn(25) increase_tension(user)
...
/obj/item/weapon/crossbow/proc/Fire(atom/target, mob/living/user, params, reflex = 0)
	...
	user.visible_message("<span class='danger'>[user] стреляет из [src] и [arrow] летит в направлении [target]!</span>","<span class='danger'>Вы отпускаете [src] и отправляется в полет [arrow] несущуюся навстречу [target]!</span>")
...
/obj/item/weapon/crossbowframe1
	...
	desc = "Чтобы завершить, вам нужно: добавить 3 стержня; заварите швы; добавить 5 проводов; добавить 3 пластика; добавить 5 проводов; затянуть болты с помощью отвертки."
	icon_state = "crossbowframe1"
	item_state = "crossbow-solid"

/obj/item/weapon/crossbowframe2
	name = "crossbow(2 stage)"
	desc = "Чтобы завершить, вам нужно: заварите швы; добавить 5 проводов; добавить 3 пластика; добавить 5 проводов; затянуть болты с помощью отвертки."
...
/obj/item/weapon/crossbowframe5
	...
	desc = "Чтобы завершить, вам нужно: добавить 5 cable coil; затянуть болты с помощью отвертки."
