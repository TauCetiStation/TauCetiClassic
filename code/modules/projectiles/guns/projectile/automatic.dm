...
/obj/item/weapon/gun/projectile/automatic/a28
	...
	desc = "Автоматическая винтовка типа булл-пап с воздушным охлождением, используемая военным корпусом пехоты НаноТрейзен. На ствольной коробке выгравировано - 'Сэр, я заканчиваю этот бой'. Использует патроны калибром 5.56мм."
	icon_state = "a28"
	item_state = "a28"
	w_class = SIZE_SMALL
	two_hand_weapon = DESIRABLE_TWOHAND
