...
/obj/item/weapon/storage/pneumatic/proc/Fire(atom/target, mob/living/user, params, reflex = 0)
	...
	user.visible_message("<span class='danger'>[user] выстреливает по [target] из пневматической пушки!</span>","<span class='danger'>Вы стреляете по [target] из пневматической пушки!</span>")
