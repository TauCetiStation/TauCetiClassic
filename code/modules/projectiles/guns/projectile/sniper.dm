...
/obj/item/weapon/gun/projectile/heavyrifle/attackby(obj/item/A, mob/user)
	...
	if(num_loaded)
		...
		playsound(src, 'sound/weapons/guns/heavybolt_in.ogg', VOL_EFFECTS)
...
/obj/item/weapon/gun/projectile/heavyrifle/attack_self(mob/user)
	bolt_open = !bolt_open
	if(bolt_open)
		playsound(src, 'sound/weapons/guns/heavybolt_out.ogg', VOL_EFFECTS)
		if(chambered)
			spawn(3)
		...
		playsound(src, 'sound/weapons/guns/heavybolt_reload.ogg', VOL_EFFECTS)
