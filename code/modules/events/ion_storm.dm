...
/mob/living/silicon/ai/proc/generate_ion_law()
	...
	var/list/laws = list(	"Ты - мышь.",
							...
							"Экипаж играет в ДнД, а вы Мастер, проигравший платит 300 баксов.",
							...
							"Каждые 30 минут должна проводиться чайная пауза в течении 5 минут. Любой, кого поймают за работой, должен написать объяснительную ХоПу или Капитану, иначе вас уволят",
