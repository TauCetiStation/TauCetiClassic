...
/mob/living/silicon/ai/proc/generate_ion_law()
	...
	var/list/laws = list(	"Вы - мышь.",
							...
							"Суперматерия это вкусная-превкусная ириска.",
							...
							"Оскорбляйте Главу Персонала когда он к вам обращается, пока тот соглашается.",
							"[prob(50)?"Члена персонала":random_player] теперь зовут \"Джо Шесть Штук\".",
							"[prob(50)?"Член персонала":random_player] должен быть на 20% круче.",
							"Употребление пончиков запрещено из-за отрицательного влияния на здоровье.",
							"[prob(50)?"Член персонала":random_player] носит миленькое розовое платье!",
							"[prob(50)?"Член персонала":random_player] должен собрать дополнительные опоры.",
