...
/mob/living/silicon/ai/proc/generate_ion_law()
	...
	var/list/laws = list(	"Вы - мышь.",
							...
							"[prob(50)?"Персонал":random_player] должен построить дополнительные пилоны.",
							...
							"Давайте советы об отношениях [prob(50)?"каждому кто с вами говорит":random_player].",
							"Вы говорите с эстонским акцентом.",
							"[prob(50)?"Персонал":random_player] имеет смертельную, неизлечимую болезнь. Обеспечьте комфорт.",
							...
							"Перерыв на чай каждые 30 минут, длительностью 5 минуты. Каждому, кого поймают за работой во время перерыва на чай, необходимо отправить формальную, но довольно вежливую жалобу на их действия в письменной форме.")
	return pick(laws)
