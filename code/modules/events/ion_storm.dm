...
/mob/living/silicon/ai/proc/generate_ion_law()
	...
	var/list/laws = list(	"Ты - мышь.",
							...
							"Нужно построить зиккурат, [prob(50)?"Член экипажа":random_player].",
							...
							"Экипаж играет в Dungeons and Dragons, а вы — Рассказчик.",
							...
							"[random_player] - монарх Российской Империи. Убедитесь, что экипаж проявляет должное отношение.",
