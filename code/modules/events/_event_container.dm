...
/datum/event_container/roundstart
	...
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Break Light",             /datum/event/aspect/area/break_light,                        50, list(ASSIGNMENT_ENGINEER = 10, ASSIGNMENT_JANITOR = 40)),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Dirt Bay",                /datum/event/aspect/area/dirt,                               10, list(ASSIGNMENT_JANITOR = 100)),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Randomize Cargo Storage", /datum/event/aspect/area/cargo_storage,                      10),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Armory Mess",             /datum/event/aspect/area/armory_mess,                        10),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "MineField",               /datum/event/aspect/area/minefield,                          5,  list(ASSIGNMENT_MEDICAL = 2), , list(ASSIGNMENT_SECURITY = 2)),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Lasertag ED-209",         /datum/event/aspect/area/lasertag_ed,                        10),list(ASSIGNMENT_ANY = 2),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Stolen Weapon",           /datum/event/aspect/area/replace/sec_weapons,                20, list(ASSIGNMENT_SECURITY = 5)),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Stolen First AID",        /datum/event/aspect/area/replace/med_storage,                10, list(ASSIGNMENT_MEDICAL = 1)),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Old Morgue",              /datum/event/aspect/area/replace/med_morgue,                 10),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Broken Airlocks",         /datum/event/aspect/area/replace/airlock,                    10, list(ASSIGNMENT_ENGINEER = 20)),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Chewed Cables",           /datum/event/aspect/area/replace/del_cable,                  10, list(ASSIGNMENT_ENGINEER = 20)),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Clondike",                /datum/event/aspect/area/replace/vault_gold,                 10),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Deathly Sec.",            /datum/event/aspect/area/replace/deathly_sec,                5,  list(ASSIGNMENT_CLOWN = 50)),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Forgotten Surgeon Tools", /datum/event/aspect/area/replace/del_surgeon_tools,          10, list(ASSIGNMENT_MEDICAL = 2)),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Anti meat",               /datum/event/aspect/area/replace/mince_back,                 10),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Invasion In Mainteance",  /datum/event/aspect/area/maintenance_spawn/invasion,         10, list(ASSIGNMENT_SECURITY = 50)),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Sign of Antagonists",     /datum/event/aspect/area/maintenance_spawn/antag_meta,       10, list(ASSIGNMENT_SECURITY = 50)),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Forgotten Headset",       /datum/event/aspect/headset,                                 10, list(ASSIGNMENT_ANY = 5)),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Forgotten Survival Box",  /datum/event/aspect/survbox,                                 10, list(ASSIGNMENT_ANY = 5)),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Forgotten Fueltanks",     /datum/event/aspect/fueltank,                                10, list(ASSIGNMENT_ENGINEER = 20)),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Forgotten Watertanks",    /datum/event/aspect/watertank,                               10, list(ASSIGNMENT_BOTANIST = 10)),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Forgotten Cleaners",      /datum/event/aspect/cleaner,                                 10, list(ASSIGNMENT_JANITOR = 100)),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Forgotten Extinguishers", /datum/event/aspect/extinguisher,                            10),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Forgotten Scraps",        /datum/event/aspect/del_scrap,                               10),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Forgotten Toilets",       /datum/event/aspect/del_toilet,                              10),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Leaked Pipe",             /datum/event/aspect/leaked_pipe,                             10),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Die Monkey",              /datum/event/aspect/dead_monkeys,                            10, list(ASSIGNMENT_SCIENTIST = 5)),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Engine Mess",             /datum/event/aspect/PA,                                      10, list(ASSIGNMENT_ENGINEER = 10)),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Forgottens Tanks",        /datum/event/aspect/tank_dispenser,                          10, list(ASSIGNMENT_ENGINEER = 5, ASSIGNMENT_SCIENTIST = 10)),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Forgotten Sec. Equimp.",  /datum/event/aspect/sec_equipment,                           10, list(ASSIGNMENT_SECURITY = 10)),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Products Inflation",      /datum/event/aspect/vending_products,                        10),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "BlueScreen APC",          /datum/event/aspect/apc,                                     10, list(ASSIGNMENT_ENGINEER = 5)),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Accounting Got It Wrong", /datum/event/aspect/salary,                                  10, list(ASSIGNMENT_ANY = 2)),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Last Clown Jokes",        /datum/event/aspect/airlock_joke,                            10, list(ASSIGNMENT_CLOWN = 50)),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Chiefs Animals",          /datum/event/aspect/head_animals,                            10),
	)
