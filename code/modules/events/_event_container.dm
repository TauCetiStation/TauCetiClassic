...
/datum/event_container/roundstart
	...
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Stolen Weapon",           /datum/event/feature/area/replace/sec_weapons,                20, list(ASSIGNMENT_SECURITY = 5)),
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Stolen First AID",        /datum/event/feature/area/replace/med_storage,                10, list(ASSIGNMENT_MEDICAL = 1)),
		...
		new /datum/event_meta(EVENT_LEVEL_ROUNDSTART, "Deathly Sec.",            /datum/event/feature/area/replace/deathly_sec,                5,  list(ASSIGNMENT_CLOWN = 50)),
