...
/datum/event_container/mundane
	...
	new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Camera Damage",      /datum/event/camera_damage,                           200,  list(ASSIGNMENT_ENGINEER = 60)),
	)
...
/datum/event_container/major
	...
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Camera Damage",           /datum/event/camera_damage,   200, list(ASSIGNMENT_ENGINEER = 60)),
	)
