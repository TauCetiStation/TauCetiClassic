...
/datum/event_container/mundane
	...
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Gravitational Anomaly",  /datum/event/anomaly/anomaly_grav,                    200),
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Organ Failure",          /datum/event/organ_failure,                           0,     list(ASSIGNMENT_MEDICAL = 150), ONESHOT),
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Space Traders",          /datum/event/space_traders,                           100,   list(), ONESHOT, 1, 20),
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Brand Intelligence",     /datum/event/brand_intelligence,                      50,    list(ASSIGNMENT_ENGINEER = 25), ONESHOT),
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Electrical Storm",       /datum/event/electrical_storm,                        250,   list(ASSIGNMENT_ENGINEER = 20, ASSIGNMENT_JANITOR = 150)),
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Space Vines",            /datum/event/spacevine,                               250,   list(ASSIGNMENT_ENGINEER = 10)),
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "APC Malfunction",        /datum/event/apc_damage,                              200,   list(ASSIGNMENT_ENGINEER = 60)),
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Ion Storm",              /datum/event/ionstorm,                                0,     list(ASSIGNMENT_AI = 50, ASSIGNMENT_CYBORG = 50, ASSIGNMENT_ENGINEER = 15, ASSIGNMENT_SCIENTIST = 5)),
	)
...
/datum/event_container/moderate
	...
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Portal Storm",            /datum/event/portal_storm,              60,    list(ASSIGNMENT_SECURITY = 40), ONESHOT, 1, 10),
...
/datum/event_container/major
	...
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Wizard",          		/datum/event/wizard,   			0, list(ASSIGNMENT_SECURITY = 20), ONESHOT, 1, 15),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Meteor Wave",             /datum/event/meteor_wave,       0, list(ASSIGNMENT_ENGINEER = 10), ONESHOT),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Lone Syndicate Agent",    /datum/event/lone_op,         100, list(ASSIGNMENT_SECURITY = 30), ONESHOT, 1, 30),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Abduction",               /datum/event/abduction,         0, list(ASSIGNMENT_SECURITY = 30), ONESHOT, 1, 25),
	)
