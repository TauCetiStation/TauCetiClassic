...
/datum/event_container/feature
	...
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_FEATURE, "Sec Rearm: Bullets",      /datum/event/feature/area/replace/sec_rearmament/bullets,     10, list(ASSIGNMENT_SECURITY = 3)),
		new /datum/event_meta(EVENT_LEVEL_FEATURE, "Sec Rearm: Energy",       /datum/event/feature/area/replace/sec_rearmament/energy,      10, list(ASSIGNMENT_SECURITY = 3)),
