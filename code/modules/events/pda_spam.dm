		...
		if(prob(2))
			...
			switch(pick(1,2,3,4,5,6,7))
				if(1)
					...
					message = pick("Тройные депозиты, ставки, казино всё это и не только на MaxBet Онлайн!",\
				...
				if(4)
					...
					"Доктор Максман был создан Джорджем Алленом, магистром медицинских наук, сертифицированным урологом CentComm, который вылечил более 70 000 пациентов во всем секторе от 'мужских проблем'.",\
					"После семи лет исследований, Доктор Аллен и его команда придумали эту простую и революционную формулу улучшения мужской силы.",\
				...
				if(5)
					...
					"В связи с нехваткой моих агентов, мне требуется независимый финансовый счет, чтобы немедленно перевести на него 1 МИЛЛИОН кредитов.",\
				...
				if(7)
					...
					message = pick("Вы выиграли билеты на новейший фильм СПАСТИ КАПИТАНА ДЖОНИ!",\
