...
/datum/event/aspect/area/maintenance_spawn/proc/spawn_atom(type, turf/T)
	if(T)
...
/datum/event/aspect/area/maintenance_spawn/start()
...
/datum/event/aspect/area/maintenance_spawn/invasion
	possible_types = list(
...
/datum/event/aspect/area/maintenance_spawn/invasion/setup()
	nums = rand(1, 3)
	. = ..()

/datum/event/aspect/area/maintenance_spawn/antag_meta
	possible_types = list(
		/obj/effect/rune,
...
/datum/event/aspect/area/maintenance_spawn/antag_meta/setup()
	nums = rand(1, 3)
	possible_types += subtypesof(/obj/item/weapon/storage/box/syndie_kit)
	. = ..()

/datum/event/aspect/area/maintenance_spawn/antag_meta/spawn_atom(type, turf/T)
