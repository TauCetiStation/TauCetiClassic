/datum/event/feature/area/replace/mince_back
...
/datum/event/feature/area/replace/mince_back/setup()
	. = ..()
	new_atom_callback = CALLBACK(src, .proc/make_death)

/datum/event/feature/area/replace/mince_back/proc/make_death(mob/M)
	M.death()
