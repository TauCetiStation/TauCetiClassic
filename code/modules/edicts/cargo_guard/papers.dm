...
/obj/item/weapon/paper/cargo_guard_request
	...
	<p>Для удовлетворения запроса носитель данной формы (квартирмейстер) обязан лично прибыть на станцию Центрального Командования к моменту прибытия эвакуационного шаттла, будучи живым и не находясь под арестом. Финансовое обеспечение запроса подтверждается остатком счёта Карго на момент конца смены.</p>"}
