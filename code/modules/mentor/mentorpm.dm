...
/client/proc/cmd_admin_pm_context(mob/M as mob in mob_list)
	...
	if(!check_rights(R_ADMIN))
		to_chat_admin_pm(src, "<span class='warning'>Error: Mentor-PM-Context: Only administrators may use this command.</span>")
		return
...
/client/proc/cmd_admin_pm_panel()
	...
	set name = "Admin PM"
	if(!check_rights(R_ADMIN))
		to_chat_admin_pm(src, "<span class='warning'>Error: Mentor-PM-Panel: Only administrators may use this command.</span>")
		return
