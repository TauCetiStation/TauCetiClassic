...
/atom/proc/balloon_alert_to_viewers(message, self_message, vision_distance = 7, list/ignored_mobs)	// TODO: make a define for vision_distance
	SHOULD_NOT_SLEEP(TRUE)

	var/list/hearers = mobs_in_view(vision_distance, src)	// TODO: use a better function
...
/atom/proc/balloon_alert_perform(mob/viewer, text)
	...
	// TODO: add in related z level shit
