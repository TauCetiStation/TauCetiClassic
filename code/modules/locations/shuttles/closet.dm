/obj/structure/closet/wagon
	...
	desc = "Это настенный шкаф для хранения вещей на экстренный случай. Внутри которого дыхательная маскама и баллон с кислородом."
...
/obj/structure/closet/mining
	name = "emergency closet"
	cases = list("аварийный шкаф", "аварийного шкафа", "аварийному шкафу", "аварийный шкаф", "аварийным шкафом", "аварийном шкафе")
	desc = "Это настенный шкаф для хранения вещей на экстренный случай. Внутри которого балон с запасом кислорода и герметичный костюмом."
	icon = 'icons/locations/shuttles/closet.dmi'
