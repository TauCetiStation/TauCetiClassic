...
/datum/disease2/effect/stimulant
	...
	desc = "The virus boosts production of adrenaline, giving host a lot of energy."
	level = 2
	max_stage = 3
	cooldown = 10
