...
/proc/compare_heights(mob/living/carbon/human/A, mob/living/carbon/human/B)
	var/first_height = 0
	var/second_height = 0
	var/difference = 0
...
/proc/check_hit_direction(mob/living/carbon/human/Attacker, mob/living/carbon/human/Victim)
	var/message = ""
	var/difference = compare_heights(Attacker, Victim)
	switch(difference)
		if(-9)
