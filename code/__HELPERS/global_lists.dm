...
/proc/make_datum_references_lists()
    ...
    */
    ...
    global.atmosReactionListRarest = list()
    for(var/gas in gas_data.gases)
        global.atmosReactionListRarest[gas] = list()
        for(var/I in global.atmosReactionList)
            var/datum/atmosReaction/R = global.atmosReactionList[I]
            if(R.rarestGas == gas)
                var/list/B = atmosReactionListRarest[gas]
                B += R
                atmosReactionListRarest[gas] = B
