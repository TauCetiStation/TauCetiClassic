...
/proc/noob_notify(mob/M)
	...
	if((isnum(M.client.player_age) && M.client.player_age < 5) || (isnum(player_ingame_age) && M.client.player_ingame_age < 600)) //less than 5 days on server OR less than 10 hours in game
