var/datum/subsystem/codex/SScodex

/datum/subsystem/codex
	name = "Codex"
	flags      = SS_NO_FIRE
	init_order = SS_INIT_CODEX
	priority   = SS_PRIORITY_CODEX
	flags      = SS_BACKGROUND
	wait       = SS_WAIT_CODEX
...
/datum/subsystem/codex/New()
	NEW_SS_GLOBAL(SScodex)

/datum/subsystem/codex/Initialize(timeofday)
...
/datum/subsystem/codex/proc/parse_links(string, viewer)
...
/datum/subsystem/codex/proc/get_codex_entry(var/entry)
...
/datum/subsystem/codex/proc/add_entry_by_string(var/string, var/entry)
	entries_by_string[lowertext(trim(string))] = entry

/datum/subsystem/codex/proc/get_entry_by_string(var/string)
	return entries_by_string[lowertext(trim(string))]

/datum/subsystem/codex/proc/present_codex_entry(var/mob/presenting_to, var/datum/codex_entry/entry)
...
/datum/subsystem/codex/proc/retrieve_entries_for_string(var/searching)
...
/datum/subsystem/codex/Topic(href, href_list)
	. = ..()
