SUBSYSTEM_DEF(events)
	...
	var/list/event_containers = list(new/datum/event_container/feature, new/datum/event_container/mundane, new/datum/event_container/moderate, new/datum/event_container/major)
