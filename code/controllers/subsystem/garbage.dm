...
/datum/verb/find_references()
	...
	if(usr && usr.client)
		...
		if(tgui_alert(usr,"Running this will create a lot of lag until it finishes.  You can cancel it by running it again.  Would you like to begin the search?", list("Find References", "Yes", "No")) == "No")
			running_find_references = null
			return
