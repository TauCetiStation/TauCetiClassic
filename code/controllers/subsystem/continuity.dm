...
/datum/controller/subsystem/continuity/proc/spawn_maintenance_barrel()
	var/turf/T = pick(global.maintenance_barrels)
	new /obj/structure/preservation_barrel/maintenance(T)

/datum/controller/subsystem/continuity/proc/read_barrels()
...
/datum/controller/subsystem/continuity/proc/write_barrels()
	var/savefile/S = new /savefile("data/obj_saves/Preservations.sav")
...
/datum/controller/subsystem/continuity/proc/read_tables()
	var/savefile/S = new /savefile("data/obj_saves/Preservations.sav")
...
/datum/controller/subsystem/continuity/proc/write_tables()
	var/savefile/S = new /savefile("data/obj_saves/Preservations.sav")
...
/datum/controller/subsystem/continuity/proc/read_boxes()
	var/savefile/S = new /savefile("data/obj_saves/Preservations.sav")
...
/datum/controller/subsystem/continuity/proc/write_boxes()
	var/savefile/S = new /savefile("data/obj_saves/Preservations.sav")
