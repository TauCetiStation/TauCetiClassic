...
/datum/subsystem/job/proc/DivideOccupations()
	...
	for(var/mob/dead/new_player/player in unassigned)
		if(player.client.prefs.alternate_option == RETURN_TO_LOBBY)
			...
			to_chat(player, "<b><font color='red'>You were returned to the lobby because your job preferences unavailable.  You can change this behavior in preferences.</font>")
	return 1
