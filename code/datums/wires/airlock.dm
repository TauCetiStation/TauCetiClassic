...
/datum/wires/airlock/get_status()
	...
	. += "[A.unres_sides ? "The unrestricted exit display is indicating that it is letting people pass from [(A.unres_sides in list(1,2,4,8)) ? "the [dir2text(A.unres_sides)]" : "multiple sides"]" : "The unrestricted exit display is faintly flickering"]."
	. += list(list(
