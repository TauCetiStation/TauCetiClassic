...
/datum/weather/proc/telegraph()
	...
	for(var/V in player_list)
		...
		if(M.z == target_z)
			...
			if(telegraph_sound)
				M.playsound_local(null, telegraph_sound, VOL_EFFECTS, null, FALSE)
...
/datum/weather/proc/start()
	...
	for(var/V in player_list)
		...
		if(M.z == target_z)
			...
			if(weather_sound)
				M.playsound_local(null, weather_sound, VOL_EFFECTS, null, FALSE)
...
/datum/weather/proc/wind_down()
	...
	for(var/V in player_list)
		...
		if(M.z == target_z)
			...
			if(end_sound)
				M.playsound_local(null, end_sound, VOL_EFFECTS, null, FALSE)
