/datum/trader/ship/vox
	...
	possible_wanted_items = list(/obj/item/weapon/                  = TRADER_SUBTYPES_ONLY,
								/obj/item/stack/sheet/mineral       = TRADER_SUBTYPES_ONLY,
								)

	possible_trading_items = list(/obj/item/weapon/gun/dartgun/vox                      = TRADER_SUBTYPES_ONLY,
								...
								/obj/effect/decal/remains                               = TRADER_ALL,
