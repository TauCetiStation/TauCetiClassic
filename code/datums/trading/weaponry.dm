/datum/trader/ship/gunshop
	...
	possible_trading_items = list(/obj/item/weapon/gun/projectile/automatic/silenced    = TRADER_THIS_TYPE,
								/obj/item/weapon/gun/projectile/sigi                    = TRADER_ALL,
								/obj/item/weapon/gun/projectile/automatic/deagle        = TRADER_ALL,
								/obj/item/weapon/gun/projectile/automatic/pistol        = TRADER_ALL,
								/obj/item/weapon/gun/projectile/automatic/colt1911      = TRADER_ALL,
								/obj/item/weapon/gun/projectile/shotgun                 = TRADER_ALL,
								/obj/item/weapon/gun/projectile/revolver/doublebarrel   = TRADER_THIS_TYPE,
								/obj/item/weapon/gun/projectile/automatic/c20r          = TRADER_THIS_TYPE,
								/obj/item/weapon/gun/projectile/automatic/c5            = TRADER_THIS_TYPE,
								/obj/item/weapon/gun/projectile/automatic/l13           = TRADER_THIS_TYPE,
								...
								/obj/item/weapon/gun/projectile/automatic/bulldog       = TRADER_THIS_TYPE,
								/obj/item/weapon/gun/projectile/automatic/a28           = TRADER_THIS_TYPE,
								/obj/item/weapon/gun/projectile/automatic/a74           = TRADER_THIS_TYPE,
								/obj/item/weapon/gun/projectile/automatic/luger         = TRADER_THIS_TYPE,
								/obj/item/weapon/gun/projectile/automatic/tommygun      = TRADER_THIS_TYPE,
								/obj/item/weapon/gun/projectile/automatic/colt1911      = TRADER_THIS_TYPE,
								/obj/item/weapon/gun/projectile/automatic/gyropistol    = TRADER_THIS_TYPE,
								/obj/item/ammo_box/magazine                             = TRADER_SUBTYPES_ONLY,
								/obj/item/ammo_box/magazine/internal                    = TRADER_BLACKLIST_ALL,
...
/datum/trader/ship/egunshop
	...
	possible_trading_items = list(/obj/item/weapon/gun/energy/taser                      = TRADER_THIS_TYPE,
								...
								/obj/item/weapon/gun/energy/laser/practice               = TRADER_THIS_TYPE,
								/obj/item/weapon/gun/energy/laser/retro                  = TRADER_THIS_TYPE,
								/obj/item/weapon/gun/projectile/automatic/l10c           = TRADER_THIS_TYPE,
								/obj/item/ammo_box/magazine/l10mag                       = TRADER_THIS_TYPE,
								/obj/machinery/recharger                                 = TRADER_THIS_TYPE,
								/obj/item/clothing/accessory/holster                     = TRADER_ALL)
...
/datum/trader/dogan
	...
	possible_trading_items = list(/obj/item/weapon/gun/projectile/automatic/pistol         = TRADER_THIS_TYPE,
								/obj/item/ammo_box/magazine/m9mm                           = TRADER_THIS_TYPE,
								/obj/item/weapon/gun/projectile/sec_pistol                 = TRADER_ALL,
								/obj/item/ammo_box/magazine/at7_45                         = TRADER_THIS_TYPE,
								/obj/item/ammo_box/magazine/acm38_38                       = TRADER_THIS_TYPE,
								/obj/item/weapon/gun/projectile/heavyrifle                 = TRADER_THIS_TYPE,
								/obj/item/ammo_casing/a145                                 = TRADER_THIS_TYPE,
								/obj/item/weapon/gun/energy/laser                          = TRADER_THIS_TYPE,
								/obj/item/weapon/gun/projectile/automatic/mini_uzi         = TRADER_THIS_TYPE,
								/obj/item/ammo_box/magazine/uzim9mm                        = TRADER_THIS_TYPE,
								/obj/item/clothing/accessory/holster                       = TRADER_ALL)