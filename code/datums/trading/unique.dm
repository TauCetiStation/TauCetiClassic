...
/datum/trader/ship/unique/severance
	...
	possible_trading_items = list(/obj/mecha/combat                                                    = TRADER_SUBTYPES_ONLY,
							...
							/obj/item/ammo_box/                                                        = TRADER_SUBTYPES_ONLY,
							/obj/item/weapon/gun/projectile/automatic/mini_uzi                         = TRADER_BLACKLIST,
							/obj/item/ammo_box/magazine/m762                                           = TRADER_BLACKLIST
							)
...
/datum/trader/ship/unique/wizard
	...
	possible_trading_items = list(/obj/item/clothing/head/helmet/space/rig/wizard = TRADER_THIS_TYPE,
								/obj/item/clothing/head/wizard                   = TRADER_ALL,
								/obj/item/clothing/suit/space/rig/wizard        = TRADER_THIS_TYPE,
