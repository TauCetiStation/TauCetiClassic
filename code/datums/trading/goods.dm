/datum/trader/ship/toyshop
	...
	possible_wanted_items = list(/obj/item/toy/figure       = TRADER_THIS_TYPE,
								/obj/item/toy/figure/dsquad    = TRADER_THIS_TYPE,
	...
	possible_trading_items = list(/obj/item/toy/prize                 = TRADER_SUBTYPES_ONLY,
								...
								/obj/item/toy/figure/dsquad              = TRADER_BLACKLIST,
								/obj/item/toy/plushie                 = TRADER_SUBTYPES_ONLY,
								/obj/item/toy/katana                  = TRADER_THIS_TYPE,
								/obj/item/toy/sword                   = TRADER_THIS_TYPE,
								/obj/item/weapon/game_kit                = TRADER_ALL,
								/obj/item/toy/cards                 = TRADER_THIS_TYPE,
...
/datum/trader/ship/electronics
	...
	possible_trading_items = list(/obj/item/weapon/circuitboard                          = TRADER_SUBTYPES_ONLY,
								...
								/obj/item/weapon/circuitboard/mecha/ultra                = TRADER_BLACKLIST,
								/obj/item/weapon/circuitboard/mecha/vindicator           = TRADER_BLACKLIST,
								...
								/obj/item/weapon/stock_parts/cell                        = TRADER_THIS_TYPE,
								/obj/item/weapon/stock_parts/cell/crap                   = TRADER_THIS_TYPE,
								/obj/item/weapon/stock_parts/cell/high                   = TRADER_THIS_TYPE,
								/obj/item/weapon/stock_parts/cell/super                  = TRADER_THIS_TYPE,
								/obj/item/weapon/stock_parts/cell/hyper                  = TRADER_THIS_TYPE,
...
/datum/trader/ship/clothingshop/shoes
	...
	possible_trading_items = list(/obj/item/clothing/shoes                = TRADER_SUBTYPES_ONLY,
								...
								/obj/item/clothing/shoes/fluff            = TRADER_BLACKLIST_ALL,
...
/datum/trader/ship/clothingshop/hatglovesaccessories
	...
	possible_trading_items = list(/obj/item/clothing/accessory            = TRADER_ALL,
								/obj/item/clothing/accessory/holobadge    = TRADER_BLACKLIST_ALL,
								...
								/obj/item/clothing/head/centhat           = TRADER_BLACKLIST_ALL,
...
/datum/trader/devices
	...
	possible_trading_items = list(/obj/item/device/flashlight              = TRADER_ALL,
								/obj/item/weapon/paintkit/fluff            = TRADER_SUBTYPES_ONLY,
								/obj/item/device/aicard                    = TRADER_THIS_TYPE,
								/obj/item/weapon/reagent_containers/glass/paint = TRADER_SUBTYPES_ONLY,
...
/datum/trader/ship/robots
	...
	possible_trading_items = list(/obj/item/weapon/ed209_assembly                 = TRADER_THIS_TYPE,
								...
								/obj/item/device/paicard                          = TRADER_THIS_TYPE,
								/obj/item/device/aicard                           = TRADER_THIS_TYPE,
								/obj/machinery/bot                                = TRADER_SUBTYPES_ONLY,
								/obj/machinery/bot/mulebot                        = TRADER_BLACKLIST)
...
/datum/trader/medical
	...
	possible_trading_items = list(/obj/item/weapon/storage/pill_bottle = TRADER_SUBTYPES_ONLY,
								  ...
								  /obj/machinery/iv_drip                 = TRADER_THIS_TYPE,
								  ...
								  /obj/item/weapon/storage/belt/medical/surg/full = TRADER_THIS_TYPE,
...
/datum/trader/mining
	...
	possible_trading_items = list(/obj/machinery/mining/drill = TRADER_THIS_TYPE,
								  ...
								  /obj/machinery/floodlight = TRADER_THIS_TYPE,
								  /obj/item/weapon/storage/fancy/glowsticks = TRADER_THIS_TYPE,
								  /obj/item/clothing/head/helmet/space/rig/mining = TRADER_THIS_TYPE,
								  /obj/item/clothing/suit/space/rig/mining  = TRADER_THIS_TYPE,
