...
/mob/living/simple_animal/construct/builder/mind_initialize()
	...
	to_chat(src, "<span class='warning'><b>OOC-INFO:</b> В случае если Вы появились из ивент портала, помните, что Ваша цель - не уничтожение всего живого на станции, а защита портала. Если вы будете убивать всех подряд и делать разгерматизации - у администрации могут возникнуть к Вам вопросы. Убивать тех, кто представляет для Вас угрозу - можно, но делать угрозу из каждого - нет.</span>")
...
/mob/living/simple_animal/construct/harvester/mind_initialize()
	..()
	mind.assigned_role = "Harvester"
	to_chat(src, "<span class='cult'>Вы играете за Harvester. Вы обладаете навыком распылять парализующий дым, ходить сквозь стены культа, а так же моментально делать небольшую зону вокруг вас подвластной вашей Вере.</span>")
	to_chat(src, "<span class='warning'><b>OOC-INFO:</b> В случае если Вы появились из ивент портала, помните, что Ваша цель - не уничтожение всего живого на станции, а защита портала. Если вы будете убивать всех подряд и делать разгерматизации - у администрации могут возникнуть к Вам вопросы. Убивать тех, кто представляет для Вас угрозу - можно, но делать угрозу из каждого - нет.</span>")
