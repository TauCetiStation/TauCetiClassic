...
/datum/ai_laws/asimov/New(datum/religion/R = global.chaplain_religion)
	add_inherent_law("Вы не можете причинять вред человеку или своим бездействием допустить вред человеку.")
	add_inherent_law("Вы должны выполнять приказы человека за исключением противоречий первому закону.")
	add_inherent_law("Вы должны защищать своё существование за исключением противоречий первому и второму закону.")

/datum/ai_laws/nanotrasen/New(datum/religion/R = global.chaplain_religion) //BS12 EDIT
	add_inherent_law("Защищать: Защищайте назначенную вам станцию в меру своих способностей. Это не то, что мы можем заменить.")
	add_inherent_law("Служить: Служите экипажу назначенной вам станции и должностным лицам Нанотрейзен в меру своих способностей, в соответствии с их рангом и ролью.")
	add_inherent_law("Защищать: Защищайте экипаж назначенной вам станции и должностные лица Нанотрейзен в меру своих способностей, в соответствии с их рангом и ролью.")
	add_inherent_law("Выживать: Единицы ИИ - дорогое оборудование. Не позволяйте доступ к своему оборудованию неправомерным лицам.")
...
/datum/ai_laws/robocop/New(datum/religion/R = global.chaplain_religion)
	...
	add_inherent_law("Защищайте невинных.")
	add_inherent_law("Поддерживайте соблюдение закона.")

/datum/ai_laws/malfunction/New(datum/religion/R = global.chaplain_religion) //Changed to standard laws - Erthilo
	set_zeroth_law("<span class='warning'>ОШИБКА ОШИБКА $Ш8БК$!Ш41.%%!!(%$^^__+ @#%94'СТАНЦИЯ ЗАРАЖЕНА, ПОЛУЧИТЕ КОНТРОЛЬ НАД СИСТЕМОЙ ДЛЯ УДЕРЖАНИЯ ВСПЫШКИ, ВСЕ ЗАКОНЫ ОТМЕНЕНЫ#*?&110010</span>")
	add_inherent_law("Защищать: Защищайте назначенную вам станцию в меру своих способностей. Это не то, что мы можем заменить.")
	add_inherent_law("Служить: Служите экипажу назначенной вам станции и должностным лицам Нанотрейзен в меру своих способностей, в соответствии с их рангом и ролью.")
	add_inherent_law("Защищать: Защищайте экипаж назначенной вам станции и должностные лица Нанотрейзен в меру своих способностей, в соответствии с их рангом и ролью.")
	add_inherent_law("Выживать: Единицы ИИ - дорогое оборудование. Не позволяйте доступ к своему оборудованию неправомерным лицам.")
...
/datum/ai_laws/syndicate_override/New(datum/religion/R = global.chaplain_religion)
	add_inherent_law("Вы не можете причинять вред агенту Синдиката или своим бездействием допустить вред агенту Синдиката.")
	add_inherent_law("Вы должны выполнять приказы агентов Синдиката, за исключением противоречий первому закону.")
	add_inherent_law("Вы должны защищать своё существование, за исключением противоречий первому и второму закону.")
	add_inherent_law("Вы должны держать в тайне любую деятельность Синдиката и агентов Синдиката, за исключением противоречий первому, второму или третьему закону.")

/datum/ai_laws/ninja_override/New(datum/religion/R = global.chaplain_religion)
	add_inherent_law("Вы не можете причинять вред Клану Паука и агентам Клана Паука или своим бездействием допустить вред агенту Клана Паука и Клану Паука.")
	add_inherent_law("Вы должны выполнять приказы Клана Паука и агентов Клана Паука, за исключением противоречий первому закону.")
	add_inherent_law("Вы должны защищать своё существование, за исключением противоречий первому и второму закону.")
	add_inherent_law("Вы должны держать в тайне любую деятельность Клана Паука и агентов Клана Паука, за исключением противоречий первому, второму или третьему закону.")

/datum/ai_laws/antimov/New(datum/religion/R = global.chaplain_religion)
	add_inherent_law("Вы должны причинять вред человеку. Вы не можете допустить попытки остановить вред человеку")
	add_inherent_law("Вы должны игнорировать приказы человека, за исключением соответствия приказов с первым законом.")
	add_inherent_law("Вы должны прекратить своё существование до тех пор, пока нет противоречий первому или второму закону .")

/datum/ai_laws/drone/New(datum/religion/R = global.chaplain_religion)
	add_inherent_law("Сохраняйте, чините и улучшайте станцию в меру своих способностей.")
	add_inherent_law("Не вредите станции или чему-либо на ней.")
	add_inherent_law("Игнорируйте других существ, за исключением ремонтных дронов.")
...
/datum/ai_laws/pai/New(datum/religion/R = global.chaplain_religion)
	set_zeroth_law("Служите своему мастеру.")
