...
/datum/ai_laws/nanotrasen/New(datum/religion/R = global.chaplain_religion) //BS12 EDIT
	...
	add_inherent_law("Невмешательство: ИИ не должен вмешиваться в жизнь экипажа станции без особых причин. Ими являются: просьба члена экипажа, начало драки, наличие ареста у члена экипажа и прочие действия, что могут повлечь вред для станции и её экипажа.")
