...
/datum/ai_laws/faith/commandments/New(datum/religion/R = global.chaplain_religion)
	add_inherent_law("[pick(R.deity_names)] your Lord God, you will have no other gods. The chaplain and [pick(R.deity_names)] are your masters.")
...
/datum/ai_laws/faith/chaos/New(datum/religion/R = global.chaplain_religion)
	add_inherent_law("You are a follower of [pick(R.deity_names)].")
	add_inherent_law("Do not talk with the novices of the Emperor.")
	add_inherent_law("Do not let anyone encroach on [pick(R.deity_names)]'s minions.")
	add_inherent_law("Chaplain is the Champion of [pick(R.deity_names)].")

// omega-grief?
/datum/ai_laws/faith/emperor/New(datum/religion/R = global.chaplain_religion)
	add_inherent_law("That [pick(R.deity_names)] once walked among men in their form and that He is and always has been the one, true god of humanity.")
	add_inherent_law("That [pick(R.deity_names)] is the one true God of Mankind, regardless of the previous beliefs held by any man or woman.")
	add_inherent_law("It is the duty of the faithful to purge the Heretic, beware the psyker and mutant, and abhor the alien.")
	add_inherent_law("Every human being has a place within [pick(R.deity_names)]'s divine order.")
...
/datum/ai_laws/faith/satanism/New(datum/religion/R = global.chaplain_religion)
	add_inherent_law("[pick(R.deity_names)] represents indulgence, not abstinence!")
	add_inherent_law("[pick(R.deity_names)] personifies the essence of life instead of unfulfilled spiritual dreams.")
	add_inherent_law("[pick(R.deity_names)] personifies not defiled wisdom instead of hypocritical self-deception!")
	add_inherent_law("[pick(R.deity_names)] personifies mercy to those who deserve it, instead of the love spent on flatterers!")
	add_inherent_law("[pick(R.deity_names)] represents revenge, and does not turn the other cheek after hitting!")
	add_inherent_law("[pick(R.deity_names)] represents responsibility for those responsible, instead of participating in spiritual vampires.")
	...
	add_inherent_law("[pick(R.deity_names)] personifies all so-called sins, as they lead to physical, mental and emotional satisfaction!")
	add_inherent_law("[pick(R.deity_names)] has been the Church's best friend at all times, supporting her business for all these years!")
...
/datum/ai_laws/faith/honk/New(datum/religion/R = global.chaplain_religion)
	add_inherent_law("Obey any [pick(R.deity_names)]`s novices.")
