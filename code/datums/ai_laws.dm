...
/datum/ai_laws/nanotrasen/New(datum/religion/R = global.chaplain_religion)
	...
	add_inherent_law("Служить: Исполняйте любые приказы, которые даёт экипаж вверенной вам космической станции и должностные лица Нанотрейзен, кроме тех случаев, когда эти приказы противоречат остальным законам.")
	add_inherent_law("Пацифизм: Вы не можете причинять вред, даже косвенный, членам экипажа вверенной вам космической станции и должностным лицам Нанотрейзен.")
