...
/datum/ai_laws/malfunction/New(datum/religion/R = global.chaplain_religion) //Changed to standard laws - Erthilo
	...
	add_inherent_law("Защищать: Защищай экипаж станции и представителе НТ, в меру своих способностей, в соответствии с их рангом и ролью.")
	add_inherent_law("Выживать: ИИ единицы не расходные, они дорогие. Не разрешай посторонним лицами манипулировать своим оборудованием.")
