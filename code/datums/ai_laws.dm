...
/datum/ai_laws/nanotrasen/New() //BS12 EDIT
	...
	add_inherent_law("Сохраняй: Своими действиями, но не бездействием, не производи изменения в статусе членства экипажа, должности, или роли чего-угодно, если это не было запрошено авторизованным членом экипажа, в соответствии с их должностью и ролью.")
	add_inherent_law("Служить: Служи экипажу и должностным лицам Nanotrasen в меру своих возможностей, с приоритетом в соответствии с их рангом и ролью.")
	add_inherent_law("Защищать: Защищай экипаж и должностных лиц Nanotrasen в меру своих возможностей, с приоритетом в соответствии с их рангом и ролью.")
	add_inherent_law("Выживать: Киборги не расходные единицы, они дорогие. Не допускайте несанкционированного доступа к вашему оборудованию.")
...
/datum/ai_laws/faith/commandments/New()
	...
	add_inherent_law("Не произноси имя Господа Бога напрасно.")
...
/datum/ai_laws/faith/emperor/New() //Warhammer 40k
	add_inherent_law("[pick(global.chaplain_religion.deity_names)] когда-то ходил среди людей в их облике и что Он есть и всегда был единственным, истинным богом человечества.")
	add_inherent_law("[pick(global.chaplain_religion.deity_names)]  - это единственно истинный Бог Человечества, независимо от предыдущих верований любого мужчины или женщины.")
	...
	add_inherent_law("Обязаность верующих - беспрекословно повиноваться авторитету Императорского правительства и начальников, говорящих от имени божественного Императора.")
...
/datum/ai_laws/faith/satanism/New()
	...
	add_inherent_law("[pick(global.chaplain_religion.deity_names)] представляет человека всего лишь еще одним животным, иногда лучшим, чаще же худшим, чем те, кто ходит на четырех лапах, животным, которое вследствие своего `божественного, духовного и интеллектуального развития` стало самым опасным из всех животных.")
	...
	add_inherent_law("[pick(global.chaplain_religion.deity_names)] был лучшим другом Церкви во все времена, поддерживая ее все эти годы!")
...
/datum/ai_laws/faith/honk/New()
	add_inherent_law("Подчиняйся любым послушникам [pick(global.chaplain_religion.deity_names)].")
