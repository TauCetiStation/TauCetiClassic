...
/datum/announcement/centcomm/event/aliens
	name = "Event: Infestation"
	subtitle = "Тревога. Формы Жизни"
	sound = "lifesigns"
/datum/announcement/centcomm/event/aliens/New()
...
/datum/announcement/centcomm/event/dust
...
/datum/announcement/centcomm/event/dust_passed
	name = "Event: Sand Storm Passed"
/datum/announcement/centcomm/event/dust_passed/New()
	subtitle = "Сенсоры [station_name_ru()]"
	message = "[station_name_ru()] прошел сквозь облако космической пыли."

/datum/announcement/centcomm/event/estorm
...
/datum/announcement/centcomm/event/grid_off
	name = "Event: Power Failure"
	subtitle = "Критический Сбой Электропитания"
	sound = "poweroff"
/datum/announcement/centcomm/event/grid_off/New()
...
/datum/announcement/centcomm/event/grid_on
	name = "Event: Power Restored"
	subtitle = "Системы Электропитания в Норме"
	sound = "poweron"
/datum/announcement/centcomm/event/grid_on/New()
...
/datum/announcement/centcomm/event/irod
	name = "Event: Immovable Rod"
	subtitle = "Общая Тревога"
	message = "Что, нахрен, это было?!"

/datum/announcement/centcomm/event/infestation
...
/datum/announcement/centcomm/event/infestation/play(vermstring, locstring)
...
/datum/announcement/centcomm/event/meteor_wave
...
/datum/announcement/centcomm/event/meteor_wave_passed
	name = "Event: Meteor Wave Cleared"
	subtitle = "Тревога. Метеоры"
	message = "Станция прошла метеорный шторм."
	sound = "meteorcleared"

/datum/announcement/centcomm/event/meteor_shower
...
/datum/announcement/centcomm/event/meteor_shower_passed
	name = "Event: Meteor Shower Cleared"
	subtitle = "Тревога. Метеоры"
	message = "Станция прошла метеорный поток."
	sound = "meteorcleared"

/datum/announcement/centcomm/event/organ_failure
	name = "Event: Organ Failure"
	subtitle = "Тревога. Биоугроза"
	sound = "outbreak7"
/datum/announcement/centcomm/event/organ_failure/New()
...
/datum/announcement/centcomm/event/greytide
	name = "Event: Grey Tide"
	subtitle = "Тревога Безопасности"
	sound = "greytide"
/datum/announcement/centcomm/event/greytide/New()
...
/datum/announcement/centcomm/event/icarus_lost
	name = "Event: Icarus Lost"
	subtitle = "Тревога. Сбойные дроны"
	sound = "icaruslost"
	always_random = TRUE
/datum/announcement/centcomm/event/icarus_lost/randomize()
	if(prob(33))
...
/datum/announcement/centcomm/event/icarus_recovered
...
/datum/announcement/centcomm/event/icarus_destroyed
	name = "Event: Icarus Recovered"
	subtitle = "Тревога. Сбойные дроны"
