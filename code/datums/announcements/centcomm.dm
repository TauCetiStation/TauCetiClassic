...
/datum/announcement/centcomm
	title = "Уточнение Центрального Командования"
	subtitle = "Уточнение НаноТрейзен"
	sound = "commandreport"
...
/datum/announcement/centcomm/yesert/play()
	message = "Похоже, отряд быстрого реагирования был запрошен на [station_name()]. Мы подготовим и отправим их в кратчайшие сроки."
	..()
