...
/datum/announcement/centcomm/malf/fourth_antag
	...
	message = "Мы отследили взломщика и наша команда по кибер-безопасности смогла отключить его от вашей сети. ПО ваших систем было обновлено."
	sound = "malf4_antag"

/datum/announcement/centcomm/malf/fourth_drill
	name = "Malf: Drill announce"
	message = "Мы отследили взломщика и похоже, что он взламывает механизм самоуничтожения. Остановите его, пока не поздно."
	sound = "malf4_drill"
