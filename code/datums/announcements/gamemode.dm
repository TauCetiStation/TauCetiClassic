...
/datum/announcement/centcomm/star_wars/jedi_arrival
	name = "Jedi Arrival"
/datum/announcement/centcomm/star_wars/jedi_arrival/New()
	message = "Внимание персонал! Артефакт, найденный предыдущей сменой, имеет огромное значение. " + \
	"С нами связались высокопоставленные представители планеты Илум — их делегация в ближайшее время прибудет на станцию. " + \
	"Подготовьте помещение космических врат к прибытию гостей. " + \
	"По их прибытии сопроводите делегацию к артефакту, в изолятор исследовательского отдела. " + \
	"С уважением, капитан Рен Лоури."

/datum/announcement/centcomm/star_wars/star_war_begin
	name = "Star War Begins"
/datum/announcement/centcomm/star_wars/star_war_begin/New()
	message = "Внимание персонал! Зафиксировано подключение к космическим вратам станции и открытие неизвестного портала! " + \
	"Представители планеты Илум сообщают о начале Звёздной Войны и требуют немедленной эвакуации персонала! " + \
	"Ситуация принимает серьёзный оборот, в скором времени станция превратится в поле боевых действий. " + \
	"Мы в срочном порядке высылаем шаттл эвакуации, если хотите выжить, немедленно проследуйте в отбытие. " + \
	"Да поможет нам КосмоИисус."
