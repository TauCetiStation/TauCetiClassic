...
/datum/announcement/centcomm/xeno/first_help/New()
	message = "Мы получили информацию о наличии улья ксеноморфов на вашей станции. " + \
			"Это враждебные и крайне опасные существа! Нельзя допустить проникновение ксеноморфов на другие объекты НаноТрейзен. " + \
			...
			"Согласно предварительным расчётам, этого достаточно для устранения угрозы."
