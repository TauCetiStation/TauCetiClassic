...
/datum/announcement/centcomm/gang/announce_gamemode/play(gang_names)
	...
	" В течение часа должна прибыть сотрудники Отдела по Борьбе с Организованной Преступностью.\n\n" + \
...
/datum/announcement/centcomm/gang/cops_closely/play(gang_names)
	...
	" Они прибудет примерно через 5 минут. Напоминаем еще раз, они находятся выше вас по иерархии" + \
...
/datum/announcement/centcomm/gang/cops_3/play()
	...
	" с вашей станции, что привело к жертвам среди гражданского персонала. НТ не будет терпеть такой агрессии," + \
	" высланный отряд будет дейстовать в полную силу, чтобы сохранить мир и сократить количество жертв. Мы окружили вашу станцию!" + \
...
/datum/announcement/centcomm/gang/cops_4/play()
	...
	" Мы надеемся, что успеем все решить в течение десятиминут, иначе же ждите шаттл и НаноТрейзен само всё решит, их методом.\n\nСдавайтесь сейчас или пожалеете!"
	..()
...
/datum/announcement/centcomm/gang/cops_5/play()
	...
	" Наша БСА направлена на станцию и ваш спасательный шаттл.\n\nЗря вы убили столько людей."
	..()
