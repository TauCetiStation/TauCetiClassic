...
/datum/announcement/centcomm/syndi_shuttle
	name = "Syndicate shuttle"
	subtitle = "ВКН Икар"

/datum/announcement/centcomm/syndi_shuttle/New()
	message = "Недалеко от [station_name_ru()] было замечено движение высокоскоростного шаттла. Судя по всему, этот шаттл принадлежит Мародёрам Горлекс. " + \
	"Экипажу станции быть на готове."
