...
/*	Revolution	*/
/datum/announcement/centcomm/revolution_succesfull/New()
	message = "По данным внешней разведки, станция потеряла контроль в лице глав. Мы инициируем эвакуацию всего лояльного персонала. " + \
			"В случае прибытия на станцию Центрального Коммандования вооружённых субъектов, по ним будет открыт огонь на поражение. " \
