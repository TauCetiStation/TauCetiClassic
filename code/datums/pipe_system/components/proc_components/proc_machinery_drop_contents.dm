/datum/pipe_system/component/proc_component/machinery_drop_contents/RunTimeAction(datum/pipe_system/process/process)
	...
	var/datum/pipe_system/component/data/target_program/target_program_data = process.GetCacheData(TARGET_PROGRAM_DATA)
	...
	var/datum/pipe_system/component/data/program_command = process.GetCacheData(PROGRAM_COMMAND_DATA)
