...
/datum/quality/quirkieish/cyborg/add_effect(mob/living/carbon/human/H, latespawn)
	...
	if(H.organs_by_name[O_HEART])
		...
		if(H.species.name == VOX)
			var/obj/item/organ/internal/heart/cybernetic/voxc/CH = new(null)
			CH.insert_organ(H)
		else
			var/obj/item/organ/internal/heart/cybernetic/CH = new(null)
			CH.insert_organ(H)
	if(H.organs_by_name[O_KIDNEYS])
		qdel(H.organs_by_name[O_KIDNEYS])
		if(H.species.name == VOX)
			var/obj/item/organ/internal/kidneys/cybernetic/voxc/CK = new(null)
			CK.insert_organ(H)
		else
			var/obj/item/organ/internal/kidneys/cybernetic/CK = new(null)
			CK.insert_organ(H)
	if(H.organs_by_name[O_LIVER])
		qdel(H.organs_by_name[O_LIVER])
		if(H.species.name == VOX)
			var/obj/item/organ/internal/liver/cybernetic/voxc/CL = new(null)
			CL.insert_organ(H)
		else
			var/obj/item/organ/internal/liver/cybernetic/CL = new(null)
			CL.insert_organ(H)
	if(H.organs_by_name[O_LUNGS])
		qdel(H.organs_by_name[O_LUNGS])
		if(H.species.name == VOX)
			var/obj/item/organ/internal/lungs/cybernetic/voxc/CU = new(null)
			CU.insert_organ(H)
		else
			var/obj/item/organ/internal/lungs/cybernetic/CU = new(null)
			CU.insert_organ(H)
	if(H.organs_by_name[O_EYES])
