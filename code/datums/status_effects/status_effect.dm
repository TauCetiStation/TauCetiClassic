...
/datum/status_effect
	...
	var/examine_text //If defined, this text will appear when the mob is examined.
...
/datum/status_effect/proc/on_apply() //Called whenever the buff is applied; returning FALSE will cause it to autoremove itself.
	return TRUE
/datum/status_effect/proc/tick(seconds_per_tick) //Called every tick.
...
/atom/movable/screen/alert/status_effect/Destroy()
	if(attached_effect && attached_effect.linked_alert == src)
