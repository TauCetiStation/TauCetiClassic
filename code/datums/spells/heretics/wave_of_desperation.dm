/obj/effect/proc_holder/spell/aoe_turf/wave_of_desperation
...
/obj/effect/proc_holder/spell/aoe_turf/wave_of_desperation/is_valid_target(mob/living/carbon/cast_on)
	return ..() && istype(cast_on) && (cast_on.handcuffed || cast_on.legcuffed)

// Before the cast, we do some small AOE damage around the caster
/obj/effect/proc_holder/spell/aoe_turf/wave_of_desperation/before_cast(mob/living/carbon/cast_on)
	. = ..()
...
/obj/effect/proc_holder/spell/aoe_turf/wave_of_desperation/cast_on_thing_in_aoe(atom/victim, atom/caster)
	if(!ismob(victim))
