		...
		switch(input("Zombie menu", "Select action", "Cancel") in list("Turn into zombie instantly", "Infect with slow zombie virus (10-20 min)", "Infect with fast zombie virus (~3 min)", "Make immune to zombie virus", "Make vulnerable to zombie virus", "Cancel"))
			if("Turn into zombie instantly")
				if(H)
					...
					message_admins("\blue [key_name_admin(usr)] turned [key_name(H)] into a zombie.")
			if("Infect with slow zombie virus (10-20 min)")
				if(H)
					...
					message_admins("\blue [key_name_admin(usr)] infected [key_name(H)] with slow zombie virus.")
			if("Infect with fast zombie virus (~3 min)")
				if(H)
					...
					message_admins("\blue [key_name_admin(usr)] infected [key_name(H)] with fast zombie virus.")
			if("Make immune to zombie virus")
				if(H)
					...
					message_admins("\blue [key_name_admin(usr)] made [key_name(H)] immune to zombie virus.")
			if("Make vulnerable to zombie virus")
				if(H)
					...
					message_admins("\blue [key_name_admin(usr)] made [key_name(H)] vulnerable to zombie virus.")
