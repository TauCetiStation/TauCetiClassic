...
/datum/spawner/responders/solgov_osg
	outfit = /datum/outfit/responders/solgov
	leader_outfit = /datum/outfit/responders/solgov/leader
	medic_outfit = /datum/outfit/responders/solgov/medic
	leader_text = "Ты - <B>сержант</B> отряда Охраны Внешних Систем Правительства! Возвращаясь с очередного патруля, вы получили сигнал о помощи и поспешили помочь станции. Вы должны действовать в рамках местного корпоративного закона, а также пытаться нейтрализовать угрозу нелетально. Помните, вы не являетесь корпоратами и находитесь здесь только потому что кому-то из высших чинов доплачивают за помощь в защите этой треклятой станции."
	fluff_text = "Ты - оперативник отряда Охраны Внешних Систем Правительства! Возвращаясь с очередного патруля, вы получили сигнал о помощи и поспешили помочь станции. Вы должны действовать в рамках местного корпоративного закона, а также пытаться нейтрализовать угрозу нелетально. Помните, вы не являетесь корпоратами и находитесь здесь только потому что кому-то из высших чинов доплачивают за помощь в защите этой треклятой станции."
	faction_type = /datum/faction/responders/solgov_osg
