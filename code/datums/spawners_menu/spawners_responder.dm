...
/datum/spawner/responders/inquisition
	outfit = /datum/outfit/responders/inquisitor
	leader_outfit = /datum/outfit/responders/inquisitor/spacemarine
	leader_text = "Ты - космоморпех! Вы получили сведения о распространяющейся ереси на станции! Возможно, это культ Нар-Си, общие намерения и описание которого вы знаете, а возможно, и иного рода ересь. В любом случае, ересь должна быть искоренена!"
	leader_text = "Ты - инквизитор святой церкви! Вы получили сведения о распространяющейся ереси на станции! Возможно, это культ Нар-Си, общие намерения и описание которого вы знаете, а возможно, и иного рода ересь. В любом случае, ересь должна быть искоренена!"
	faction_type = /datum/faction/responders/inquisition

/datum/spawner/responders/inquisition/New(mission)
	. = ..()
	var/church = prob(25) ? "Терры" : "святой церкви"
	leader_text = "Ты - космоморпех [church]! Вы получили сведения о распространяющейся ереси на станции! Возможно, это культ Нар-Си, общие намерения и описание которого вы знаете, а возможно, и иного рода ересь. В любом случае, ересь должна быть искоренена! [church == "Терры" ? "<B>Род людской превыше всего.</B>" : ""]"
	leader_text = "Ты - инквизитор [church]! Вы получили сведения о распространяющейся ереси на станции! Возможно, это культ Нар-Си, общие намерения и описание которого вы знаете, а возможно, и иного рода ересь. В любом случае, ересь должна быть искоренена! [church == "Терры" ? "<B>Род людской превыше всего.</B>" : ""]"
