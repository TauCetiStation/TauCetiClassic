...
/datum/spawner/responders/crusaders
	outfit = /datum/outfit/responders/crusader
	leader_outfit = /datum/outfit/responders/crusader/leader
	leader_text = "Ты - магистр Ордена Весов! Отряд вашего ордена получил сигнал бедствия со станции, и вы решили придти на помощь праведникам - вдруг среди них окажутся отвратительные грешники?"
	fluff_text = "Ты - брат Ордена Весов! Отряд вашего ордена получил сигнал бедствия со станции, и вы решили придти на помощь праведникам - вдруг среди них окажутся отвратительные грешники?"
	faction_type = /datum/faction/responders/crusaders
