...
var/global/list/player_list = list()				//List of all mobs **with clients attached**. Excludes /mob/dead/new_player
var/global/list/mob_list = list()					//List of all mobs, including clientless
var/global/list/living_mob_list = list()			//List of all alive mobs, including clientless. Excludes /mob/dead/new_player
...
var/global/list/ghost_hud_users = list() // list of all entities using a ghostbusters HUD
