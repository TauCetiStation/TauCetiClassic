...
var/global/list/cooking_recipe_types = list(/datum/recipe/microwave, /datum/recipe/oven, /datum/recipe/grill, /datum/recipe/candy)
var/global/list/cooking_recipes = list()
