...
var/global/list/SOUNDIN_MAGBOOTS_TOGGLE		  = list('sound/effects/magb1.ogg', 'sound/effects/magb2.ogg', 'sound/effects/magb3.ogg','sound/effects/magb4.ogg','sound/effects/magb5.ogg')
