...
var/global/list/SOUNDIN_HEY_MALE = list('sound/voice/hey/hey_male-1.ogg', 'sound/voice/hey/hey_male-2.ogg')
var/global/list/SOUNDIN_HEY_FEMALE = list('sound/voice/hey/hey_female-1.ogg', 'sound/voice/hey/hey_female-2.ogg')
// Human's pain
