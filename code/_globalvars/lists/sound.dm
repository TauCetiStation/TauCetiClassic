...
// Serpentid's emotes
var/global/list/SOUNDIN_LAUGH_SERPENTID = list('sound/voice/Bug.ogg')
var/global/list/SOUNDIN_GRUNT_SERPENTID = list('sound/voice/BugHiss.ogg')
var/global/list/SOUNDIN_SCREAM_SERPENTID = list('sound/voice/BugBuzz.ogg')
// Xenomorph's emotes
