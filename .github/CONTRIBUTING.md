...
Мы не препятствуем использованию LLM-инструментов, но основной вклад и инициатива всегда должны идти от человека. PR-ы от автономных агентов не рассматривается.
