...
На простом примере, если мы хотим, чтобы мод терял 2 жизни в секунду:
...
``SPT_PROB`` конвертирует шанс на шанс в секунду и обеспечивает более постоянное значение, зависимое скорости от сабсистемы.
