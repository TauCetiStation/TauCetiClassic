...
> [!NOTE]
> Апстрим [документация tg](https://github.com/tgstation/tgstation/blob/master/.github/guides/STANDARDS.md) где-то может быть более поднобна и актуальна, но не обязательно соответствует нашему билду.
