...
/datum/uplink_item/ammo/machinegun
	name = "Ammo-7.62Ч51mm"
	desc = "A 50-round magazine of 7.62Ч51mm ammunition for use in the L6 SAW machinegun. By the time you need to use this, you'll already be on a pile of corpses."
