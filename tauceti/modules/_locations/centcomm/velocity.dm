/turf/unsimulated/floor/velocity
	icon = 'tauceti/modules/_locations/centcomm/floor.dmi'

/obj/structure/grille/velocity
	icon = 'tauceti/modules/_locations/centcomm/grille_velocity.dmi'
	icon_state = "grille"
...
/obj/structure/rail_centcomm
	...
	icon = 'tauceti/modules/_locations/centcomm/centcomm.dmi'
	density = 0
	anchored = 1
	layer = 2.7
...
/obj/structure/sign/tablo/display_90
	icon = 'tauceti/modules/_locations/centcomm/monitor_90.dmi'

/obj/structure/sign/tablo/display
	icon = 'tauceti/modules/_locations/centcomm/monitor.dmi'
...
/obj/structure/sign/velocity_overlay/car_impala
	layer = 4
	icon = 'tauceti/modules/_locations/centcomm/car_impala.dmi'
...
/obj/structure/sign/velocity_overlay/car_carmageddon
	layer = 4
	icon = 'tauceti/modules/_locations/centcomm/car_carmageddon.dmi'
...
/obj/structure/closet/secure_closet/velocity_security
	...
	req_access_txt = "101"
	icon = 'tauceti/modules/_locations/centcomm/closet.dmi'
