...
/obj/spacecraft
	...
	var/datum/global_iterator/pr_speed_increment //���������� ��������
	var/datum/global_iterator/pr_cooling //���������� ���������
	...
	var/obj/machinery/spacecraft_refill_station/connected_port = null //������� �������
...
/obj/spacecraft/proc/add_iterators()														//���������
...
////ITERATORS///////
/datum/global_iterator/spacecraft_preserve_temp  //normalizing cabin air temperature to 20 degrees celsium. ���� �����������.
	delay = 20
