/obj/item/clothing/head/helmet/space/rig/RF_mining
	icon = 'tauceti/items/WalterJ_Items_Pack/RED FACTION RIG/WJ_Red_Faction_Rig.dmi'
	tc_custom = 'tauceti/items/WalterJ_Items_Pack/RED FACTION RIG/WJ_Red_Faction_Rig.dmi'
