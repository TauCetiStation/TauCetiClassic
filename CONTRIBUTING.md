...
Если вы создали ПР, но он всё ещё незакончен и вы над ним работаете, добавьте в начало названия `[WIP]`.
...
#### Чейнджлог
К нашему репозиторию подключён свой автоматический генератор чейнджлога, описываемых в теле ПРа, изменений. На нашей [Вики](http://tauceti.ru/wiki/Git/GitHub) имеется подробное описание что и как делается. **Самое главное**, что нужно помнить - всё, что идёт после `:cl:` метки обработчик считает за чейнджлог. Поэтому всё и описывается в конце основного тела ПРа.
