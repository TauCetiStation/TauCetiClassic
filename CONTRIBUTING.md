...
## Работа с гитом
Весьма подробный гайд, вплоть до создания ПРа, описан на нашей основной Вики: [http://tauceti.ru/wiki/Git/Git-console](http://tauceti.ru/wiki/Git/Git-console). Прочитайте на досуге.
...
#### Чейнджлог
К нашему репозиторию подключён свой автоматический генератор чейнджлога, описываемых в теле ПРа изменений. В уже представленной выше ссылке на [Вики](http://tauceti.ru/wiki/Git/Git-console) имеется подробное описание что и как делается. **Самое главное**, что нужно помнить - всё, что идёт после `:cl:` метки обработчик считает за чейнджлог. Поэтому всё и описывается в конце основного тела ПРа.
...
### Согласование
Решение того что будет добавлено, а что нет остается за командой проекта или лицами, которые отвечают за контент. Иначе говоря, кодить можно все что душе угодно, но не все может пройти в проект. Лучше согласовать с людьми и/или с теми, кто отвечает за контент, вносимый в проект (мэйнтейнеры). В противном случае могут возникнуть ситуации, когда вы потратили время, но ваш контент, по итогу, добавлен в билд не будет. (Для понимания, ситуация, когда конкретный ПР забракован конкретным мейнтейнром очень редкие. Как правило против внесения изменений высказываются другие игроки и кодеры, которые следят за деятельностью на гитхабе.)
